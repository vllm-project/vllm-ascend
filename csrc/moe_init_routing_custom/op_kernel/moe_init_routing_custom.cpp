 ...
 */
#define MOE_INIT_ROUTING_CUSTOM_SORTONECORE_GATHER_NODROP 1000000  // 无Gather单核排序、非量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTONECORE_SCATTER_NODROP 1001000 // 无Gather单核排序、非量化、SCATTER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTMULTICORE_GATHER_NODROP 1100000 // 无Gather多核排序、非量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTMULTICORE_SCATTER_NODROP 1101000 // 无Gather多核排序、非量化、SCATTER索引

/*
 * 动态量化、无Gather、非Drop/Pad
 */
#define MOE_INIT_ROUTING_CUSTOM_SORTONECORE_DYNAMICQUANT_GATHER_NODROP 1020000 // 单核排序、动态量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTONECORE_DYNAMICQUANT_SCATTER_NODROP 1021000 // 单核排序、动态量化、SCATTER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTMULTICORE_DYNAMICQUANT_GATHER_NODROP 1120000 // 多核排序、动态量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTMULTICORE_DYNAMICQUANT_SCATTER_NODROP 1121000 // 多核排序、动态量化、GATHER索引

/*
 * 静态量化、无Gather、非Drop/Pad
 */
#define MOE_INIT_ROUTING_CUSTOM_SORTONECORE_QUANT_GATHER_NODROP 1010000 // 单核排序、静态量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTONECORE_QUANT_SCATTER_NODROP 1011000 // 单核排序、静态量化、SCATTER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTMULTICORE_QUANT_GATHER_NODROP 1110000 // 多核排序、静态量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTMULTICORE_QUANT_SCATTER_NODROP 1111000 // 多核排序、静态量化、GATHER索引

/*
 * Drop/Pad
 */
#define MOE_INIT_ROUTING_CUSTOM_SORTONECORE_GATHER_DROP 1000100 // 单核排序、非量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTMULTICORE_GATHER_DROP 1100100 // 多核排序、非量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTONECORE_DYNAMICQUANT_GATHER_DROP 1020100 // 单核排序、动态量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTMULTICORE_DYNAMICQUANT_GATHER_DROP 1120100 // 多核排序、动态量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTONECORE_QUANT_GATHER_DROP 1010100 // 单核排序、静态量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_SORTMULTICORE_QUANT_GATHER_DROP 1110100 // 多核排序、静态量化、GATHER索引

/*
 * 非量化、有Gather
 */
#define MOE_INIT_ROUTING_CUSTOM_GATHER_SORTONECORE_GATHER 1200000 // 单核Gather->单核或多核排序、非量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_GATHER_SORTONECORE_SCATTER 1201000 // 单核Gather->单核或多核排序、非量化、SCATTER索引
#define MOE_INIT_ROUTING_CUSTOM_GATHER_SORTMULTICORE_GATHER 1300000 // 多核Gather->多核排序、非量化、GATHER索引
#define MOE_INIT_ROUTING_CUSTOM_GATHER_SORTMULTICORE_SCATTER 1301000 // 多核Gather->多核排序、非量化、SCATTER索引
