...
TORCH_LIBRARY_EXPAND(CONCAT(_C, _ascend), ops)
{
    ...
    ops.def(
        ...
        "                     int max_output_size, Tensor! out, Tensor! expert_token_nums, Tensor? x_active_mask=None,"
        "                     Tensor? profiling_data=None, float swiglu_limit=1000000.0) -> (Tensor out, Tensor expert_token_nums)"
    );
