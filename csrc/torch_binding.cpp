...
#include "attention/lightning_indexer_fp32/lightning_indexer_fp32_torch_adpt.h"
...
TORCH_LIBRARY_EXPAND(CONCAT(_C, _ascend), ops)
{
    ...
    ops.impl("npu_lightning_indexer_fp32", torch::kPrivateUse1, &vllm_ascend::npu_lightning_indexer_fp32);
