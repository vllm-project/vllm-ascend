...
#include "attention/fused_rearrange_mix_qkv_gdn_gating/fused_rearrange_mix_qkv_gdn_gating_torch_adpt.h"
...
TORCH_LIBRARY_EXPAND(CONCAT(_C, _ascend), ops)
{
    ...
    ops.def(
        "npu_fused_rearrange_mix_qkv_gdn_gating(Tensor x, Tensor a, Tensor b, Tensor alog, Tensor dtbias, "
    ...
    ops.impl(
        ...
        torch::kPrivateUse1,
        &vllm_ascend::npu_fused_rearrange_mix_qkv_gdn_gating);
