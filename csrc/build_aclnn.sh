...
if [[ "$SOC_VERSION" =~ ^ascend310 ]]; then
    ...
    CUSTOM_OPS="grouped_matmul_swiglu_quant_weight_nz_tensor_list;lightning_indexer_vllm;sparse_flash_attention;matmul_allreduce_add_rmsnorm;moe_init_routing_custom;moe_gating_top_k;add_rms_norm_bias;apply_top_k_top_p_custom;moe_grouped_matmul;transpose_kv_cache_by_block;"
    SOC_ARG="ascend910b"
