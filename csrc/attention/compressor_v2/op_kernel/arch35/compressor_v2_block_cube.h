...
class CompressorV2BlockCube {
    using MM1_OUT_T = float;

public:
    __aicore__ inline CompressorV2BlockCube(){};
...
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::InitParams(const ConstInfo &constInfo,
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::Init(
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::InitBuffers(TPipe *pipe)
{
    // L1
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::InitGlobalBuffers(
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::AllocEventID(TPipe *pipe)
{
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::FreeEventID(TPipe *pipe)
{
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::CopyXGmToL1(const RunInfo &info,
                                                                              ...
                                                                              uint32_t kBase)
{
    ...
    if constexpr (IS_FULL_LOAD) {
        copySeqCnt = constInfo_.mEnd - constInfo_.mStart; // info.dealSeqCnt; // 此基本块处理的长度
        sIdx = constInfo_.mStart;                         // 起始s在整个T的起始点
    } else {
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::CopyWeightGmToL1(LocalTensor<X_T> wL1Tensor,
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::LoadAToL0(const RunInfo &info,
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::LoadBToL0(LocalTensor<X_T> bL0Tensor,
                                                                            LocalTensor<X_T> wL1Tensor, uint32_t kStart,
                                                                            uint32_t kBase, uint32_t nStart,
                                                                            uint32_t nDealSize)
{
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::MatrixMmad(LocalTensor<T> cL0Tensor,
                                                                             LocalTensor<X_T> aL0Tensor,
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::CopyOutMm1Res(const RunInfo &info,
...
template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline uint32_t CompressorV2BlockCube<COMP, IS_FULL_LOAD>::GetMSize(const RunInfo &info, uint32_t coffId)
{
    return info.dealSeqCnt;
}

template <typename COMP, bool IS_FULL_LOAD>
__aicore__ inline void CompressorV2BlockCube<COMP, IS_FULL_LOAD>::ComputeMm1(const RunInfo &info)
{
    uint32_t mSize = info.dealSeqCnt;
    if (mSize == 0) {
        return;
    }
    // FULL_LOAD模板用128以避免mmad反压
    static constexpr uint32_t K_L1_BASE = IS_FULL_LOAD ? 128 : 256;
