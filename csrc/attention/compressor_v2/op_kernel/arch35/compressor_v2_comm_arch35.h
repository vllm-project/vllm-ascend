...
/*!
 * \file compressor_comm_arch35.h
 * \brief
 */

#ifndef COMPRESSOR_COMM_ARCH35_H
#define COMPRESSOR_COMM_ARCH35_H
...
template <X_LAYOUT X_L, X_DTYPE X_T, typename... Args>
struct COMPType {
    static constexpr X_LAYOUT xLayout = X_L;
    static constexpr X_DTYPE xDtype = X_T;
    static constexpr COFF coff = COFF::DISABLE;
    static constexpr CACHE_MODE cacheMode = CACHE_MODE::RING_BUFFER;
    static constexpr GRAD_ENABLED gradEnabled = GRAD_ENABLED::DISABLE;
};
