...
/*!
 * \file compressor_tiling_arch22.h
 * \brief
 */

#ifndef COMPRESSOR_TILING_ARCH22_H
#define COMPRESSOR_TILING_ARCH22_H
...
#include "../../op_kernel/arch22/compressor_v2_template_tiling_key.h"
#include "../../op_kernel/arch22/compressor_v2_tiling_data.h"
...
class CompressorV2Tiling {
public:
    explicit CompressorV2Tiling(CompressorV2Context *context)
        : context_(context)
    {}
    ~CompressorV2Tiling() = default;

    static ge::graphStatus ConvertContext(gert::TilingContext &context, CompressorV2Context &compressorContext);
    ge::graphStatus RunBigKernelTiling(CompressorV2TilingData *tilingData);

private:
    static ge::graphStatus ConvertRequiredParams(gert::TilingContext &context, CompressorV2Context &compressorContext);

    static void ConvertOptionalParams(gert::TilingContext &context, CompressorV2Context &compressorContext);
    ...
    CompressorV2Context *context_ = nullptr;
    CompressorV2BaseParams *baseParams_ = nullptr;
    CompressorV2PageAttentionParams *pageAttentionParams_ = nullptr;
    CompressorV2InnerSplitParams *innerSplitParams_ = nullptr;
    CompressorV2WorkspaceParams *workspaceParams_ = nullptr;
};
