 ...
 */
#ifndef LIGHTNING_INDEXER_FP32_TORCH_ADPT_H
#define LIGHTNING_INDEXER_FP32_TORCH_ADPT_H

namespace vllm_ascend {

std::tuple<at::Tensor, at::Tensor> construct_lightning_indexer_fp32_output_tensor(
...
std::tuple<at::Tensor, at::Tensor> npu_lightning_indexer_fp32_meta(
...
{
    return construct_lightning_indexer_fp32_output_tensor(
        query, key, sparse_count, std::string(layout_query), std::string(layout_key), return_value);
}

std::tuple<at::Tensor, at::Tensor> npu_lightning_indexer_fp32(
    const at::Tensor& query, const at::Tensor& key, const at::Tensor& weights,
    const c10::optional<at::Tensor>& actual_seq_lengths_query,
    const c10::optional<at::Tensor>& actual_seq_lengths_key,
    const c10::optional<at::Tensor>& block_table, c10::string_view layout_query,
    ...
    int64_t pre_tokens, int64_t next_tokens, bool return_value)
{
    ...
    auto lightning_indexer_fp32_output = construct_lightning_indexer_fp32_output_tensor(
        query, key, sparse_count, query_layout_str, key_layout_str,
        return_value);
    at::Tensor sparse_indices_out = std::get<0>(lightning_indexer_fp32_output);
    at::Tensor sparse_values_out = std::get<1>(lightning_indexer_fp32_output);

    char* query_layout_ptr = const_cast<char*>(query_layout_str.c_str());
    char* key_layout_ptr = const_cast<char*>(key_layout_str.c_str());

    EXEC_NPU_CMD(aclnnLightningIndexerFp32, query, key, weights,
...
#endif  // LIGHTNING_INDEXER_FP32_TORCH_ADPT_H
