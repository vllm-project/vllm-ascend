...
/*!
 * \file lightning_indexer_fp32_def.cpp
 * \brief
 */
#include <cstdint>
...
namespace ops {
class LightningIndexerFp32 : public OpDef {
public:
    explicit LightningIndexerFp32(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
