...
#include "aclnn_vllm_fused_infer_attention_score.h"
...
[[maybe_unused]] uint32_t NNOPBASE_VllmFusedInferAttentionScore = 0U;
} // namespace
...
aclnnStatus aclnnVllmFusedInferAttentionScoreGetWorkspaceSize(
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnVllmFusedInferAttentionScoreTiling", false};
    void *nnopExecutor;
...
aclnnStatus aclnnVllmFusedInferAttentionScore(
    void *workspace,
    uint64_t workspaceSize,
    aclOpExecutor *executor,
    aclrtStream stream)
