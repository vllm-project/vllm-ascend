...
public:
    ...
    {
        // Match the only dtype signature selected by the A5 inference binding.
        const std::initializer_list<ge::DataType> dataTypes = {ge::DT_BF16};
        const std::initializer_list<ge::DataType> gateTypes = {ge::DT_BF16};
        const std::initializer_list<ge::DataType> betaTypes = {ge::DT_FLOAT};
        const std::initializer_list<ge::DataType> fp32Types = {ge::DT_FLOAT};
