...
#include "fused_rearrange_mix_qkv_gdn_gating.h"

using namespace fused_rearrange_mix_qkv_gdn_gating_impl;

extern "C" __global__ __aicore__ void fused_rearrange_mix_qkv_gdn_gating(
    ...
    GM_ADDR y, GM_ADDR g, GM_ADDR betaOut, GM_ADDR workspace, GM_ADDR tiling)
{
    ...
    if ASCEND_IS_AIV {
        ...
        TPipe pipe;
        GdnGatingStage<DTYPE_ALOG, DTYPE_DTBIAS> gatingStage;
