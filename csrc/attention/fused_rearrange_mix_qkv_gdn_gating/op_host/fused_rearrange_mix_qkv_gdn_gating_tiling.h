...
namespace optiling {
BEGIN_TILING_DATA_DEF(FusedRearrangeMixQkvGdnGatingTilingData)
...
REGISTER_TILING_DATA_CLASS(FusedRearrangeMixQkvGdnGating, FusedRearrangeMixQkvGdnGatingTilingData)

struct FusedRearrangeMixQkvGdnGatingCompileInfo {};
}  // namespace optiling
