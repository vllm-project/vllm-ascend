...
namespace ops {
class FusedRearrangeMixQkvGdnGating : public OpDef {
public:
    explicit FusedRearrangeMixQkvGdnGating(const char* name) : OpDef(name)
    {
        ...
        this->Input("dtbias")
            .ParamType(REQUIRED)
            .DataType({ge::DT_FLOAT, ge::DT_BF16, ge::DT_FLOAT16, ge::DT_BF16})
            .Format({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND, ge::FORMAT_ND})
            .AutoContiguous();
...
OP_ADD(FusedRearrangeMixQkvGdnGating);
}  // namespace ops
