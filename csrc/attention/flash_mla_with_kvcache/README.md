...
These absorbed paths do not expand the entire historical cache. With the optional
MLAPO operator package, DCP1 with MXFP8 projection weights uses mode 8 to write
the cache directly. Replicated-Q DCP8 can use
