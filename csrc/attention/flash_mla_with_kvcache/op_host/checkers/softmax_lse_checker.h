...
#ifndef FLASH_MLA_WITH_KVCACHE_SOFTMAX_LSE_CHECKER_H
#define FLASH_MLA_WITH_KVCACHE_SOFTMAX_LSE_CHECKER_H
...
class SoftmaxLSEChecker : public FlashMlaWithKvcacheBaseChecker {
public:
    SoftmaxLSEChecker() = default;
...
#endif // FLASH_MLA_WITH_KVCACHE_SOFTMAX_LSE_CHECKER_H