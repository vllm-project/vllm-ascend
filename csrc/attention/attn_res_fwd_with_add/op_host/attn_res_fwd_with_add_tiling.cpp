...
namespace optiling {
REGISTER_OPS_TILING_TEMPLATE(AttnResFwdWithAdd, AttnResFwdTiling, 0);
...
IMPL_OP_OPTILING(AttnResFwdWithAdd).Tiling(Tiling).TilingParse<AttnResFwdCompileInfo>(Parse);
}
