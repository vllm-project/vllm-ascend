...
ASCENDC_TPL_ARGS_DECL(
    mla_prolog_dcp_c8, // 算子唯一标识，必须与 OPTYPE / opc --main_func=mla_prolog_dcp_c8 一致
...
// DCP8 C8 queries preserve the mode-7 BF16 current KV cache and Q outputs.
// Only the A5 no-RoPE split-N template is built; C8 Q has separate outputs.
ASCENDC_TPL_SEL(
