...
/*!
 * \file infer_flash_attention_comm_arch35.h
 * \brief
 */
#ifndef INFER_FLASH_ATTENTION_COMM_ARCH35_H
#define INFER_FLASH_ATTENTION_COMM_ARCH35_H
#include <type_traits>
...
#endif // INFER_FLASH_ATTENTION_COMM_ARCH35_H
