...
GmCopyInToL1(LocalTensor<L1Type> &L1Tensor, GlobalTensor<L1Type> &GmTensor, const CopyParam &mmCopyParam)
{
...
template <typename L1Type>
__aicore__ inline void DataCopyGmNDToL1(LocalTensor<L1Type> &l1Tensor,
                                        GlobalTensor<L1Type> &gmTensor,
                                        uint32_t rowAct,
                                        uint32_t rowAlign,
                                        uint32_t col, // D
...
template <typename L1Type>
__aicore__ inline void DataCopyGmNZToL1(LocalTensor<L1Type> &l1Tensor,
                                        GlobalTensor<L1Type> &gmTensor,
...
template <typename L1Type>
__aicore__ inline void GmCopyInToL1HasRopePANoContinue(LocalTensor<L1Type> &nopeTensor,
                                                       LocalTensor<L1Type> &ropeTensor,
                                                       ...
                                                       const Position &startPos)
{
    ...
    while (copyFinishRowCnt < shape.copyRowNum) {
        ...
        if (kvLayout == KVLAYOUT::NZ) {
            ...
            DataCopyGmNZToL1(tmpNopeDstTensor,
                             tmpNopeSrcTensor,
                             copyRowCnt,
                             (shape.copyRowNumAlign - copyRowCnt),
                             (shape.blockSize - copyRowCnt),
                             shape.actHeadDim);
            ...
            DataCopyGmNZToL1(tmpRopeDstTensor,
                             tmpRopeSrcTensor,
                             copyRowCnt,
                             (ropeShape.copyRowNumAlign - copyRowCnt),
                             (ropeShape.blockSize - copyRowCnt),
                             ropeShape.actHeadDim);
        } else {
            ...
            GlobalTensor<L1Type> tmpRopeSrcTensor = ropeGmTensor[keyRopeOffset];
            DataCopyGmNDToL1(
                tmpRopeDstTensor, tmpRopeSrcTensor, copyRowCnt, shape.copyRowNumAlign, dRopeValue, srcRopeDValue);
        }
...
template <typename L1Type>
__aicore__ inline void GmCopyInToL1HasRopePA(LocalTensor<L1Type> &nopeTensor,
                                             LocalTensor<L1Type> &ropeTensor,
                                             GlobalTensor<L1Type> &nopeGmTensor,
                                             GlobalTensor<L1Type> &ropeGmTensor,
                                             GlobalTensor<int32_t> &blockTableGm,
...
template <typename L1Type>
__aicore__ inline void GmCopyInToL1PA(LocalTensor<L1Type> &l1Tensor,
                                      GlobalTensor<L1Type> &gmTensor,
                                      GlobalTensor<int32_t> &blockTableGm,
                                      KVLAYOUT kvLayout,
                                      const PAShape &shape,
