...
/*!
 * \file pivot_lightning_indexer_def.cpp
 * \brief
 */
#include <cstdint>
...
namespace ops {
class PivotLightningIndexer : public OpDef {
public:
    explicit PivotLightningIndexer(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
