...
#include "aclnn_pivot_lightning_indexer.h"
...
extern aclnnStatus aclnnInnerPivotLightningIndexerGetWorkspaceSize(
...
extern aclnnStatus aclnnInnerPivotLightningIndexer(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
...
aclnnStatus aclnnPivotLightningIndexerGetWorkspaceSize(
        ...
        aclOpExecutor **executor)
{
    ...
    return aclnnInnerPivotLightningIndexerGetWorkspaceSize(
...
aclnnStatus aclnnPivotLightningIndexer(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
                                     const aclrtStream stream)
{
    return aclnnInnerPivotLightningIndexer(workspace, workspaceSize, executor, stream);
}
