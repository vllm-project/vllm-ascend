...
/*!
 * \file pivot_lightning_indexer_infershape.cpp
 * \brief
 */
...
static ge::graphStatus InferShapePivotLightningIndexer(gert::InferShapeContext *context)
{
    OP_CHECK_IF(context == nullptr, OP_LOGE("PivotLightningIndexer", "InferShapeContext is nullptr!"),
    ...
    OP_LOGI(context->GetNodeName(), "PivotLightningIndexer InferShape end.");

    return ge::GRAPH_SUCCESS;
}

static ge::graphStatus InferDataTypePivotLightningIndexer(gert::InferDataTypeContext *context)
{
    OP_CHECK_IF(context == nullptr, OP_LOGE("PivotLightningIndexer", "InferDataTypeContext is nullptr!"),
               return ge::GRAPH_FAILED);
    OP_LOGI(context->GetNodeName(), "Enter PivotLightningIndexer InferDataType impl.");
    ...
    OP_LOGI(context->GetNodeName(), "PivotLightningIndexer InferDataType end.");
    return GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(PivotLightningIndexer)
    .InferShape(InferShapePivotLightningIndexer)
    .InferDataType(InferDataTypePivotLightningIndexer);
} // namespace ops
