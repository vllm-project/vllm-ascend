...
/*!
 * \file pivot_lightning_indexer_vector.h
 * \brief
 */
#ifndef PIVOT_LIGHTNING_INDEXER_VECTOR_H
#define PIVOT_LIGHTNING_INDEXER_VECTOR_H
...
#endif // PIVOT_LIGHTNING_INDEXER_VECTOR_H
