...
/*!
 * \file pivot_lightning_indexer_service_cube.h
 * \brief use 5 buffer for matmul l1, better pipeline
 */
#ifndef PIVOT_LIGHTNING_INDEXER_SERVICE_CUBE_H
#define PIVOT_LIGHTNING_INDEXER_SERVICE_CUBE_H
...
#include "../pivot_lightning_indexer_common.h"

namespace LIKernel {
using namespace LICommon;
template <typename LIT>
class PivotLightningIndexerServiceCube {
public:
    using Q_T = typename LIT::queryType;
    using K_T = typename LIT::keyType;

    __aicore__ inline PivotLightningIndexerServiceCube(){};
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::InitParams(const ConstInfo &constInfo)
{
    constInfo_ = constInfo;
}

template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::InitBuffers(TPipe *pipe)
{
...
PivotLightningIndexerServiceCube<LIT>::InitMm1GlobalTensor(const GlobalTensor<int32_t> &blkTableGm,
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::ComputeMm1(const LICommon::RunInfo &runInfo)
{
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::KeyNd2Nz(uint64_t s2L1RealSize, uint64_t s2GmOffset,
                                                    const LICommon::RunInfo &runInfo)
{
...
// blkNum, blkSize, N2, D
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::KeyNd2NzForPA(uint64_t s2L1RealSize, uint64_t s2GmOffset,
                                                    const LICommon::RunInfo &runInfo)
{
    uint64_t s2L1Offset = 0;
    while (s2L1Offset < s2L1RealSize) {
...
// batch, s1, n2, g, d
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::QueryNd2Nz(uint64_t s1gL1RealSize, uint64_t s1gGmOffset,
                                                 const LICommon::RunInfo &runInfo)
{
    Nd2NzParams nd2nzPara;
    nd2nzPara.ndNum = 1;
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::LoadQueryToL0a(uint64_t s1gGmOffset,
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::LoadKeyToL0b(uint64_t s2L1Offset,
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::ComuteL0c(uint64_t s1gL0RealSize, uint64_t s2L0RealSize,
                                                const LICommon::RunInfo &runInfo)
{
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::Fixp(uint64_t s1gGmOffset,
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::AllocEventID()
{
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceCube<LIT>::FreeEventID()
{
