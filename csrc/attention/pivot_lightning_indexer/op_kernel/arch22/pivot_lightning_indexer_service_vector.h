...
/*!
 * \file pivot_lightning_indexer_service_vector.h
 * \brief
 */
#ifndef PIVOT_LIGHTNING_INDEXER_SERVICE_VECTOR_H
#define PIVOT_LIGHTNING_INDEXER_SERVICE_VECTOR_H
...
#include "pivot_lightning_indexer_vector.h"
...
public:
    ...
    __aicore__ inline PivotLightningIndexerServiceVector(){};
    ...
    __aicore__ inline void InitParams(const struct LICommon::ConstInfo &constInfo,
                                      const PivotLITilingData *__restrict tilingData);
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceVector<LIT>::InitBuffers(TPipe *pipe)
{
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceVector<LIT>::InitLDBuffers(TPipe *pipe)
{
    pipe->Reset();
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceVector<LIT>::InitParams(const struct LICommon::ConstInfo &constInfo,
                                                 const PivotLITilingData *__restrict tilingData)
{
...
PivotLightningIndexerServiceVector<LIT>::InitVec1GlobalTensor(GlobalTensor<MM1_OUT_T> mm1ResGm,
                                    GlobalTensor<float> vec1ResGm,
                                    GlobalTensor<int64_t> vec1ParamGm, GlobalTensor<W_T> weightsGm,
                                    GlobalTensor<int32_t> indiceOutGm, GlobalTensor<K_T> valueOutGm)
{
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceVector<LIT>::AllocEventID()
{
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceVector<LIT>::FreeEventID()
{
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceVector<LIT>::CleanInvalidOutput(int64_t invalidS1offset)
{
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceVector<LIT>::ProcessVec(const LICommon::RunInfo &info)
{
...
template <typename LIT>
__aicore__ inline void PivotLightningIndexerServiceVector<LIT>::ProcessLD()
{
