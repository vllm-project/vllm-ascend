 ...
 */
#ifndef PIVOT_LIGHTNING_INDEXER_TORCH_ADPT_H
#define PIVOT_LIGHTNING_INDEXER_TORCH_ADPT_H

namespace vllm_ascend {

std::tuple<at::Tensor, at::Tensor> construct_pivot_lightning_indexer_output_tensor(
...
std::tuple<at::Tensor, at::Tensor> npu_pivot_lightning_indexer(
    ...
    int64_t pre_tokens, int64_t next_tokens, bool return_value)
{
    ...
    auto pivot_lightning_indexer_output = construct_pivot_lightning_indexer_output_tensor(
        query, key, sparse_count, query_layout_str, key_layout_str,
        return_value);
    at::Tensor sparse_indices_out = std::get<0>(pivot_lightning_indexer_output);
    at::Tensor sparse_values_out = std::get<1>(pivot_lightning_indexer_output);

    char* query_layout_ptr = const_cast<char*>(query_layout_str.c_str());
    char* key_layout_ptr = const_cast<char*>(key_layout_str.c_str());

    EXEC_NPU_CMD(aclnnPivotLightningIndexer, query, key, weights,
...
#endif  // PIVOT_LIGHTNING_INDEXER_TORCH_ADPT_H
