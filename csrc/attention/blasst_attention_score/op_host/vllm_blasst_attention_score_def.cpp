...
/*!
 * \file blasst_attention_score_def.cpp
 * \brief
 */
...
namespace ops {
class VllmBlasstAttentionScore : public OpDef {
public:
    explicit VllmBlasstAttentionScore(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
        ...
        // Behavior switch fed from vllm_ascend BlasstConfig.flash_decode.
        ...
        aicore_config.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "blasst_attention_score")
            .ExtendCfgInfo("jitCompile.flag", "static_false,dynamic_false");
        this->AICore().AddConfig("ascend910_93", aicore_config);
    }
};
OP_ADD(VllmBlasstAttentionScore);
} // namespace ops
