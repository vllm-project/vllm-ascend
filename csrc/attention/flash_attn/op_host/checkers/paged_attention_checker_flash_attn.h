...
/*!
 * \file paged_attention_checker_flash_attn.h
 * \brief Checker for PagedAttention parameters (文档约束: Paged Attention参数组)
 */

#ifndef FLASH_ATTN_PAGED_ATTENTION_CHECKER_FLASH_ATTN_H
#define FLASH_ATTN_PAGED_ATTENTION_CHECKER_FLASH_ATTN_H
...
#endif // FLASH_ATTN_PAGED_ATTENTION_CHECKER_FLASH_ATTN_H
