...
const aclTensor *MixedQuantSparseFlashMlaMetadata(
    ...
    int64_t aicCoreNum, int64_t aivCoreNum, bool isBatchConsistency, const aclTensor *metaData, aclOpExecutor *executor)
{
    ...
    auto ret = ADD_TO_LAUNCHER_LIST_AICPU(
        ...
        OP_ATTR_NAMES({"num_heads_q",   "num_heads_kv",  "head_dim",          "quant_mode",
                       "batch_size",    "max_seqlen_q",  "max_seqlen_ori_kv", "max_seqlen_cmp_kv",
                       "ori_topk",      "cmp_topk",      "rope_head_dim",     "cmp_ratio",
