    ...
    int64_t ropeHeadDim, const aclTensor *attentionOut, uint64_t *workspaceSize, aclOpExecutor **executor)
{
    ...
    return aclnnInnerKvQuantSparseFlashAttentionGetWorkspaceSize(
        ...
        preTokens, nextTokens, attentionMode, quantScaleRepoMode, tileSize, ropeHeadDim, false, attentionOut,
        softmaxMax, softmaxSum, workspaceSize, executor);
}

aclnnStatus aclnnKvQuantSparseFlashAttention(void *workspace, uint64_t workspaceSize, aclOpExecutor *executor,
