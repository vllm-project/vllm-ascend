...
#if __has_include("../../sparse_flash_attention_vllm/arch35/util_regbase.h")
#include "../../sparse_flash_attention_vllm/arch35/util_regbase.h"
#else
#include "../../../sparse_flash_attention_vllm/op_kernel/arch35/util_regbase.h"
#endif
