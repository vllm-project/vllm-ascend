...
public:
    ...
    {
        // The V2 chain uses BF16 intermediates and FP32 gate/state tensors.
        const std::initializer_list<ge::DataType> dataTypes = {ge::DT_BF16};
        const std::initializer_list<ge::DataType> gateTypes = {ge::DT_FLOAT};
        const std::initializer_list<ge::DataType> stateTypes = {ge::DT_FLOAT};
        const std::initializer_list<ge::DataType> indexTypes = {ge::DT_INT64};
