...
#ifndef ACLNN_FUSED_INFER_ATTENTION_SCORE_V2_SINK_V2_H_
#define ACLNN_FUSED_INFER_ATTENTION_SCORE_V2_SINK_V2_H_
...
/**
 * @brief The second interface of aclnnFusedInferAttentionScoreV2SinkV2 calculates the workspace size
          based on the specific calculation process.
 * @domain aclnn_ops_infer
 */
__attribute__((visibility("default"))) aclnnStatus aclnnFusedInferAttentionScoreV2SinkV2GetWorkspaceSize(
...
/**
 * @brief The second interface of aclnnFusedInferAttentionScoreV2SinkV2 is used to perform calculations.
 */
__attribute__((visibility("default"))) aclnnStatus aclnnFusedInferAttentionScoreV2SinkV2(void *workspace,
                                                                                         uint64_t workspaceSize,
                                                                                         aclOpExecutor *executor,
