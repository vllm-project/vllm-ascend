...
#ifndef ACLNN_FUSED_INFER_ATTENTION_SCORE_V2_SINK_H_
#define ACLNN_FUSED_INFER_ATTENTION_SCORE_V2_SINK_H_
...
/**
 * @brief The first interface of aclnnFusedInferAttentionScoreV4 calculates the workspace size based on the specific
 * calculation process.
 * @domain aclnn_ops_infer
 */
__attribute__((visibility("default"))) aclnnStatus aclnnFusedInferAttentionScoreV2SinkGetWorkspaceSize(
 ...
 */
__attribute__((visibility("default"))) aclnnStatus aclnnFusedInferAttentionScoreV2Sink(void *workspace,
                                                                                       uint64_t workspaceSize,
                                                                                       aclOpExecutor *executor,
