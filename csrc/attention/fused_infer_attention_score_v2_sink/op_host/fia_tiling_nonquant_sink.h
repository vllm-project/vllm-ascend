...
/*!
 * \file fia_tiling_nonquant_sink.h
 * \brief
 */
#ifndef FIA_TILING_NONQUANT_SINK_H
#define FIA_TILING_NONQUANT_SINK_H
...
public:
    ...
    ~FiaTilingNonQuant() noexcept override = default;
...
#endif // FIA_TILING_NONQUANT_SINK_H
