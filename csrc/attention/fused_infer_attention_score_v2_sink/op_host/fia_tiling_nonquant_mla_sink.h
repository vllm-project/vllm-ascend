...
/*!
 * \file fia_tiling_nonquant_mla_sink.h
 * \brief
 */
#ifndef FIA_TILING_NONQUNAT_MLA_SINK_H
#define FIA_TILING_NONQUNAT_MLA_SINK_H
...
class FiaTilingNonQuantMla : public FiaTilingBase {
  public:
    ...
    ~FiaTilingNonQuantMla() noexcept override = default;
  ...
  private:
    ...
    uint64_t
    CalcNormalWorkspaceSize(uint32_t coreNum, int64_t mm1ResSize, int64_t mm2ResSize, uint32_t mBaseSize) const;
    ...
    // set info to context
    FusedInferAttentionScoreV2SinkTilingData tilingData_;
...
#endif // FIA_TILING_NONQUNAT_MLA_SINK_H
