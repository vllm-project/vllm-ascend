...
#include "../vendor/c6240b268/checkers/base_checker_sparse_flash_mla.h"

namespace optiling {
namespace mixed_quant_smla_checker {

class MixedQuantVariantChecker : public BaseChecker {
public:
...
#endif // MIXED_QUANT_SPARSE_MLA_VARIANT_CHECKER_H
