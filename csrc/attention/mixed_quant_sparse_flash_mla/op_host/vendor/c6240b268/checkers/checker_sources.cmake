...
set(MQSMLA_C624_COMMON_CHECKER_SRC_FILES
...
function(add_mqsmla_c624_common_checker_sources target_name)
    get_property(common_checker_added TARGET ${target_name} PROPERTY MQSMLA_C624_COMMON_CHECKER_ADDED)
    if(NOT common_checker_added)
        target_sources(${target_name} PRIVATE ${MQSMLA_C624_COMMON_CHECKER_SRC_FILES})
        set_property(TARGET ${target_name} PROPERTY MQSMLA_C624_COMMON_CHECKER_ADDED TRUE)
    endif()
endfunction()
