...
/*! \file dgemma_fused_router_front_utils.h
 *  \brief cross-core FFTS sync helpers (mirrors matmul_allreduce_add_rmsnorm_utils.h). */
#ifndef DGEMMA_FUSED_ROUTER_FRONT_UTILS_H
#define DGEMMA_FUSED_ROUTER_FRONT_UTILS_H
...
constexpr int32_t AIV_WAIT_AIC_FINISH_ROUTER_FLAG_ID = 7;
...
#endif // DGEMMA_FUSED_ROUTER_FRONT_UTILS_H
