"""ST ATK plugin: PAGED_BBND dim0 non-contiguous KV (FIA fused cache).

Golden stays on the contiguous plugin. NPU path rewrites key/value then
delegates to parent init.

  atk ... -p aclnn_genericblocksparseattention_uncon.py
"""
...
class GenericBlockSparseAttentionInputProcessUncon(_ContigInputProcess):
