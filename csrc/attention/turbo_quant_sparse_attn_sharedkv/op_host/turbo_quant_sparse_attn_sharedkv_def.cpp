...
/*!
 * \file turbo_quant_sparse_attn_sharedkv_def.cpp
 * \brief
 */
...
namespace ops {
class TurboQuantSparseAttnSharedkv : public OpDef {
public:
    explicit TurboQuantSparseAttnSharedkv(const char *name)
        : OpDef(name)
    {
        this->Input("q")
            .ParamType(REQUIRED)
...
OP_ADD(TurboQuantSparseAttnSharedkv);
} // namespace ops
