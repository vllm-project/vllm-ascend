...
/*!
 * \file sparse_flash_attention_for_offload_tiling.h
 * \brief
 */
#ifndef SPARSE_FLASH_ATTENTION_FOR_OFFLOAD_TILING_H
#define SPARSE_FLASH_ATTENTION_FOR_OFFLOAD_TILING_H
...
namespace optiling {
// The offload operator is built into the same optiling shared library as the
// native SparseFlashAttention operator. Keep copied/private tiling helpers in a
// dedicated namespace so their C++ symbols cannot collide at link time. The
// registered tiling-data classes remain directly under optiling because their
// operator-facing names are already unique.
namespace sfa_offload {
// Inputs Index
...
constexpr uint32_t TAIL_INFO_INPUT_INDEX = 4;
...
constexpr uint32_t OFFLOAD_SPARSE_INDICES_CAPACITY = 16384;
constexpr uint32_t OFFLOAD_SPARSE_COMPUTE_COUNT = 2048;
constexpr uint32_t OFFLOAD_TAIL_CAPACITY = 128;
...
struct SFAParaInfo {
    ...
    SFARequiredParaInfo tailInfo = {nullptr, nullptr};
...
BEGIN_TILING_DATA_DEF(SparseFlashAttentionForOffloadBaseParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionForOffloadBaseParamsMlaOp, SparseFlashAttentionForOffloadBaseParamsMla)

BEGIN_TILING_DATA_DEF(SparseFlashAttentionForOffloadSingleCoreParamsMla)
TILING_DATA_FIELD_DEF(uint32_t, usedCoreNum);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionForOffloadSingleCoreParamsMlaOp, SparseFlashAttentionForOffloadSingleCoreParamsMla)

BEGIN_TILING_DATA_DEF(SparseFlashAttentionForOffloadSingleCoreTensorSizeMla)
TILING_DATA_FIELD_DEF(uint32_t, mmResUbSize);
TILING_DATA_FIELD_DEF(uint32_t, bmm2ResUbSize);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionForOffloadSingleCoreTensorSizeMlaOp, SparseFlashAttentionForOffloadSingleCoreTensorSizeMla)

BEGIN_TILING_DATA_DEF(SparseFlashAttentionForOffloadSplitKVParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionForOffloadSplitKVParamsMlaOp, SparseFlashAttentionForOffloadSplitKVParamsMla)

BEGIN_TILING_DATA_DEF(SparseFlashAttentionForOffloadInnerSplitParams)
TILING_DATA_FIELD_DEF(uint32_t, mBaseSize)
TILING_DATA_FIELD_DEF(uint32_t, s2BaseSize)
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionForOffloadInnerSplitParamsOp, SparseFlashAttentionForOffloadInnerSplitParams)

BEGIN_TILING_DATA_DEF(SparseFlashAttentionForOffloadTilingDataMla)
TILING_DATA_FIELD_DEF_STRUCT(SparseFlashAttentionForOffloadBaseParamsMla, baseParams);
TILING_DATA_FIELD_DEF_STRUCT(SparseFlashAttentionForOffloadSplitKVParamsMla, splitKVParams);
TILING_DATA_FIELD_DEF_STRUCT(SparseFlashAttentionForOffloadSingleCoreParamsMla, singleCoreParams);
TILING_DATA_FIELD_DEF_STRUCT(SparseFlashAttentionForOffloadSingleCoreTensorSizeMla, singleCoreTensorSize);
TILING_DATA_FIELD_DEF_STRUCT(SparseFlashAttentionForOffloadInnerSplitParams, innerSplitParams);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(SparseFlashAttentionForOffload, SparseFlashAttentionForOffloadTilingDataMla)
...
private:
    ...
    SparseFlashAttentionForOffloadTilingDataMla tilingData_;
...
#endif // SPARSE_FLASH_ATTENTION_FOR_OFFLOAD_TILING_H
