...
const aclTensor *RecurrentGatedDeltaRule(const aclTensor *query, const aclTensor *key, const aclTensor *value,
                                         ...
                                         const aclTensor *numAcceptedTokens, float scaleValue, int64_t stateStride0,
                                         int64_t stateStride1, int64_t stateStride2, aclOpExecutor *executor)
{
    ...
    auto ret = INFER_SHAPE(
        ...
        OP_OUTPUT(out, stateRef), OP_ATTR(scaleValue, stateStride0, stateStride1, stateStride2));
