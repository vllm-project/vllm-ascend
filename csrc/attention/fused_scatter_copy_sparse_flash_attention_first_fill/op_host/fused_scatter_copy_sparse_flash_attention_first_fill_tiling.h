...
BEGIN_TILING_DATA_DEF(FusedScatterCopySparseFlashAttentionFirstFillTilingData)
...
REGISTER_TILING_DATA_CLASS(
    FusedScatterCopySparseFlashAttentionFirstFill,
    FusedScatterCopySparseFlashAttentionFirstFillTilingData)

struct FusedScatterCopySparseFlashAttentionFirstFillCompileInfo {
};
