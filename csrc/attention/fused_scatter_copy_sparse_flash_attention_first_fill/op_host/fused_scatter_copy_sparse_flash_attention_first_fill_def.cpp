...
class FusedScatterCopySparseFlashAttentionFirstFill : public OpDef {
public:
    explicit FusedScatterCopySparseFlashAttentionFirstFill(const char *name) : OpDef(name)
    {
...
OP_ADD(FusedScatterCopySparseFlashAttentionFirstFill);
