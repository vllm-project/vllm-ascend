...
#include "fused_scatter_copy_sparse_flash_attention_first_fill_tiling.h"
...
ge::graphStatus TilingFusedScatterCopySparseFlashAttentionFirstFill(
    gert::TilingContext *context)
{
    ...
    FusedScatterCopySparseFlashAttentionFirstFillTilingData tiling;
...
ge::graphStatus TilingPrepareFusedScatterCopySparseFlashAttentionFirstFill(
...
IMPL_OP_OPTILING(FusedScatterCopySparseFlashAttentionFirstFill)
    .Tiling(TilingFusedScatterCopySparseFlashAttentionFirstFill)
    .TilingParse<FusedScatterCopySparseFlashAttentionFirstFillCompileInfo>(
        TilingPrepareFusedScatterCopySparseFlashAttentionFirstFill);
