...
/*!
 * \file aclnn_fused_infer_attention_score_v2_sink_metadata.cpp
 * \brief
 */

#include "aclnn_fused_infer_attention_score_v2_sink_metadata.h"
...
aclnnStatus aclnnFusedInferAttentionScoreV2SinkMetadataGetWorkspaceSize(const aclTensor *actualSeqLengthsOptional,
                                                                        const aclTensor *actualSeqLengthsKvOptional,
                                                                        int64_t numHeadsQ,
                                                                        int64_t numHeadsKv,
                                                                        int64_t headDimQk,
...
{
    L2_DFX_PHASE_1(aclnnFusedInferAttentionScoreV2SinkMetadata,
...
__attribute__((visibility("default"))) aclnnStatus aclnnFusedInferAttentionScoreV2SinkMetadata(void *workspace,
                                                                                               ...
                                                                                               aclrtStream stream)
{
    L2_DFX_PHASE_2(aclnnFusedInferAttentionScoreV2SinkMetadata);
