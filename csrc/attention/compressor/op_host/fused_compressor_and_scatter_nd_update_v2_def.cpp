...
namespace ops {
class FusedCompressorAndScatterNdUpdateV2 : public OpDef {
public:
    ...
    explicit FusedCompressorAndScatterNdUpdateV2(const char *name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        this->Attr("scatter_block_size").AttrType(OPTIONAL).Int(0);
        ...
        config910.Input("rope_cos")
            ...
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config910.Input("slot_mapping")
            .ParamType(REQUIRED)
            .DataTypeList({ge::DT_INT32})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config910.Input("paged_kv_cache")
            .ParamType(REQUIRED)
            .DataType({ge::DT_BF16, ge::DT_FLOAT16, ge::DT_BF16, ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .IgnoreContiguous();
        ...
        config910.Output("state_cache")
            ...
            .DataTypeList({ge::DT_FLOAT})
            .FormatList({ge::FORMAT_ND});
        config910.Output("paged_kv_cache")
            .ParamType(REQUIRED)
            .DataType({ge::DT_BF16, ge::DT_FLOAT16, ge::DT_BF16, ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND});
...
OP_ADD(FusedCompressorAndScatterNdUpdateV2, optiling::CompressorCompileInfo);
} // namespace ops
