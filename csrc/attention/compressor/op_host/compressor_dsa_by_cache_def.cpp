...
namespace ops {
class CompressorDsaByCache : public OpDef {
public:
    ...
    explicit CompressorDsaByCache(const char *name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        config910.Input("norm_weight")
            ...
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config910.Input("compress_positions")
            .ParamType(REQUIRED)
            .DataTypeList({ge::DT_INT64})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        config910.Input("cos_sin_cache")
            .ParamType(REQUIRED)
            .DataType({ge::DT_BF16, ge::DT_FLOAT16})
            .FormatList({ge::FORMAT_ND})
            .AutoContiguous();
        ...
        config910.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "compressor_dsa_by_cache")
...
OP_ADD(CompressorDsaByCache, optiling::CompressorCompileInfo);
}  // namespace ops
