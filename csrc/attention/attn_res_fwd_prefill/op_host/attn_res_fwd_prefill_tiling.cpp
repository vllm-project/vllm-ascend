...
namespace optiling {
REGISTER_OPS_TILING_TEMPLATE(AttnResFwdPrefill, AttnResFwdTiling, 0);
...
IMPL_OP_OPTILING(AttnResFwdPrefill).Tiling(Tiling).TilingParse<AttnResFwdCompileInfo>(Parse);
}
