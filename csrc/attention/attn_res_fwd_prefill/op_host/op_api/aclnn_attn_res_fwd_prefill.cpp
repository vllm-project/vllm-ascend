...
#include "aclnn_attn_res_fwd_prefill.h"
#include "opdev/make_op_executor.h"
#include "opdev/op_def.h"
#include "opdev/op_executor.h"
#include "opdev/tensor_view_utils.h"
using namespace op;
namespace l0op { OP_TYPE_REGISTER(AttnResFwdPrefill); }
using namespace l0op;
extern "C" aclnnStatus aclnnAttnResFwdPrefillGetWorkspaceSize(
    ...
    uint64_t *workspaceSize, aclOpExecutor **executorOut)
{
    ...
    auto ret = ADD_TO_LAUNCHER_LIST_AICORE(AttnResFwdPrefill,
...
extern "C" aclnnStatus aclnnAttnResFwdPrefill(
