...
ge::graphStatus MlaPrologTiling::ConvertContext(gert::TilingContext &context, MlaPrologContext &mlaPrologContext)
{
    ...
    // DCP C8 appends outputs but preserves the V3 input and attribute prefix.
    mlaPrologContext.opType = std::strcmp(context.GetNodeType(), "MlaPrologDcpC8") == 0
        ? V3_OP_NAME : context.GetNodeType();
