...
/*!
 * \file fused_scatter_copy_sparse_flash_attention_common.h
 * \brief
 */

#ifndef FUSED_SCATTER_COPY_SPARSE_FLASH_ATTENTION_COMMON_H
#define FUSED_SCATTER_COPY_SPARSE_FLASH_ATTENTION_COMMON_H
...
template <typename Q_T, typename KV_T, typename OUT_T, const bool FLASH_DECODE = false,
	  SFA_LAYOUT LAYOUT_T = SFA_LAYOUT::BSND, SFA_LAYOUT KV_LAYOUT_T = SFA_LAYOUT::BSND,
          ...
          const bool MTP_MODE = false, typename... Args>
struct SFAType {
    using queryType = Q_T;
    using kvType = KV_T;
    ...
    static constexpr bool mtpMode = MTP_MODE;
...
#endif // FUSED_SCATTER_COPY_SPARSE_FLASH_ATTENTION_COMMON_H
