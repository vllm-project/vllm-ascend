...
/*!
 * \file fused_scatter_copy_sparse_flash_attention_tiling_impl.h
 * \brief
 */
#ifndef FUSED_SCATTER_COPY_SPARSE_FLASH_ATTENTION_TILING_IMPL_H
#define FUSED_SCATTER_COPY_SPARSE_FLASH_ATTENTION_TILING_IMPL_H
...
const uint32_t FusedScatterCopySparseFlashAttention_MAX_AIC_CORE_NUM = 26;
...
struct FusedScatterCopySparseFlashAttentionTilingShapeCompareParam {
    int64_t B = 1;
    int64_t S = 1;
    int64_t N = 1;
    int64_t D = 1;
...
enum class FusedScatterCopySparseFlashAttentionKvStorageMode : uint32_t {
    BATCH_CONTINUOUS = 0,
    PAGE_ATTENTION = 1
};

enum class FusedScatterCopySparseFlashAttentionPerfMode : uint32_t {
    C_TEMPLATE_MODE = 0,
    V_TEMPLATE_MODE
};

enum class FusedScatterCopySparseFlashAttentionAxis : uint32_t {
    B = 0,
    S = 1,
    N = 2,
    D = 3,
...
struct FusedScatterCopySparseFlashAttentionRequiredParaInfo {
    const gert::CompileTimeTensorDesc *desc;
    const gert::StorageShape *shape;
};

struct FusedScatterCopySparseFlashAttentionOptionalParaInfo {
    const gert::CompileTimeTensorDesc *desc;
    const gert::Tensor *tensor;
};

struct FusedScatterCopySparseFlashAttentionParaInfo {
    FusedScatterCopySparseFlashAttentionRequiredParaInfo query = {nullptr, nullptr};
    FusedScatterCopySparseFlashAttentionRequiredParaInfo key = {nullptr, nullptr};
    FusedScatterCopySparseFlashAttentionRequiredParaInfo value = {nullptr, nullptr};
    FusedScatterCopySparseFlashAttentionRequiredParaInfo sparseIndices = {nullptr, nullptr};
    FusedScatterCopySparseFlashAttentionRequiredParaInfo cacheTokens = {nullptr, nullptr};
    FusedScatterCopySparseFlashAttentionOptionalParaInfo blockTable = {nullptr, nullptr};
    FusedScatterCopySparseFlashAttentionOptionalParaInfo actualSeqLengthsQ = {nullptr, nullptr};
    FusedScatterCopySparseFlashAttentionOptionalParaInfo actualSeqLengths = {nullptr, nullptr};
    FusedScatterCopySparseFlashAttentionOptionalParaInfo queryRope = {nullptr, nullptr};
    FusedScatterCopySparseFlashAttentionOptionalParaInfo keyRope = {nullptr, nullptr};
    FusedScatterCopySparseFlashAttentionRequiredParaInfo attenOut = {nullptr, nullptr};
...
BEGIN_TILING_DATA_DEF(FusedScatterCopySparseFlashAttentionBaseParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(FusedScatterCopySparseFlashAttentionBaseParamsMlaOp, FusedScatterCopySparseFlashAttentionBaseParamsMla)

BEGIN_TILING_DATA_DEF(FusedScatterCopySparseFlashAttentionSingleCoreParamsMla)
TILING_DATA_FIELD_DEF(uint32_t, usedCoreNum);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(FusedScatterCopySparseFlashAttentionSingleCoreParamsMlaOp, FusedScatterCopySparseFlashAttentionSingleCoreParamsMla)

BEGIN_TILING_DATA_DEF(FusedScatterCopySparseFlashAttentionSingleCoreTensorSizeMla)
TILING_DATA_FIELD_DEF(uint32_t, mmResUbSize);
TILING_DATA_FIELD_DEF(uint32_t, bmm2ResUbSize);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(FusedScatterCopySparseFlashAttentionSingleCoreTensorSizeMlaOp, FusedScatterCopySparseFlashAttentionSingleCoreTensorSizeMla)

BEGIN_TILING_DATA_DEF(FusedScatterCopySparseFlashAttentionSplitKVParamsMla)
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(FusedScatterCopySparseFlashAttentionSplitKVParamsMlaOp, FusedScatterCopySparseFlashAttentionSplitKVParamsMla)

BEGIN_TILING_DATA_DEF(FusedScatterCopySparseFlashAttentionInnerSplitParams)
TILING_DATA_FIELD_DEF(uint32_t, mBaseSize)
TILING_DATA_FIELD_DEF(uint32_t, s2BaseSize)
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(FusedScatterCopySparseFlashAttentionInnerSplitParamsOp, FusedScatterCopySparseFlashAttentionInnerSplitParams)

BEGIN_TILING_DATA_DEF(FusedScatterCopySparseFlashAttentionTilingDataMla)
...
END_TILING_DATA_DEF
template <typename T> inline T FusedScatterCopySparseFlashAttentionAlign(T num, T rnd)
{
    return (((rnd) == 0) ? 0 : (((num) + (rnd) - 1) / (rnd) * (rnd)));
}

template <typename T>
std::string FusedScatterCopySparseFlashAttentionShape2String(const T &shape)
{
...
struct FusedScatterCopySparseFlashAttentionTilingInfo {
    const char *opName = nullptr;
    fe::PlatFormInfos *platformInfo = nullptr;
    FusedScatterCopySparseFlashAttentionParaInfo opParamInfo;
    ...
    FusedScatterCopySparseFlashAttentionKvStorageMode kvStorageMode = FusedScatterCopySparseFlashAttentionKvStorageMode::BATCH_CONTINUOUS;

    FusedScatterCopySparseFlashAttentionLayout qLayout = FusedScatterCopySparseFlashAttentionLayout::BSND;
    FusedScatterCopySparseFlashAttentionLayout topkLayout = FusedScatterCopySparseFlashAttentionLayout::BSND;
    FusedScatterCopySparseFlashAttentionLayout outLayout = FusedScatterCopySparseFlashAttentionLayout::BSND;
    FusedScatterCopySparseFlashAttentionLayout kvLayout = FusedScatterCopySparseFlashAttentionLayout::BSND;
...
class FusedScatterCopySparseFlashAttentionTiling {
public:
    explicit FusedScatterCopySparseFlashAttentionTiling(gert::TilingContext *context) : context_(context) {}
    ge::graphStatus DoOpTiling(FusedScatterCopySparseFlashAttentionTilingInfo *sfaInfo);
...
private:
    ...
    uint32_t coreNum_ = 0;
    FusedScatterCopySparseFlashAttentionPerfMode perfMode_ = FusedScatterCopySparseFlashAttentionPerfMode::V_TEMPLATE_MODE;
    ...
    FusedScatterCopySparseFlashAttentionTilingDataMla tilingData_;
    ...
    FusedScatterCopySparseFlashAttentionTilingInfo *sfaInfo_ = nullptr;
};

class FusedScatterCopySparseFlashAttentionTilingCheck {
public:
    explicit FusedScatterCopySparseFlashAttentionTilingCheck(const FusedScatterCopySparseFlashAttentionTilingInfo &sfaInfo) : sfaInfo_(sfaInfo) {};
    ~FusedScatterCopySparseFlashAttentionTilingCheck() = default;
...
private:
    ...
    ge::graphStatus CheckDimNumInLayoutSupport(const FusedScatterCopySparseFlashAttentionLayout &layout,
        const gert::StorageShape *shape, const std::string &name) const;
    void LogErrorLayoutSupport(const std::vector<FusedScatterCopySparseFlashAttentionLayout> &expectLayoutList,
    ...
    ge::graphStatus CompareShape(FusedScatterCopySparseFlashAttentionTilingShapeCompareParam &param,
        const gert::Shape &shape, const FusedScatterCopySparseFlashAttentionLayout &layout, const std::string &name) const;
    ge::graphStatus CheckLayoutSupport(const FusedScatterCopySparseFlashAttentionLayout &actualLayout, const std::string &name) const;
    ...
    ge::graphStatus GetActualSeqLenSize(uint32_t &size, const gert::Tensor *tensor,
        const FusedScatterCopySparseFlashAttentionLayout &layout, const std::string &name);
    void SetFusedScatterCopySparseFlashAttentionShapeCompare();
...
private:
    ...
    FusedScatterCopySparseFlashAttentionParaInfo opParamInfo_;
    const FusedScatterCopySparseFlashAttentionTilingInfo &sfaInfo_;
    ...
    uint32_t qTSize_ = 0;
    uint32_t kvTSize_ = 0;
    FusedScatterCopySparseFlashAttentionKvStorageMode kvStorageMode_ = FusedScatterCopySparseFlashAttentionKvStorageMode::BATCH_CONTINUOUS;
    uint32_t sparseBlockCount_ = 0;
    int64_t sparseBlockSize_ = 0;

    FusedScatterCopySparseFlashAttentionLayout qLayout_ = FusedScatterCopySparseFlashAttentionLayout::BSND;
    FusedScatterCopySparseFlashAttentionLayout topkLayout_ = FusedScatterCopySparseFlashAttentionLayout::BSND;
    FusedScatterCopySparseFlashAttentionLayout outLayout_ = FusedScatterCopySparseFlashAttentionLayout::BSND;
    FusedScatterCopySparseFlashAttentionLayout kvLayout_ = FusedScatterCopySparseFlashAttentionLayout::BSND;
...
class FusedScatterCopySparseFlashAttentionInfoParser {
public:
    explicit FusedScatterCopySparseFlashAttentionInfoParser(const gert::TilingContext *context) : context_(context) {}
    ~FusedScatterCopySparseFlashAttentionInfoParser() = default;
    ...
    ge::graphStatus GetFusedScatterCopySparseFlashAttentionKvStorageMode();
    ge::graphStatus GetKvLayout();
    void SetFusedScatterCopySparseFlashAttentionShape();
    ...
    void GenerateInfo(FusedScatterCopySparseFlashAttentionTilingInfo &sfaInfo);
    ge::graphStatus Parse(FusedScatterCopySparseFlashAttentionTilingInfo &sfaInfo);

public:
    bool HasAxis(const FusedScatterCopySparseFlashAttentionAxis &axis, const FusedScatterCopySparseFlashAttentionLayout &layout, const gert::Shape &shape) const;
    size_t GetAxisIdx(const FusedScatterCopySparseFlashAttentionAxis &axis, const FusedScatterCopySparseFlashAttentionLayout &layout) const;
    uint32_t GetAxisNum(const gert::Shape &shape, const FusedScatterCopySparseFlashAttentionAxis &axis,const FusedScatterCopySparseFlashAttentionLayout &layout) const;
...
#endif // FUSED_SCATTER_COPY_SPARSE_FLASH_ATTENTION_TILING_IMPL_H
