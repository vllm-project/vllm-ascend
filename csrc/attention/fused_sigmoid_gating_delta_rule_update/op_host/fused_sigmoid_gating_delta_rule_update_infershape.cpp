...
/* !
 * \file fused_sigmoid_gating_delta_rule_update_infershape.cpp
 * \brief
 */
#include <map>
#include <string>
...
static ge::graphStatus InferShapeFusedSigmoidGatingDeltaRuleUpdate(InferShapeContext *context)
{
    if (context == nullptr) {
        OP_LOGE("FusedSigmoidGatingDeltaRuleUpdate", "inference context is null");
...
static ge::graphStatus InferDataTypeFusedSigmoidGatingDeltaRuleUpdate(gert::InferDataTypeContext *context)
{
...
IMPL_OP_INFERSHAPE(FusedSigmoidGatingDeltaRuleUpdate)
    .InferShape(InferShapeFusedSigmoidGatingDeltaRuleUpdate)
    .InferDataType(InferDataTypeFusedSigmoidGatingDeltaRuleUpdate);
} // namespace ops
