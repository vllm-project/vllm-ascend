...
OP_TYPE_REGISTER(FusedSigmoidGatingDeltaRuleUpdate);
...
{
    L0_DFX(FusedSigmoidGatingDeltaRuleUpdate, aLog, a, b, dtBias, query, key, value, stateRef, actualSeqLengths,
           ssmStateIndices, numAcceptedTokens, scaleValue, softplusBeta, softplusThreshold);
    ...
    auto ret = INFER_SHAPE(
        ...
        OP_INPUT(aLog, a, b, dtBias, query, key, value, stateRef, actualSeqLengths, ssmStateIndices,
                 numAcceptedTokens),
        OP_OUTPUT(out, stateRef), OP_ATTR(scaleValue, softplusBeta, softplusThreshold));
    OP_CHECK_INFERSHAPE(ret != ACLNN_SUCCESS, return nullptr, "FusedSigmoidGatingDeltaRuleUpdate InferShape failed.");
    ...
    OP_CHECK_ADD_TO_LAUNCHER_LIST_AICORE(ret != ACLNN_SUCCESS, return nullptr,
                                         "FusedSigmoidGatingDeltaRuleUpdate ADD_TO_LAUNCHER_LIST_AICORE failed.");
