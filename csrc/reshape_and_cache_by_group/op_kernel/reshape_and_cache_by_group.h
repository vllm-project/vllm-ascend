...
#ifndef ASCEND_RESHAPE_AND_CACHE_BY_GROUP_H
#define ASCEND_RESHAPE_AND_CACHE_BY_GROUP_H

#include "kernel_operator.h"

namespace ReshapeAndCacheByGroup {
using namespace AscendC;


#ifndef RESHAPE_AND_CACHE_BY_GROUP_TILING_DATA_H_
#define RESHAPE_AND_CACHE_BY_GROUP_TILING_DATA_H_
struct ReshapeAndCacheByGroupTilingData{
...
#endif
template <typename T>
class ReshapeAndCacheByGroupBase {
public:
    ...
    __aicore__ inline void Init( AscendC::TPipe *pipe, ReshapeAndCacheByGroupTilingData *tilingData)
    {
        pipeThis = pipe;
