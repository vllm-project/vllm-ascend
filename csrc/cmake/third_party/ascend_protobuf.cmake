...
if(ascend_protobuf_build_transformer_FOUND AND NOT FORCE_REBUILD_CANN_3RD)
    ...
    # Cache-correctness boundary: source trees are prepared inputs, effective
    # CMake options are the recipe, and executable versions are the compiler
    # environment. Keep these groups aligned with ExternalProject_Add below;
    # an omitted semantic input can produce a false cache HIT.
    # Hash the effective build recipe rather than the CMake file text, so
    # comments and workspace paths do not create false misses.
    set(
