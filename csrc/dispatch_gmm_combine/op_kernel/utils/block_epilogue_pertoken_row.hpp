...
#ifndef CATLASS_EPILOGUE_BLOCK_EPILOGUE_PER_TOKEN_ONLY_HPP
#define CATLASS_EPILOGUE_BLOCK_EPILOGUE_PER_TOKEN_ONLY_HPP
...
public:
    ...
    )
    {
        ...
        for (uint32_t loopIdx = 0; loopIdx < tileLoops; loopIdx ++) {
            ...
            //AscendC::Cast(ubD, ubCFp32, AscendC::RoundMode::CAST_NONE, blockN);
