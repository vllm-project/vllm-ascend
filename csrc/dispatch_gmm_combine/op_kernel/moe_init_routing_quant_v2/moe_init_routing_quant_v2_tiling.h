...
struct MoeInitRoutingQuantV2TilingData {
    ...
    // CATLASS_DEVICE
    // MoeInitRoutingQuantV2TilingData(const MoeInitRoutingQuantV2TilingData& rhs) 
    //     : coreNum(rhs.coreNum), n(rhs.n), cols(rhs.cols), k(rhs.k), expertCapacity(rhs.expertCapacity)
    //     , expertNum(rhs.expertNum), dropPadMode(rhs.dropPadMode)
    //     , expertTokensCountOrCumsumFlag(rhs.expertTokensCountOrCumsumFlag)
    //     , expertTokensBeforeCapacityFlag(rhs.expertTokensBeforeCapacityFlag), smoothType(rhs.smoothType)
    //     , vbsComputeParamsOp(rhs.vbsComputeParamsOp)
    //     , vmsMiddleComputeParamsOp(rhs.vmsMiddleComputeParamsOp)
    //     , sortOutComputeParamsOp(rhs.sortOutComputeParamsOp)
    //     , srcToDstComputeParamsOp(rhs.srcToDstComputeParamsOp)
    //     , srcToDstCapacityComputeParamsOp(rhs.srcToDstCapacityComputeParamsOp)
    //     , gatherOutComputeParamsOp(rhs.gatherOutComputeParamsOp) {
    // }
};
...
void MoeInitRoutingQuantV2TilingBase::Tiling4GatherDynamicQuant() {
  ...
  tilingData->needCoreNum = (CeilDiv(totalLength, perCoreRows));
  //int64_t cols = quantTilingData.cols;
