    ...
    gert::TilingContext *context, PPTilingData &ppTilingData, CommTilingData &commTilingData)
{
    ...
    ppTilingData.m0 =
        GetValueFromMKNConditionMap(m, n, ALLREDUCE_EIGHT_RANK_FP16_M0_DEFAULT, ALLREDUCE_EIGHT_RANK_FP16_M0_MAP);
    ...
    commTilingData.ubMoveNum = GetValueFromMKNConditionMap(
            m, n, ALLREDUCE_EIGHT_RANK_FP16_UBMOVENUM_DEFAULT, ALLREDUCE_EIGHT_RANK_FP16_UBMOVENUM_MAP) *
        HALF_KBYTE;
