...
TORCH_LIBRARY_IMPL_EXPAND(CONCAT(_C, _ascend), Meta, ops) {
    ...
    ops.impl("npu_quant_lightning_indexer_v2_cann", &vllm_ascend::meta::npu_quant_lightning_indexer_v2_meta);
    ops.impl("npu_quant_lightning_indexer_v2_metadata_cann", &vllm_ascend::meta::npu_quant_lightning_indexer_v2_metadata_meta);
