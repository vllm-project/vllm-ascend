...
private:
    ...
    TBuf<TPosition::VECCALC> tmpBuff; // 动态量化的中间结果
...
template <typename T, const int COPYOUTTYPE, const int SMOOTHTYPE>
__aicore__ inline void MoeV3FullLoadDynamicQuant<T, COPYOUTTYPE, SMOOTHTYPE>::ComputeQuant(LocalTensor<float>& smoothLocal)
{
