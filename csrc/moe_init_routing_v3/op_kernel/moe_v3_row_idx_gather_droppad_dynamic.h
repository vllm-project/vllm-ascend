...
#include "moe_v3_common.h" // to do 与v2的对比一下
...
template <typename T, typename TilingData>
__aicore__ inline float MoeV3SrcToDstAndGather<T, TilingData>::ComputeMax(
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::ComputeScale(
    LocalTensor<float>& inLocal, LocalTensor<float>& tempLocal, float scaleTemp, int64_t dstIndex, int64_t j)
{
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::ComputeLoops(
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstAndGather<T, TilingData>::Init(
