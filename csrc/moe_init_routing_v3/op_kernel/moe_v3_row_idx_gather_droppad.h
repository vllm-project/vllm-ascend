...
private:
    ...
    const MoeV3SrcToDstCapacityComputeTilingData* srcToDstTilingData; // 注意：适配
...
template <typename T, typename TilingData>
__aicore__ inline void MoeV3SrcToDstWithCapacity<T, TilingData>::Init(
...
#endif // MOE_V3_SRC_TO_DST_WITH_CAPACITY_H