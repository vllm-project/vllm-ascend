...
/* !
 * \file swi_glu_dynamic_quant_static.h
 * \brief
 */
#ifndef SWI_GLU_DYNAMIC_QUANT_STATIC_H
#define SWI_GLU_DYNAMIC_QUANT_STATIC_H
...
class SwiGluDynamicQuantStatic : public SwiGluDynamicQuantBase {
public:
    __aicore__ inline SwiGluDynamicQuantStatic(TPipe *pipe)
    {
        pPipe = pipe;
    }
...
#endif // SWI_GLU_DYNAMIC_QUANT_STATIC_H
