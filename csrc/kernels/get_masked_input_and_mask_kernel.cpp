...
class GetMaskedInputAndMask {
 public:
  ...
  __aicore__ inline void Init(
      __gm__ scalar_t* input, __gm__ scalar_t* masked_input,
 ...
 private:
  ...
  __aicore__ inline void CompareWithValue(
      ...
      const AscendC::LocalTensor<float>& compare_value, bool is_greater_equal) {
  ...
  __aicore__ inline void ComputeRangeMask(
      ...
      const AscendC::LocalTensor<float>& input, const float start_value,
