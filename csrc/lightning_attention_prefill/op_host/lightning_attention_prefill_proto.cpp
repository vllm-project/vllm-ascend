...
static ge::graphStatus InferShapeLightningAttentionPrefill(gert::InferShapeContext* context)
{
...
static ge::graphStatus InferDataTypeLightningAttentionPrefill(gert::InferDataTypeContext *context)
{
...
IMPL_OP_INFERSHAPE(LightningAttentionPrefill)
    .InferShape(InferShapeLightningAttentionPrefill)
    .InferDataType(InferDataTypeLightningAttentionPrefill);
