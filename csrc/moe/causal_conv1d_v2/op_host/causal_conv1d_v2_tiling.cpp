...
/*!
 * \file causal_conv1d_v2_tiling.cpp
 * \brief CausalConv1dV2 tiling entry and template registration.
 */

#include "tiling_base/tiling_templates_registry.h"
#include "causal_conv1d_v2_tiling_utils.h"
#include "causal_conv1d_v2_tiling_planner.h"
#include "causal_conv1d_v2_tiling_validation.h"

namespace optiling {

using namespace Ops::Transformer::OpTiling;
using namespace causal_conv1d_v2_host;

static ge::graphStatus CausalConv1dV2TilingFunc(gert::TilingContext *context)
{
    uint64_t ubSize = 0;
    uint32_t coreNum = 0;
    ...
    CausalConv1dV2TilingData *tiling = context->GetTilingData<CausalConv1dV2TilingData>();
    OP_CHECK_NULL_WITH_CONTEXT(context, tiling);
    OP_CHECK_IF(memset_s(tiling, sizeof(CausalConv1dV2TilingData), 0, sizeof(CausalConv1dV2TilingData)) != EOK,
                OP_LOGE(context, "set tiling data error"), return ge::GRAPH_FAILED);

    CausalConv1dV2AttrInfo attrInfo;
    ...
    const bool &isFn = (runModeKey == CAUSAL_CONV1D_V2_TPL_RUN_MODE_FN);
...
static ge::graphStatus TilingParseForCausalConv1dV2(gert::TilingParseContext *context)
{
    OP_LOGD(context, "Enter TilingParseForCausalConv1dV2.");
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_OPTILING(CausalConv1dV2)
    .Tiling(CausalConv1dV2TilingFunc)
    .TilingParse<CausalConv1dV2CompileInfo>(TilingParseForCausalConv1dV2);
