...
/*!
 * \file causal_conv1d_v2_def.cpp
 * \brief CausalConv1dV2 operator definition and registration.
 */
...
class CausalConv1dV2 : public OpDef {
public:
    explicit CausalConv1dV2(const char* name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
