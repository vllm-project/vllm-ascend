...
/*!
 * \file causal_conv1d_v2_regbase.h
 * \brief CausalConv1dV2 RegBase kernel implementation for arch35 (Ascend 950).
 */

#ifndef CAUSAL_CONV1D_V2_REGBASE_H
#define CAUSAL_CONV1D_V2_REGBASE_H
