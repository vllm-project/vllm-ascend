...
/*!
 * \file causal_conv1d_v2_fn.h
 * \brief CausalConv1dV2 FN (forward/prefill) kernel.
 */

#ifndef CAUSAL_CONV1D_V2_FN_H
#define CAUSAL_CONV1D_V2_FN_H

#include "causal_conv1d_v2.h"

namespace NsCausalConv1dV2 {

template <typename T, uint32_t widthKey, uint32_t fnPlanKey>
class CausalConv1dV2Fn : public CausalConv1dV2<T, CAUSAL_CONV1D_V2_TPL_RUN_MODE_FN, widthKey, fnPlanKey> {
public:
    __aicore__ inline void Init(GM_ADDR x, GM_ADDR weight, GM_ADDR bias, GM_ADDR convStates, GM_ADDR queryStartLoc,
                                ...
                                GM_ADDR workspace, const CausalConv1dV2TilingData *tilingData)
    {
...
template <typename T, uint32_t widthKey, uint32_t fnPlanKey>
__aicore__ inline void RunCausalConv1dV2Fn(GM_ADDR x, GM_ADDR weight, GM_ADDR bias, GM_ADDR convStates,
                                         GM_ADDR queryStartLoc, GM_ADDR cacheIndices, GM_ADDR hasInitialState,
                                         GM_ADDR numAcceptedTokens, GM_ADDR y, GM_ADDR workspace,
                                         const CausalConv1dV2TilingData *tilingData)
{
    CausalConv1dV2Fn<T, widthKey, fnPlanKey> op;
