...
/*!
 * \file causal_conv1d_v2_update.h
 * \brief CausalConv1dV2 UPDATE (decode) kernel.
 */

#ifndef CAUSAL_CONV1D_V2_UPDATE_H
#define CAUSAL_CONV1D_V2_UPDATE_H
...
template <typename T>
class CausalConv1dV2Update
    : public CausalConv1dV2<T, CAUSAL_CONV1D_V2_TPL_RUN_MODE_UPDATE, CAUSAL_CONV1D_V2_TPL_WIDTH_RUNTIME,
...
public:
    ...
    {
        const CausalConv1dV2TilingData *tilingData = this->GetTilingData();
...
template <typename T>
__aicore__ inline void RunCausalConv1dV2Update(GM_ADDR x, GM_ADDR weight, GM_ADDR bias, GM_ADDR convStates,
