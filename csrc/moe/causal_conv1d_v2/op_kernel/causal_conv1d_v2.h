...
/*!
 * \file causal_conv1d_v2.h
 * \brief CausalConv1dV2 kernel core class and shared device-side logic.
 */

#ifndef CAUSAL_CONV1D_V2_H
#define CAUSAL_CONV1D_V2_H

#include "kernel_operator.h"
#include "kernel_tiling/kernel_tiling.h"
#include "causal_conv1d_v2_tiling_data.h"
#include "causal_conv1d_v2_tiling_key.h"
#include "causal_conv1d_v2_common.h"
#if defined(__CCE_AICORE__) && __CCE_AICORE__ == 310
#include "arch35/causal_conv1d_v2_regbase.h"
#endif

namespace NsCausalConv1dV2 {

using namespace AscendC;
using namespace NsCausalConv1dV2Common;

#define CAUSAL_CONV1D_V2_TEMPLATE_ARGS typename T, uint32_t runModeKey, uint32_t widthKey, uint32_t fnPlanKey
#define CAUSAL_CONV1D_V2_CLASS CausalConv1dV2<T, runModeKey, widthKey, fnPlanKey>
...
{
    switch (widthKey) {
        case CAUSAL_CONV1D_V2_TPL_WIDTH_2:
            return 2;
        case CAUSAL_CONV1D_V2_TPL_WIDTH_3:
            return 3;
        case CAUSAL_CONV1D_V2_TPL_WIDTH_4:
            return 4;
        default:
            return 0;
    }
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
class CausalConv1dV2 {
public:
    __aicore__ inline CausalConv1dV2() = default;

protected:
    static constexpr bool kIsUpdateMode = (runModeKey == CAUSAL_CONV1D_V2_TPL_RUN_MODE_UPDATE);
    static constexpr int32_t kTemplateWidth = DecodeWidthTplKey(widthKey);
    static constexpr bool kHasCompileTimeWidth =
        (runModeKey == CAUSAL_CONV1D_V2_TPL_RUN_MODE_FN) && (kTemplateWidth >= 2) && (kTemplateWidth <= MAX_WIDTH);
    static constexpr FnExecutionPlan kFnExecutionPlan = static_cast<FnExecutionPlan>(fnPlanKey);

    __aicore__ inline void ResetRuntimeState(const CausalConv1dV2TilingData *tilingData);
    ...
    __aicore__ inline void ProcessFnChunk(int32_t seq, int32_t cacheIdx, bool hasInit, int32_t seqStart,
                                          ...
                                          int32_t baseDim, int32_t dim);
    __aicore__ inline const CausalConv1dV2TilingData *GetTilingData() const;
...
protected:
    ...
    const CausalConv1dV2TilingData *tilingData_{nullptr};
};

template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::ResetRuntimeState(const CausalConv1dV2TilingData *tilingData)
{
    tilingData_ = tilingData;
}

template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::InitSharedBuffersAndEvents()
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::AllocEvents()
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::ReleaseEvents()
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::LoadWeightAndBias(int32_t channelStart, int32_t baseDim)
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::InitRing(int32_t cacheIdx, bool hasInit, int32_t stateTokenOffset,
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::WriteFnOutput(LocalTensor<T> &outSlotT, int32_t token,
                                                          int32_t channelStart, int32_t baseDim, int32_t dim)
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::RunSeq(int32_t start, int32_t len, int32_t channelStart,
                                                   int32_t baseDim, int32_t dim)
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::RestoreFnLocalPartials(int32_t baseDim)
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::ComputeFnRollingOutput(int32_t slotCurr, int32_t baseDim)
{
    if constexpr (!kHasCompileTimeWidth) {
        return;
    }
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::AdvanceFnLocalPartials(int32_t slotCurr, int32_t baseDim)
{
    if constexpr (!kHasCompileTimeWidth) {
        return;
    }
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::CopyFnRollingInputBatch(int32_t start, int32_t firstToken,
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::ProcessFnRollingToken(int32_t start, int32_t len, int32_t t,
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::RunSeqFnRolling(int32_t start, int32_t len, int32_t channelStart,
                                                            int32_t baseDim, int32_t dim)
{
    if constexpr (!kHasCompileTimeWidth) {
        return;
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::DrainTaskMte3()
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::WriteBackState(int32_t cacheIdx, int32_t len, int32_t channelStart,
                                                           int32_t baseDim, int32_t dim)
{
    if (!HasConvStates()) {
        return;
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::WriteBackFnState(int32_t seq, int32_t cacheIdx, bool hasInit,
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::WriteBackStateSpec(int32_t cacheIdx, bool hasInit,
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline bool CAUSAL_CONV1D_V2_CLASS::ResolveSeqTaskWindow(int32_t seq, int32_t inputMode, int32_t seqLen,
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
template <int32_t kWindowMode>
__aicore__ inline bool CAUSAL_CONV1D_V2_CLASS::ResolveSeqTaskWindowByMode(int32_t seq, int32_t seqLen, int32_t &start,
                                                                       int32_t &len) const
{
    SeqTaskWindow window;
    if constexpr (kWindowMode == SEQ_TASK_WINDOW_MODE_VARLEN) {
        // Device metadata is never read back to the host. Keep baseline bounds
        // checks before narrowing or using a metadata-derived GM address.
        if (seq < 0 || seq >= tilingData_->batch) {
            return false;
        }
        const int64_t startVal = ReadQueryStartLoc(seq);
        const int64_t endVal = ReadQueryStartLoc(seq + 1);
        if (startVal < 0 || endVal < startVal || endVal > tilingData_->cuSeqlen) {
            return false;
        }
        if constexpr (runModeKey == CAUSAL_CONV1D_V2_TPL_RUN_MODE_UPDATE) {
            if (tilingData_->maxQueryLen >= 0 && endVal - startVal > tilingData_->maxQueryLen) {
                return false;
            }
        }
        window = BuildSeqTaskWindowVarlen(static_cast<int32_t>(startVal), static_cast<int32_t>(endVal));
    ...
    if (!window.valid || window.start < 0 || window.len < 0 ||
        static_cast<int64_t>(window.start) + window.len > tilingData_->cuSeqlen) {
        return false;
    }
    start = window.start;
    len = window.len;
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline bool CAUSAL_CONV1D_V2_CLASS::ResolveSeqCacheIndex(int32_t seq, bool hasCacheIndices,
                                                                 int32_t &cacheIdx) const
{
    ...
    if (!hasCacheIndices) {
        return !HasConvStates() || seq < tilingData_->numCacheLines;
    }
    ...
    if (cacheIdx64 < 0 || cacheIdx64 >= tilingData_->numCacheLines || cacheIdx64 > 2147483647LL) {
        return false;
    }
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline int64_t CAUSAL_CONV1D_V2_CLASS::ReadQueryStartLoc(int32_t index) const
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline int64_t CAUSAL_CONV1D_V2_CLASS::ReadCacheIndex(int32_t index) const
{
    const int64_t offset = static_cast<int64_t>(index) * tilingData_->cacheIndicesStride;
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline int64_t CAUSAL_CONV1D_V2_CLASS::ReadHasInitialState(int32_t index) const
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline int64_t CAUSAL_CONV1D_V2_CLASS::ReadNumAcceptedTokens(int32_t index) const
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline bool CAUSAL_CONV1D_V2_CLASS::ResolveSeqHasInit(int32_t seq, bool hasInitialState) const
{
    return HasConvStates() && hasInitialState && (ReadHasInitialState(seq) != 0);
}

template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::ProcessDefault()
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
template <int32_t kWindowMode>
__aicore__ inline void CAUSAL_CONV1D_V2_CLASS::ProcessDefaultByWindowMode()
{
    const int32_t dim = tilingData_->dim;
    ...
    for (int64_t task = static_cast<int64_t>(blockIdx); task < gridSize; task += static_cast<int64_t>(blockNum)) {
        ...
        if (isSpecDecodingGlobal) {
            const int64_t accepted = ReadNumAcceptedTokens(seq);
            // accepted=0 still processes the current window, starting at history 0.
            const int64_t acceptedOffset = accepted > 0 ? accepted - 1 : 0;
            stateTokenOffset = static_cast<int32_t>(
                acceptedOffset < tilingData_->stateLen ? acceptedOffset : tilingData_->stateLen);
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline const CausalConv1dV2TilingData *CAUSAL_CONV1D_V2_CLASS::GetTilingData() const
{
    return tilingData_;
}

template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline bool CAUSAL_CONV1D_V2_CLASS::HasActivation() const
{
    return (tilingData_ != nullptr) && (tilingData_->activationMode != 0);
}

template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline bool CAUSAL_CONV1D_V2_CLASS::HasBias() const
{
    return (tilingData_ != nullptr) && (tilingData_->hasBias != 0);
}

template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline bool CAUSAL_CONV1D_V2_CLASS::HasConvStates() const
{
    return (tilingData_ != nullptr) && (tilingData_->numCacheLines > 0);
}

template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline bool CAUSAL_CONV1D_V2_CLASS::IsUpdateMode() const
{
    return kIsUpdateMode;
}

template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline bool CAUSAL_CONV1D_V2_CLASS::IsFnRollingFastPathEnabled() const
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline bool CAUSAL_CONV1D_V2_CLASS::HasExplicitFnTokenSeqRanges() const
{
...
template <CAUSAL_CONV1D_V2_TEMPLATE_ARGS>
__aicore__ inline bool CAUSAL_CONV1D_V2_CLASS::IsUpdateSpecDecodingEnabled() const
{
    return kIsUpdateMode && (tilingData_->hasNumAcceptedTokens != 0) && (tilingData_->width == 4);
}

#include "causal_conv1d_v2_fn_tasks.h"

#undef CAUSAL_CONV1D_V2_CLASS
#undef CAUSAL_CONV1D_V2_TEMPLATE_ARGS
