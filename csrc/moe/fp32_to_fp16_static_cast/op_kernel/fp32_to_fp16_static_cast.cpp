...
class Fp32ToFp16StaticCastKernel {
public:
    __aicore__ inline void Init(
        GM_ADDR x, GM_ADDR y, const Fp32ToFp16StaticCastTilingData* tilingData)
    {
...
extern "C" __global__ __aicore__ void fp32_to_fp16_static_cast(
    GM_ADDR x, GM_ADDR y, GM_ADDR workspace, GM_ADDR tiling)
{
    (void)workspace;
    GET_TILING_DATA(tilingData, tiling);
    Fp32ToFp16StaticCastKernel op;
