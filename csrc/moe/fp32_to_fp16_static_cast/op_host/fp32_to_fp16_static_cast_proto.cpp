...
static ge::graphStatus InferShape4Fp32ToFp16StaticCast(gert::InferShapeContext* context)
{
...
static ge::graphStatus InferDtype4Fp32ToFp16StaticCast(gert::InferDataTypeContext* context)
{
    context->SetOutputDataType(kOutputY, ge::DT_FLOAT16);
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(Fp32ToFp16StaticCast)
    .InferShape(InferShape4Fp32ToFp16StaticCast)
    .InferDataType(InferDtype4Fp32ToFp16StaticCast);
} // namespace ops
