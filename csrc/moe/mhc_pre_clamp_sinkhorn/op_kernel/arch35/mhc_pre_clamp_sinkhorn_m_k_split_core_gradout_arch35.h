...
/*!
 * \file mhc_pre_clamp_sinkhorn_m_k_split_core_gradout_arch35.h
 * \brief
 */
...
template <typename T>
class MhcPreClampSinkhornMKSplitCorePart1Gradout {
public:
    __aicore__ inline MhcPreClampSinkhornMKSplitCorePart1Gradout()
    {}
...
template <typename T>
class MhcPreClampSinkhornMKSplitCorePart2Gradout {
public:
    __aicore__ inline MhcPreClampSinkhornMKSplitCorePart2Gradout()
    {}
