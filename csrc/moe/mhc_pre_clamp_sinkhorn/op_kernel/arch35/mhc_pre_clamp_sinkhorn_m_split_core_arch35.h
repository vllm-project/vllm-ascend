...
/*!
 * \file mhc_pre_clamp_sinkhorn_m_split_core_arch35.h
 * \brief
 */
...
template <typename T>
class MhcPreClampSinkhornMSplitCorePart1 {
public:
    __aicore__ inline MhcPreClampSinkhornMSplitCorePart1()
    {
    }

    __aicore__ inline void Init(GM_ADDR x, GM_ADDR hcFn, GM_ADDR hcScale, GM_ADDR hcBase, GM_ADDR y, GM_ADDR post,
                                GM_ADDR combFrag, const MhcPreClampSinkhornTilingData *tilingDataPtr, TPipe *pipePtr)
    {
        pipe = pipePtr;
