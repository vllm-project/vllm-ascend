...
/*!
 * \file mhc_pre_clamp_sinkhorn_m_k_split_core_arch35.h
 * \brief
 */
...
template <typename T>
class MhcPreClampSinkhornMKSplitCorePart1 {
public:
    __aicore__ inline MhcPreClampSinkhornMKSplitCorePart1()
    {}
...
template <typename T>
class MhcPreClampSinkhornMKSplitCorePart2 {
public:
    __aicore__ inline MhcPreClampSinkhornMKSplitCorePart2()
    {}
