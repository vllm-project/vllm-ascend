...
/* !
 * \file moe_gating_top_k_with_map_infershape.cpp
 * \brief
 */
...
static ge::graphStatus InferShape4MoeGatingTopKWithMap(gert::InferShapeContext *context)
{
    OP_LOGD(context, "Begin to do MoeGatingTopKWithMapInfershape.");
    ...
    OP_LOGD(context, "End to do MoeGatingTopKWithMapInfershape.");
    return ge::GRAPH_SUCCESS;
}

static ge::graphStatus InferDataType4MoeGatingTopKWithMap(gert::InferDataTypeContext *context)
{
    OP_LOGD(context, "Begin to do MoeGatingTopKWithMapInferDataType.");
    ...
    OP_LOGD(context, "End to do MoeGatingTopKWithMapInferDataType.");
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(MoeGatingTopKWithMap).InferShape(InferShape4MoeGatingTopKWithMap).InferDataType(InferDataType4MoeGatingTopKWithMap);
} // namespace ops
