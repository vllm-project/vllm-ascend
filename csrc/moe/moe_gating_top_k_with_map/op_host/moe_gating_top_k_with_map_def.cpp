...
/*!
 * \file moe_gating_top_k_with_map_def.cpp
 * \brief
 */
#include "register/op_def_registry.h"

namespace ops {
class MoeGatingTopKWithMap : public OpDef {
public:
    explicit MoeGatingTopKWithMap(const char *name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
        ...
        regbaseCfg.DynamicCompileStaticFlag(true)
            ...
            .ExtendCfgInfo("opFile.value", "moe_gating_top_k_with_map_apt");
        this->AICore().AddConfig("ascend950", regbaseCfg);
    }
};

OP_ADD(MoeGatingTopKWithMap);
} // namespace ops
