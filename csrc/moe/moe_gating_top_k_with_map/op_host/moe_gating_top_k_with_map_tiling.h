...
/*!
 * \file moe_gating_top_k_with_map_tiling.h
 * \brief
 */

#ifndef AIR_CXX_RUNTIME_V2_OP_IMPL_MOE_GATING_TOP_K_WITH_MAP_H
#define AIR_CXX_RUNTIME_V2_OP_IMPL_MOE_GATING_TOP_K_WITH_MAP_H
...
namespace optiling {
BEGIN_TILING_DATA_DEF(MoeGatingTopKWithMapTilingData)
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(MoeGatingTopKWithMap, MoeGatingTopKWithMapTilingData)

BEGIN_TILING_DATA_DEF(MoeGatingTopKWithMapRegbaseTilingData)
TILING_DATA_FIELD_DEF(int64_t, needCoreNum);
TILING_DATA_FIELD_DEF(int64_t, rowCount);
TILING_DATA_FIELD_DEF(int64_t, perCoreRowCount);
TILING_DATA_FIELD_DEF(int64_t, lastCoreRowCount);
...
END_TILING_DATA_DEF;
REGISTER_TILING_DATA_CLASS(MoeGatingTopKWithMap_10000, MoeGatingTopKWithMapRegbaseTilingData)
struct MoeGatingTopKWithMapCompileInfo {};
} // namespace optiling
#endif // AIR_CXX_RUNTIME_V2_OP_IMPL_MOE_GATING_TOP_K_WITH_MAP_H
