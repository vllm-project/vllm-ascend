...
static ge::graphStatus InferShape4Fp32ToBf16StaticCast(gert::InferShapeContext* context)
{
...
static ge::graphStatus InferDtype4Fp32ToBf16StaticCast(gert::InferDataTypeContext* context)
{
    context->SetOutputDataType(kOutputY, ge::DT_BF16);
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(Fp32ToBf16StaticCast)
    .InferShape(InferShape4Fp32ToBf16StaticCast)
    .InferDataType(InferDtype4Fp32ToBf16StaticCast);
} // namespace ops
