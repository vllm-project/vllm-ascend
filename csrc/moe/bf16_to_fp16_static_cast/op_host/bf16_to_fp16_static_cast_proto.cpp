...
static ge::graphStatus InferShape4Bf16ToFp16StaticCast(gert::InferShapeContext* context)
{
...
static ge::graphStatus InferDtype4Bf16ToFp16StaticCast(gert::InferDataTypeContext* context)
{
    context->SetOutputDataType(kOutputY, ge::DT_FLOAT16);
    return ge::GRAPH_SUCCESS;
}

IMPL_OP_INFERSHAPE(Bf16ToFp16StaticCast)
    .InferShape(InferShape4Bf16ToFp16StaticCast)
    .InferDataType(InferDtype4Bf16ToFp16StaticCast);
} // namespace ops
