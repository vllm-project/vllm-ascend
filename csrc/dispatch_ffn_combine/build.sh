...
ASCEND_TOOLKIT_ARCH_INCLUDE=${ASCEND_CANN_PACKAGE_PATH}/${ARCH}-linux/include/
ASCEND_HIGH_LV_API=${ASCEND_CANN_PACKAGE_PATH}/${ARCH}-linux/include/ascendc/highlevel_api/lib/
