...
class ReplayBuilder(opdesc_parser.OpDesc):
    ...
    def gen_replay_source(self: any, impl_path: str, out_path: str,
                          ops_product: str):
        ...
        if impl_path.endswith("op_kernel"):
            ...
            tiling_file = os.path.join(impl_path, "../op_host",
                                       self.op_file + "_tiling.h")
        else:
            ...
            tiling_file = os.path.join(impl_path, "../../op_tiling",
                                       self.op_file + "_tiling.h")
...
def gen_replay(cfgfile: str,
    ...
    op_descs = opdesc_parser.get_op_desc(cfgfile, batch_lists, iterator_lists,
                                         ReplayBuilder, ops)
