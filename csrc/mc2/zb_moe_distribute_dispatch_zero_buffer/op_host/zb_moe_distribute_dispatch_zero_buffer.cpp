...
namespace ops {
class ZbMoeDistributeDispatchZeroBuffer : public OpDef
{
public:
    explicit ZbMoeDistributeDispatchZeroBuffer(const char *name) : OpDef(name)
    {
        this->Input("x")
            .ParamType(REQUIRED)
...
OP_ADD(ZbMoeDistributeDispatchZeroBuffer);
