...
#ifndef MATMUL_ALLREDUCE_ADD_RMSNORM_910C_UTILS_H
#define MATMUL_ALLREDUCE_ADD_RMSNORM_910C_UTILS_H
...
constexpr uint32_t FINE_GRAIN_TILE_ELEMENTS = 224;
constexpr uint32_t FINE_GRAIN_READY_FLAG_COUNT = 28;
constexpr uint32_t FINE_GRAIN_READY_FLAG_STRIDE_BYTES = 64;
constexpr uint32_t FINE_GRAIN_READY_WORKSPACE_BYTES =
    FINE_GRAIN_READY_FLAG_COUNT * FINE_GRAIN_READY_FLAG_STRIDE_BYTES;
constexpr int32_t FINE_GRAIN_DEBUG_STAGE = 1;
...
#endif // MATMUL_ALLREDUCE_ADD_RMSNORM_910C_H
