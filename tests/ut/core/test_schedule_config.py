...
class TestAscendSchedulerConfig(unittest.TestCase):
    def setUp(self):
    ...
    def test_initialize_from_config_with_default(self):
        ...
        ascend_config = AscendSchedulerConfig.initialize_from_config(self.basic_scheduler_config, {})
        ...
        self.assertEqual(ascend_config.scheduler_cls, "vllm_ascend.core.scheduler.AscendScheduler")
    ...
    def test_initialize_from_config_with_override(self):
        # test override
        ascend_config = AscendSchedulerConfig.initialize_from_config(self.basic_scheduler_config, AscendSchedulerConfig(
    ...
    def test_not_implemented_policy(self):
        with self.assertRaises(NotImplementedError) as context:
            AscendSchedulerConfig.initialize_from_config(self.basic_scheduler_config, AscendSchedulerConfig(
    ...
    def test_not_implemented_multimodal(self):
        with self.assertRaises(NotImplementedError) as context:
            AscendSchedulerConfig.initialize_from_config(SchedulerConfig(is_multimodal_model=True), {})
    ...
    def test_not_implemented_multi_step(self):
        with self.assertRaises(NotImplementedError) as context:
            AscendSchedulerConfig.initialize_from_config(self.basic_scheduler_config,
