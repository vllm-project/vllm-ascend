...
class TestAscendScheduler(TestBase):
    ...
    def test_scheduler_with_pd_transfer(self):
        ...
        self.assertEqual(len(scheduler_output.scheduled_new_reqs), scheduler.max_num_running_reqs)
        ...
        model_runner_output = make_output(scheduler)
        scheduler.update_from_output(scheduler_output, model_runner_output)
        self.assertEqual(len(scheduler.finished_prefill_reqs), first_iter_prefilled_req_num)
