...
def test_attn_state_mla_spec_and_metadata_wrappers(monkeypatch):
    ...
    assert attn_utils.build_attn_state(mtp, None, seq, 2, scheduled, ones) is state.SpecDecoding
    assert attn_utils.build_attn_state(eagle, None, seq, 2, scheduled, ones) is state.ChunkedPrefill
    assert attn_utils.build_attn_state(chunked, None, seq, 2, scheduled, scheduled) is state.ChunkedPrefill
    assert attn_utils.build_attn_state(no_spec, None, seq, 2, scheduled, scheduled) is state.PrefillCacheHit
