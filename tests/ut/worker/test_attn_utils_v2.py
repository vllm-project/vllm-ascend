...
def test_mrv2_initializes_dsv4_cache_only_layer(
    ...
    def _ascend_bind_kv_cache_to_layers(
        ...
        # `bind_kv_cache_to_layers`, which dropped the runner-list argument.
        del num_attn_module, kv_cache_groups
        for kv_cache in kv_caches.values():
    ...
    if vllm_version_is("0.29.0"):
        ...
        init_kwargs["runner_kv_caches"] = runner_kv_caches
    else:
        monkeypatch.setattr(upstream_attn_utils, "bind_kv_cache_to_layers", _ascend_bind_kv_cache_to_layers)
    kv_caches = upstream_attn_utils.init_kv_cache(**init_kwargs)
