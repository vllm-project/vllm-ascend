...
def test_update_tokens_for_pcp_basic(tokens, num_reqs, num_computed_tokens,
    ...
    pcp_manager.init_batch_info(num_scheduled_tokens, input_batch.num_computed_tokens_cpu, num_reqs, 1)
...
def test_generate_pcp_mtp_input(
    ...
    pcp_manager.init_batch_info(np.array(list(num_scheduled_tokens.values())), input_batch.num_computed_tokens_cpu, num_reqs, 2)
