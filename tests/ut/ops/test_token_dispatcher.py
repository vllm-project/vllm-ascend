...
class TestTokenDispatcherWithMC2(TestBase):
    ...
    def test_get_dispatch_mc2_kwargs_without_hierarchy_omits_mc2_mask(self):
        self.mock_get_config.return_value.parallel_config.tensor_parallel_size = 4
        self.mock_ascend_config.return_value.get_mc2_comm_alg.return_value = ""
        dispatcher = TokenDispatcherWithMC2(with_quant=False, top_k=8, num_experts=128)
    ...
    def test_get_dispatch_mc2_kwargs_with_hierarchy_keeps_mc2_mask(self):
        self.mock_ascend_config.return_value.get_mc2_comm_alg.return_value = "hierarchy"
        dispatcher = TokenDispatcherWithMC2(with_quant=False, top_k=8, num_experts=128)
        hidden_states = torch.randn(10, 128)
        topk_ids = torch.randint(0, 8, (10, 1))
        topk_weights = torch.randn(10, 1)
