...
class TestTokenDispatcherWithMC2(TestBase):
    ...
    def test_get_dispatch_mc2_kwargs_without_quant(self):
        ...
        kwargs = self.dispatcher.get_dispatch_mc2_kwargs(hidden_states, topk_weights, topk_ids, expert_map, mc2_mask)
    ...
    def test_token_permutation_dispatch(self):
        ...
        with patch(
            ...
            output = self.dispatcher.token_dispatch(hidden_states, topk_weights, topk_ids, expert_map)
    ...
    def test_token_dispatch_with_shared_experts_and_quant(self):
        ...
        self.shared_experts.gate_up_proj.return_value = (
            torch.randn(10, 128),
            torch.tensor(1.0),
        )
    ...
    def test_get_combine_mc_kwargs_with_quant(self):
        ...
        kwargs = self.dispatcher.get_combine_mc_kwargs(hidden_states, context_metadata)
...
class TestTokenDispatcherWithAllGather(TestBase):
    ...
    def test_token_dispatch_without_expert_map(self):
        ...
        results = self.dispatcher.token_dispatch(hidden_states, topk_weights, topk_ids, None)
    ...
    def test_token_dispatch_without_quant(self):
        ...
        results = self.dispatcher_quant.token_dispatch(hidden_states, topk_weights, topk_ids, None)
    ...
    def test_token_dispatch_with_quant(self):
        ...
        results = self.dispatcher_quant.token_dispatch(hidden_states, topk_weights, topk_ids, None, with_quant=True)
    ...
    def test_token_combine_with_expert_map(self):
        ...
        final_hidden_states = self.dispatcher.token_combine(hidden_states, context_metadata).routed_out
...
class TestTokenDispatcherWithAll2AllV(TestBase):
    def setUp(self):
        ...
        self.mock_npu_moe_token_permute.return_value = (
            torch.randn(16, 16),
            torch.arange(16),
        )
        ...
        self.mock_async_all_to_all.return_value = (
            None,
            torch.randn(16, 16),
            MagicMock(),
        )
    ...
    def test_token_dispatch(self):
        ...
        result = self.dispatcher.token_dispatch(
