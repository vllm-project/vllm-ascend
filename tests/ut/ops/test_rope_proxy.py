...
# ──────────────────────────────────────────────
# Contract: ComplexExpRotaryEmbedding.forward writes back in place
# ──────────────────────────────────────────────
...
def test_dsv4_rope_writes_back_inplace():
    ...
    #
    # On real hardware __init__ builds its rope cache on
    # current_platform.device_type (NPU) while the test inputs are CPU
