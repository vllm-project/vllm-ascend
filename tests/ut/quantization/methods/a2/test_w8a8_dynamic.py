...
class TestAscendW8A8FusedMoEMethod(TestBase):
    ...
    def test_process_weights_after_loading_builds_a3_mega_moe_lists(self, mock_get_config, mock_format_cast):
        ...
        self.assertEqual(layer.a3_mega_moe_fused_w1_scale_list[0].dtype, torch.uint64)
        self.assertEqual(layer.a3_mega_moe_fused_w2_scale_list[0].dtype, torch.uint64)
        self.assertTrue(layer.a3_mega_moe_w13_weight_list[0].is_contiguous())
        self.assertTrue(layer.a3_mega_moe_w2_weight_list[0].is_contiguous())
