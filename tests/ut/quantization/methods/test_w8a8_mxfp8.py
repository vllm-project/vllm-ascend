...
class TestAscendW8A8MXFP8LinearMethod(TestBase):
    ...
    def test_init(self):
        ...
        self.assertEqual(self.scheme.group_size, 32)

    def test_get_weight_float8_dtype(self):
        result = self.scheme.get_weight(256, 128, torch.bfloat16)
    ...
    def test_process_weights_double_call_no_change(self):
        ...
        self.scheme.process_weights_after_loading(layer)
        self.assertTrue(torch.equal(layer.weight.data, weight_after_first))
...
class TestAscendW8A8MXFP8MoEMethod(TestBase):
    ...
    def test_quant_type_is_mxfp8(self):
        self.assertEqual(self.scheme.quant_type, QuantType.MXFP8)
