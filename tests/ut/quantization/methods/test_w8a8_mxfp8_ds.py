...
class TestAscendW8A8MXFP8DSOProjTP(TestBase):
    ...
    def _make_scheme(self):
        ...
        # parent w8a8_mxfp8.__init__ calls get_current_vllm_config in the
        # w8a8_mxfp8 namespace. Both sites must return the same mock.
        ...
        with (
            ...
            scheme = AscendW8A8MXFP8DSDynamicLinearMethod([BLOCK_SIZE, BLOCK_SIZE])
        return scheme
