...
class TestAscendW4A8DynamicLinearMethod(TestBase):
    ...
    def test_get_weight(self):
        weight = self.method.get_weight(8, 16, torch.bfloat16)
        self.assertEqual(weight["weight"].dtype, torch.int8)
        self.assertEqual(weight["weight"].shape, (16, 8))

    def test_get_pergroup_param(self):
        params = self.method.get_pergroup_param(8, 16, torch.bfloat16)
        ...
        self.assertEqual(params["weight_scale_second"].shape, (16, 1))
        self.assertEqual(params["weight_offset_second"].dtype, torch.bfloat16)
        self.assertEqual(params["weight_offset_second"].shape, (16, 1))
