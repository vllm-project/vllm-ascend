...
class TestAscendQuantConfig(TestBase):
    ...
    def test_get_name(self):
        self.assertEqual(AscendQuantConfig.get_name(), ASCEND_QUANTIZATION_METHOD)
    ...
    def test_get_quant_method_for_linear(self):
        ...
        with (
            ...
            patch(
                "vllm_ascend.quantization.quant_config.AscendLinearMethod",
    ...
    def test_get_quant_method_for_attention(self):
        ...
        with (
            ...
            patch(
                "vllm_ascend.quantization.quant_config.AscendKVCacheMethod",
                return_value=MagicMock(),
    ...
    def test_get_quant_method_for_fused_moe(self):
        ...
        with (
            ...
            patch(
                "vllm_ascend.quantization.quant_config.AscendUnquantizedFusedMoEMethod",
                return_value=MagicMock(),
            ) as mock_ascend_moe,
        ):
