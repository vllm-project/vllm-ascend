...
class TestUtils(TestBase):
    ...
    def test_register_ascend_customop(self, mock_ascend_rmsnorm,
        ...
        # should call register_oot five times
        self.assertEqual(mock_customop.register_oot.call_count, 5)
        self.assertTrue(utils._ASCEND_CUSTOMOP_IS_REIGISTERED)

        # ascend custom op is already registered
        utils.register_ascend_customop()
        # should not register_oot again, thus only called five times in this ut
        self.assertEqual(mock_customop.register_oot.call_count, 5)
