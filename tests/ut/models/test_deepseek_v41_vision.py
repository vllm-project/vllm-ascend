...
from vllm.transformers_utils.configs.deepseek_v41 import (  # type: ignore[import-not-found]
    DeepseekV41Config as UpstreamDeepseekV41Config,
)

from vllm_ascend.models.deepseek_v41._compat import (
    IMAGE,
    IMAGE_END,
    IMAGE_NEW_LINE,
...
def test_v41_processing_info_accepts_v41_config():
    ...
    # vLLM dropped the V4.1 compressor-alignment pad from the released config.
...
def test_v41_image_span_is_dead_to_engram():
...
def test_v41_embed_input_ids_passes_raw_ids_to_language_model():
