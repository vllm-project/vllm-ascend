...
class TestMooncakeTransferGroups(unittest.TestCase):
    ...
    def test_m3_index_spec_is_preserved_and_splits_transfer_group(self):
        ...
        self.assertGreaterEqual(placements[main_layer].size, main_spec.page_size_bytes * num_blocks)
        self.assertGreaterEqual(placements[index_layer].size, index_spec.page_size_bytes * num_blocks)
