...
class TestAscendRejectionSampler(TestBase):
    ...
    def test_expand_batch_to_tokens(self):
        ...
        num_tokens = 7
        # Test PyTorch path
        with patch("vllm_ascend.sample.rejection_sampler.HAS_TRITON", False), patch("vllm_ascend.sample.rejection_sampler.expand_pytorch") as mock_pytorch:
        ...
        with patch("vllm_ascend.sample.rejection_sampler.HAS_TRITON", True), patch("vllm_ascend.sample.rejection_sampler.expand_triton") as mock_triton:
            expand_batch_to_tokens(x, cu_num_tokens, num_tokens)
