...
def test_apply_temperature_skip_zero_and_one():
...
def test_gumbel_sample_different_seeds():
...
def test_gumbel_sample_temperature_affects_distribution():
...
def test_gumbel_sample_shared_seed_same_request():
...
def test_gumbel_sample_apply_temperature_false_nonzero():
...
def test_gumbel_sample_processed_logits_mixed_temp():
...
def test_gumbel_sample_large_vocab():
...
def test_gumbel_sample_extreme_temperatures():
