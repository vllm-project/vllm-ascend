...
class TestQwen3MTPGetTopTokens:
    ...
    def test_qwen3_5_mtp_has_get_top_tokens(self):
        ...
        assert hasattr(Qwen3_5MTP, "get_top_tokens"), (
            "Qwen3_5MTP should have get_top_tokens after patching"
        )
    ...
    def test_qwen3_next_mtp_has_get_top_tokens(self):
        ...
        assert hasattr(Qwen3NextMTP, "get_top_tokens"), (
            "Qwen3NextMTP should have get_top_tokens after patching"
        )
    ...
    def test_get_top_tokens_calls_logits_processor(self):
        ...
        instance.logits_processor.get_top_tokens.assert_called_once_with(
            instance.lm_head, hidden_states
        )
