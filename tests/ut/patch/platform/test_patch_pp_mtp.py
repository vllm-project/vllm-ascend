...
@pytest.mark.parametrize(
    ...
    [
        pytest.param("qwen3_5_mtp", "Qwen3_5MTP", id="mtp"),
        pytest.param("deepseek_v4", "DSparkDraftModel", id="deepseek-dspark"),
        pytest.param("kimi_k3", "K3DSparkModel", id="kimi-mla-dspark"),
        pytest.param("qwen3", "Qwen3DSparkModel", id="kimi-gqa-dspark"),
    ],
)
def test_model_config_validates_local_spec_drafter_as_single_pp_rank(
    monkeypatch,
    model_type,
    architecture,
):
