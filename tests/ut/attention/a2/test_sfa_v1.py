...
class TestAscendSFAImpl(TestBase):
    ...
    def test_mla_extras_force_native_preprocessing(self):
    ...
    def test_manual_kv_path_applies_norm_rope_and_rescale(
        self,
        mock_fused_kv,
    ...
    @patch("vllm_ascend.attention.sfa_v1.get_tensor_model_parallel_rank", return_value=1)
    def test_native_forward_rescales_q_and_applies_headwise_gate(
        self,
        _mock_tp_rank,
        _mock_wait_for_kv,
        _mock_notify_kv,
