...
class TestAscendMLAImpl(TestBase):
    ...
    @patch_distributed_groups(dcp_size=2, pcp_size=2, needs_mocks=False)
    def test_mla_preprocess_dcp(self, magic_npu_fetch, mock_maybe_all_gather_and_maybe_unpad):
    ...
    def test_process_attn_out_lse(self):
        ...
        result = _process_attn_out_lse(attn_output, softmax_lse, decode_metadata.batch_seq_mask)
    ...
    def test_forward_decode_pcp_dcp(
        ...
        attn_metadata.decode.batch_seq_mask = torch.tensor([False, False], dtype=torch.bool)
