...
class TestAscendAttentionBackend(TestBase):
    ...
    def test_get_impl_cls(self):
        self.assertEqual(
            AscendAttentionBackend.get_impl_cls(), AscendAttentionBackendImpl
        )

    def test_get_builder_cls(self):
        self.assertEqual(
            AscendAttentionBackend.get_builder_cls(), AscendAttentionMetadataBuilder
        )
...
class TestAscendAttentionMetadataBuilder(TestBase):
    def setUp(self):
        ...
        self.builder = AscendAttentionMetadataBuilder(
...
class TestAscendAttentionBackendImpl(TestBase):
    ...
    def test_forward_decode_only_swa_seq_len_mismatch(
        ...
        mock_fused_infer_attention_score.return_value = (
            torch.ones(10, 8, 64),
            torch.ones(10, 8, 64),
        )
