...
def setUpModule() -> None:
    # Install the mocks when this module's tests start, not at import time.
    # The batch shares one process with other files (e.g. test_utils.py) that
    # call ``unittest.mock.patch.stopall()``; an import-time patch would be
    # silently stopped before these tests run.
    patch(
