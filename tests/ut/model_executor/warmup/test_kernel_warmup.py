...
@patch.object(kw, "slot_mapping_triton_warmup")
...
def test_kernel_warmup(mock_indexer, mock_rej, mock_pen, mock_rms, mock_slot_mapping, mock_logger):
    ...
    mock_slot_mapping.assert_called_once_with(worker)
