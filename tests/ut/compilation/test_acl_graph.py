...
from vllm.forward_context import ForwardContext, BatchDescriptor

from tests.ut.base import TestBase
from vllm_ascend.compilation.acl_graph import ACLGraphWrapper, ACLGraphEntry
...
class TestACLGraphWrapper(TestBase):
    ...
    @patch('vllm_ascend.compilation.acl_graph.current_platform')
    @patch('vllm_ascend.compilation.acl_graph.envs')
    def test_call_with_none_runtime_mode(self, mock_envs, mock_current_platform, mock_get_forward_context):
    ...
    @patch('vllm_ascend.compilation.acl_graph.current_platform')
    @patch('vllm_ascend.compilation.acl_graph.envs')
    def test_call_with_mismatched_runtime_mode(self, mock_envs, mock_current_platform, mock_get_forward_context):
    ...
    def test_call_capture_graph_first_time(self, mock_weak_ref_tensors, mock_compilation_counter, 
    ...
    @patch('vllm_ascend.compilation.acl_graph.compilation_counter')
    @patch('vllm_ascend.compilation.acl_graph.weak_ref_tensors')
    def test_call_replay_graph(self, mock_weak_ref_tensors, mock_compilation_counter, 
                             mock_envs, mock_current_platform, mock_get_forward_context,
                             mock_validate_cudagraph_capturing_enabled, mock_torch):
    ...
    def test_call_capture_graph_with_gc_disable(self, mock_patch, mock_weak_ref_tensors, mock_compilation_counter, 
                                              mock_envs, mock_current_platform, mock_get_forward_context,
                                              mock_validate_cudagraph_capturing_enabled, mock_torch):
    ...
    @patch('vllm_ascend.compilation.acl_graph.compilation_counter')
    @patch('vllm_ascend.compilation.acl_graph.weak_ref_tensors')
    def test_call_capture_graph_with_weak_ref_output(self, mock_weak_ref_tensors, mock_compilation_counter, 
                                                   mock_envs, mock_current_platform, mock_get_forward_context,
                                                   mock_validate_cudagraph_capturing_enabled, mock_torch):
