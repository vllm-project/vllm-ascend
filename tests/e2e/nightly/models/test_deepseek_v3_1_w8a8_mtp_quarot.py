...
async def test_models(model: str) -> None:
    ...
    server_args = [
        "--quantization", "ascend", "--data-parallel-size", "4",
        ...
        "--async-scheduling", "--no-enable-prefix-caching", "--dtype",
        "bfloat16", "--speculative-config",
        json.dumps(speculative_config), "--compilation-config",
