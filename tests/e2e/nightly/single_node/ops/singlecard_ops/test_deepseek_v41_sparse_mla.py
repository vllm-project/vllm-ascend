...
from tests.deepseek_v41_utils import allocate_cache_views, make_cache_config
from vllm_ascend.attention.dsa_v41 import DeepseekV41AttentionImpl
...
def test_slot_backed_attention_matches_block_outermost(ratio, query_lens):
    ...
    impl = DeepseekV41AttentionImpl.__new__(DeepseekV41AttentionImpl)
