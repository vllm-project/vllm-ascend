...
def test_triton_fusion_ops():
    ...
    b = (
        torch.tensor([[0.4277, 0.8906, 1.6875, 2.3750, 4.1562, 0.3809, 1.0625, 3.6719]])
        .bfloat16()
        .npu()
    )
    ...
    dt_bias = (
        torch.tensor(
            [-4.7812, -5.0938, -5.5000, 9.4375, 7.6250, -4.3750, -3.0938, 0.9688]
        )
        .bfloat16()
        .npu()
    )
