...
from cann_ops_transformer.ops import flash_attn, flash_attn_metadata  # type: ignore[import-not-found]
...
def test_native_writer_updates_only_owned_slots_and_heads(dtype, page):
    ...
    torch_npu.npu_scatter_pa_kv_cache(k, v, kc.permute(0, 2, 1, 3), vc.permute(0, 2, 1, 3), slots, cache_mode="Norm")
    torch.npu.synchronize()
