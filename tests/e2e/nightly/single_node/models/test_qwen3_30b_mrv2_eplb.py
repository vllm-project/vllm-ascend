...
def test_qwen3_moe_w8a8_dp4_tp4_sync_eplb_accuracy():
    baseline_outputs = _run_dp4_tp4(enable_eplb=False)
    eplb_outputs = _run_dp4_tp4(enable_eplb=True)

    assert eplb_outputs == baseline_outputs
