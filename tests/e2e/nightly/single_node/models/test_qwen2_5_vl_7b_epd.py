...
async def test_models(model: str, tp_size: int) -> None:
    ...
    with RemoteEPDServer(vllm_serve_args=vllm_server_args) as _, DisaggEpdProxy(proxy_args=proxy_args) as _:
        # warm up
        run_aisbench_cases(model=model, port=proxy_port, aisbench_cases=warmup_cases)
        # aisbench test
