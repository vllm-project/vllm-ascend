...
from vllm.v1.metrics.reader import Counter, Vector, Metric
...
# Helper functions for DFlash tests
def load_and_process_dataset(data_name: str):
    """Load and process dataset for DFlash validation."""
...
def compute_acceptance_rate(
    ...
    """Compute acceptance rate from metrics."""
...
def compute_acceptance_len(
    ...
    """Compute acceptance length from metrics."""
    name2metric = {metric.name: metric for metric in metrics}
...
def test_dflash_acceptance_rates():
    ...
    """
    # target_model = "/data/model/Qwen3-8B"
    # draft_model = "z-lab/Qwen3-8B-DFlash-b16"

    target_model = "/data/model/Qwen3-8B"
    draft_model = "/data/model/Qwen3-8B-DFlash-b16"
...
def test_dflash_correctness():
    ...
    # Run speculative decoding with DFlash
    with VllmRunner(
        model_name=target_model,
        speculative_config={
            "method": "dflash",
        ...
        evaluate_gsm8k_offline(spec_llm)
