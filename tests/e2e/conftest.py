...
def hunyuan_prompt(questions: list[str]) -> list[str]:
    # vLLM main (PR #49691) requires the image placeholder to be wrapped with
    # the image start/end tokens in the prompt, while v0.26.0's prompt update
    # wraps a bare placeholder itself. Supplying the wrapper where vLLM adds
    # it would duplicate the boundary tokens.
