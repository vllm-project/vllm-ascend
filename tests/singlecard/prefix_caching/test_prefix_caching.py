...
# Adapted from vllm/tests/prefix_caching/test_prefix_caching.py
#
"""Compare the with and without prefix caching.

Run `pytest tests/singlecard/prefix_caching/test_prefix_caching.py`.
"""
...
from tests.prefix_caching.core_utils import SchedulerProxy, create_dummy_prompt
