...
# Adapted from vllm-project/vllm/tests/spec_decode/e2e/test_multistep_correctness.py
...
@pytest.mark.skipif(
    True,
    reason=
    "Please release this case after the preemptive scheduling preblem is solved."
)
@pytest.mark.parametrize(
    "common_llm_kwargs",
    [{
