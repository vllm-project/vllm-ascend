...
class MoEAllGatherCombineMetadata:
    ...
    # Dispatch expert ids use the global contiguous active range
    # [first_expert_idx, first_expert_idx + E). Keep the range origin with
    # expanded_row_idx so grouped MoE LoRA never guesses the id domain.
