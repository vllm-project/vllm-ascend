...
if vllm_version_is("0.21.0"):
    from vllm.model_executor.layers.fused_moe.layer import determine_expert_map  # type: ignore[import-not-found]
else:
    from vllm.model_executor.layers.fused_moe.expert_map_manager import (  # type: ignore[import-not-found]
        determine_expert_map,  # type: ignore[import-not-found]
    )
