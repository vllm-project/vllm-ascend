...
class VllmEplbAdaptor(EplbAdaptor):
    ...
    def do_update_expert_map(self, layer_id, updated_expert_map):
        self.expert_map_per_layer[layer_id].copy_(updated_expert_map.clone)
        self.expert_map_per_layer_cpu[layer_id].copy_(updated_expert_map.clone)
    ...
    def do_update_expert_weight(self, layer_id, local_expert_to_replace,
        ...
        for expert_tensor, buffer_tensor in zip(
            ...
            expert_tensor.copy_(buffer_tensor.clone)
