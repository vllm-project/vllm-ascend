    ...
    def init_expert_param_per_layer(self):
        ...
        for local_idx, layer in enumerate(self.moe_layers):
            ...
            for name in expert_weight_names:
                ...
                get_parameter = getattr(type(layer), "get_eplb_parameter", None)
                self.param_dict[param_key] = (
                    get_parameter(layer, name) if get_parameter is not None else getattr(layer, name)
                )
