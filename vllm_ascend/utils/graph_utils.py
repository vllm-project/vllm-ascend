...
"""
ACL/CUDA Graph configuration utilities for vLLM Ascend.

This module provides functionality for:
- Managing CUDA/ACL graph capture sizes
- Updating graph configuration based on hardware limitations
"""
...
def update_aclgraph_sizes(vllm_config: VllmConfig) -> None:
    ...
    if hasattr(hf_config, 'num_hidden_layers'):
        ...
        from vllm_ascend.utils.model_utils import get_max_hidden_layers
