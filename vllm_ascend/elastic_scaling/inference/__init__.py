...
from vllm_ascend.elastic_scaling.inference.npu_model_runner import __init__, initialize_kv_cache, load_model
...
from vllm_ascend.elastic_scaling.inference.scale.async_llm import reload_kvcache, reload_models
...
from vllm_ascend.elastic_scaling.inference.scale.core_client import reload_kvcache_async, reload_models_async
...
from vllm_ascend.elastic_scaling.inference.scale.core import reload_kvcache, reload_model
...
from vllm_ascend.elastic_scaling.inference.scale.abstract import reload_kvcache, reload_model
