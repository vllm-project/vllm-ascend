...
if TYPE_CHECKING:
    from vllm_ascend.worker.model_runner import ModelInputForNPUBuilder, ModelInputForNPUWithSamplingMetadata
...
class AscendMetadata(AttentionMetadata):
    ...
    def advance_step(self,
        ...
        # update input_tokens
        sampled_token_ids_list = sampled_token_ids[:num_queries].squeeze(-1) # type: ignore
        model_input.input_tokens[:num_queries] = sampled_token_ids_list # type: ignore
