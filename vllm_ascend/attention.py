...
from vllm.attention.backends.abstract import (AttentionBackend, AttentionImpl,
                                              MLAAttentionImpl, AttentionLayer,
    ...
    def forward(
        ...
        if self.w_kc == None or self.w_vc == None:
            kv_b_proj_weight = self.kv_b_proj.weight.reshape(self.num_heads,
                                                             ...
                                                             self.kv_lora_rank)
            self.w_kc = kv_b_proj_weight[:, :self.qk_nope_head_dim, :].contiguous()
            self.w_vc = kv_b_proj_weight[:, self.qk_nope_head_dim:, :].transpose(1, 2).contiguous()
