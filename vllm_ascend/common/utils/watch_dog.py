...
class WatchDog:
    ...
    def _check_loop(self):
        ...
        # Wait on the stop event instead of sleeping, so stop() wakes the
        # thread immediately instead of leaving it running in the background
        # for up to _check_interval seconds after stop().
