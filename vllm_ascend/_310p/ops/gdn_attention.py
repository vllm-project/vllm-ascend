...
from vllm_ascend._310p.ops.qkvzba_split_reshape import (
    fused_qkvzba_split_reshape_cat_pytorch,
)
from vllm_ascend._310p.ops.gdn_gating import fused_gdn_gating_pytorch
from vllm_ascend._310p.ops.delta_rule import (
...
def gdn_attention_core_impl(
    ...
    This is called by torch.ops.vllm.gdn_attention_core.
    """
