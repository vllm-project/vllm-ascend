...
def register_connector():
    ...
    from vllm_ascend.distributed.ec_transfer import register_connector as register_ec_connector
    from vllm_ascend.distributed.kv_transfer import register_connector as register_kv_connector
