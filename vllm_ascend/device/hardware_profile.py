...
class KVCacheLayout(Enum):
    """KV cache storage layouts selected by a hardware profile."""
...
_CUSTOM_OP_CAPABILITIES = frozenset({HardwareCapability.CUSTOM_OPS})
_HARDWARE_PROFILES: Mapping[AscendDeviceType, HardwareProfile] = MappingProxyType(
    {
        AscendDeviceType.A2: HardwareProfile(
            ...
            kv_cache_layout=KVCacheLayout.ND,
            capabilities=_CUSTOM_OP_CAPABILITIES,
        ),
        ...
        AscendDeviceType._310P: HardwareProfile(
            ...
            kv_cache_layout=KVCacheLayout.FRACTAL_NZ,
