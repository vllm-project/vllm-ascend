...
# ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
#   1. `vllm.config.vllm.VllmConfig.__post_init__`
#    Why:
...
#    How:
#       Import the configured plugin before the original `VllmConfig.__post_init__`
#       resolves reasoning token IDs. Skip the import when the parser is already
#       registered, preserving API-server and programmatic registration behavior.
#    Related PR (if no, explain why):
