...
#    Why:
#       Vllm transfer the kv blocks data only when this block have already been fulfilled.
#       However, this behaviour may cause decode node
#       exist prefill behaviour. In order to make decode node work as expected,
#       we always transfer all data whether or not the block is filled.
#    How：
#       The num_computed_token shall always equal to the token number of request during scheduling.
