    ...
    if not preempted_reqs:
        while self.waiting and token_budget > 0:
            ...
            # Number of tokens to be scheduled.
                ...
                # We use `request.num_tokens_with_spec` instead of
