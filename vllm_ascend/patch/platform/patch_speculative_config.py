...
def _normalize_deepseek_v4_dspark_draft(draft_model_config) -> None:
    ...
    is_v41 = is_deepseek_v41(hf_config)
    if (
        hf_config is None
    ...
    architecture = "DeepseekV41DSparkModel" if is_v41 else "DSparkDraftModel"
    if is_v41:
    ...
    normalized_model_type = "deepseek_v41" if is_v41 else str(root_model_type)
    hf_config.update(
        {
