...
_original_signal_callback = SignalCallback.trigger
...
def patched_signal_callback(self):
    _watchdog.dump_stack("signal")
    return _original_signal_callback(self)


def patch_watchdog_for_engine_core():
    SignalCallback.trigger = patched_signal_callback
