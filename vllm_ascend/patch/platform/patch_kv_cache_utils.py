...
from vllm_ascend.core.kv_cache_interface import is_deepseek_v41_cache, is_prefix_cacheable
...
def _ascend_get_packed_kv_cache_groups(
    ...
    if is_deepseek_v41_cache(kv_cache_spec):
        from vllm_ascend.models.deepseek_v41.cache_config import group_cache_specs, make_cache_groups
...
def _ascend_pool_bytes_per_block(kv_cache_groups: list[KVCacheGroupSpec]) -> int:
    ...
    if is_deepseek_v41_cache(kv_cache_groups):
        from vllm_ascend.models.deepseek_v41.cache_config import get_deepseek_v41_pool_bytes_per_block
...
def _ascend_get_kv_cache_config_from_groups(
    ...
    if is_deepseek_v41_cache(kv_cache_groups):
        from vllm_ascend.models.deepseek_v41.cache_config import get_deepseek_v41_kv_cache_config
