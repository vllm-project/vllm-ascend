...
def _patch_remove_skipped_blocks() -> None:
    ...
    SingleTypeKVCacheManager.remove_skipped_blocks = remove_skipped_blocks  # type: ignore[method-assign]
...
def _patch_sliding_window_mask() -> None:
    ...
    SlidingWindowManager.reachable_block_mask = reachable_block_mask  # type: ignore[attr-defined]
    SlidingWindowManager.cache_blocks = cache_blocks  # type: ignore[method-assign]
