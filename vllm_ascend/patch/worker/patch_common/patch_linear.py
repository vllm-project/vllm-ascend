...
from vllm.model_executor.layers.linear import LinearBase,WEIGHT_LOADER_V2_SUPPORTED,adjust_bitblas_shard, adjust_bitsandbytes_4bit_shard, adjust_marlin_shard
...
if envs.VLLM_ASCEND_ENABLE_MLP_OPTIMZE:
    vllm.model_executor.layers.linear.MergedColumnParallelLinear = ATTNMergedColumnParallelLinear
    vllm.model_executor.layers.linear.RowParallelLinear = AttnRowParallelLinear
