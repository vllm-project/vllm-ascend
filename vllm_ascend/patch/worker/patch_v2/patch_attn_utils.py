...
from vllm_ascend.patch.worker.patch_bind_kv_cache import bind_kv_cache, bind_kv_cache_to_layers
...
if not vllm_version_is("0.29.0"):
    # vLLM main routes init_kv_cache through bind_kv_cache_to_layers instead of
    # the runner-list bind_kv_cache, so patch the symbol it now calls.
