...
class CustomDeepseekV2ForCausalLM(DeepseekV2ForCausalLM):
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        expert_params_mapping = SharedFusedMoE.make_expert_params_mapping(
            ...
            num_experts=self.config.n_routed_experts + (self.config.n_shared_experts if mix_placement else 0),
        ...
        for name, loaded_weight in weights:
            ...
            is_fuse_shared_experts_layer = mix_placement and ("mlp.shared_experts" in name)
    ...
    def load_weights(self, weights: Iterable[tuple[str, torch.Tensor]]) -> set[str]:
        ...
        for name, loaded_weight in weights:
            ...
            if spec_layer is None:
                continue
            is_fusion_moe_shared_experts_layer = mix_placement and ("mlp.shared_experts" in name)
