...
from vllm_ascend.observability.runtime_guard.rank_gate import dump_rank_tag, should_run_anomaly_check_on_rank
...
class ActionExecutor:
    ...
    def anomaly_check_skip_reason(self) -> str | None:
        from vllm_ascend.observability.runtime_guard.rank_gate import anomaly_check_rank_skip_reason
