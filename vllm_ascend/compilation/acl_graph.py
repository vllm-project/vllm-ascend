...
class GraphParams:
    ...
    conv1d_params: dict[int, list[tuple]]  # 新增：存储conv1d参数
    conv1d_handles: dict[int, list[torch_npu._C._NPUTaskGroupHandle]]  # 新增：conv1d专用handles
    conv1d_events: dict[int, list[torch.npu.ExternalEvent]]  # 新增：conv1d专用events
