...
def compute_mega_moe_buffer_tokens_per_rank(
    ...
    """Compute the rank-local input capacity of the A5 MegaMoE buffer."""
...
class AscendConfig:
    ...
    def __init__(self, vllm_config: "VllmConfig"):
        ...
        # Platform-specific fused-MoE token ceiling. A5 MegaMoE treats this as
        # a global input limit and divides it by the EP world size. A2/A3
        # continue to interpret it as the maximum rank-local receive capacity
        # after dispatch. Default 65536.
