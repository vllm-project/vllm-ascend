...
class AscendConfig:
    ...
    def __init__(self, vllm_config: "VllmConfig"):
        ...
        # Per-rank token capacity for dispatch_ffn_combine. A5 MegaMoE instead
        # treats this as a global ceiling and derives its per-rank symmetric-buffer
        # capacity from that ceiling and the current process's MC2 execution capacity.
        # Default 65536.
