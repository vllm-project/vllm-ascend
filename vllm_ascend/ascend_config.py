...
class AscendConfig:
    ...
    _sparse_li_c4_layer_filter_enabled: bool = dataclasses.field(default=False, init=False, repr=False)
    ...
    def _has_sparse_li_c8_layer_config(quant_config: Any) -> bool:
        """Compatibility alias for callers testing the original C8 filter."""
        return AscendConfig._has_sparse_li_layer_config(quant_config)
    ...
    def _parse_sparse_li_c8_layers_from_quant_config(cls, quant_config: Any) -> tuple[set[int], set[str]]:
        """Compatibility wrapper for the original C8-only parser."""
        return cls._parse_sparse_li_layers_from_quant_config(quant_config, ("INT8_DYNAMIC", "W8A8_MXFP8"))
    ...
    def is_sparse_li_c8_layer(self, layer_name: str | None) -> bool:
        return self._is_sparse_li_layer(
            ...
            self._sparse_li_c8_layer_filter_enabled,
            self._sparse_li_c8_layer_names,
            self._sparse_li_c8_layer_ids,
        )
    ...
    def is_sparse_li_c4_layer(self, layer_name: str | None) -> bool:
        return self._is_sparse_li_layer(
            ...
            self._sparse_li_c4_layer_filter_enabled,
            self._sparse_li_c4_layer_names,
            self._sparse_li_c4_layer_ids,
        )
