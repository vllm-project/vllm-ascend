...
class AscendConfig:
    ...
    def is_sparse_c8_layer(self, layer_name: str | None) -> bool:
        ...
        score_encoder_cache_config = additional_config.get(
            "score_encoder_cache_config", {})
        self.score_encoder_cache_config = ScoreEncoderCacheConfig(
            score_encoder_cache_config, vllm_config)
...
class ScoreEncoderCacheConfig:
    ...
    """
    def __init__(self,
                score_encoder_cache_config: dict, vllm_config):
        """
