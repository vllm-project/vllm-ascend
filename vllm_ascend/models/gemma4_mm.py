...
_W4A4_MXFP4_QUANT_SCHEME = "W4A4_MXFP4"
...
def _get_tower_quant_config(
    ...
    *,
    allow_unaligned_mxfp4: bool = False,
    ...
    if allow_unaligned_mxfp4 and quant_config and quant_config.get_name() == ASCEND_QUANTIZATION_METHOD:
        quant_description = getattr(quant_config, "quant_description", {})
        if any(
            name.startswith(("model.vision_tower.", "vision_tower.")) and quant_scheme == _W4A4_MXFP4_QUANT_SCHEME
            for name, quant_scheme in quant_description.items()
        ):
            return quant_config
...
class AscendGemma4ForConditionalGeneration(Gemma4ForConditionalGeneration):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        vision_tower_quant = _get_tower_quant_config(vllm_config, allow_unaligned_mxfp4=True)
