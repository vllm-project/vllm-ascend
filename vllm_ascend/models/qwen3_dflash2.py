...
class DFlash2Qwen3Model(DFlashQwen3Model):
    # PR 52816 makes the parent ctor build layers via self.decoder_layer_cls;
    # on main this class attribute is read directly and the module-global swap
    # below is only needed for the v0.27.1 branch where it does not exist.
...
class DFlash2Qwen3ForCausalLM(DFlashQwen3ForCausalLM):
    ...
    # PR 52816 makes the parent ctor build the draft model via self.model_cls;
    # on main this class attribute is read directly and the module-global swap
    # below is only needed for the v0.27.1 branch where it does not exist.
