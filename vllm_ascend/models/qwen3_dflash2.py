...
class DFlash2Qwen3Model(DFlashQwen3Model):
    ...
    # this class factory. Keep the global swap below for v0.27.1 and declare
    # the main-lane factory so both versions build DFlash2 decoder layers.
    ...
    def __init__(
        ...
        *,
        ...
        if not vllm_version_is("0.27.1"):
            ...
            # v0.27.1 resolves this dependency from the module global.
