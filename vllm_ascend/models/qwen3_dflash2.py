    ...
    def __init__(
        ...
        *,
        ...
        if vllm_version_is("0.27.1"):
            ...
            # v0.27.1 upstream builds layers from the module-global
            # DFlashQwen3DecoderLayer; swap it so the parent ctor builds
            # DFlash2 layers.
            ...
            # main: upstream reads self.decoder_layer_cls, which resolves to
            # DFlash2Qwen3DecoderLayer via the class attribute above.
            super().__init__(
                vllm_config=vllm_config,
                start_layer_id=start_layer_id,
                prefix=prefix,
...
class DFlash2Qwen3ForCausalLM(DFlashQwen3ForCausalLM):
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = "") -> None:
        if vllm_version_is("0.27.1"):
            ...
            # main: upstream reads self.model_cls, which resolves to
            # DFlash2Qwen3Model via the class attribute above.
            super().__init__(vllm_config=vllm_config, prefix=prefix)
