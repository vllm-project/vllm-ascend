...
class AscendQwen2_5_VisionTransformer(Qwen2_5_VisionTransformer):
    ...
    def pad_qkv_weight(self, data):
        ...
        qkv_weight_final_copy = torch.empty_like(qkv_weight_final).copy_(qkv_weight_final)
        qkv_weight_final_copy = torch_npu.npu_format_cast(qkv_weight_final_copy, ACL_FORMAT_FRACTAL_ND)
    ...
    def pad_proj_weight(self, data):
        ...
        out_weight_copy = torch_npu.npu_format_cast(out_weight_copy, ACL_FORMAT_FRACTAL_ND)
