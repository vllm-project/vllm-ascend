...
if vllm_envs.VLLM_PLE_CPU_OFFLOAD:
    raise NotImplementedError(
        "VLLM_PLE_CPU_OFFLOAD is not supported on Ascend. The upstream "
        "Qwen3.8 Flash-Next offload protocol uses CUDA Driver semaphores, "
        "CUDA IPC, and CUDA streams. Disable VLLM_PLE_CPU_OFFLOAD to run "
        "PLE on the NPU."
    )
