...
def _decode_index_score_kernel(
    ...
    score_row_base = score_ptr + head_offsets * stride_s_h + query_id * stride_s_n
    ...
    if (partial_block_id < valid_block_count) & (partial_block_id >= normal_start) & (partial_block_id < normal_end):
...
def minimax_m3_index_decode(
    ...
    target_program_count = detected_aicore_count if detected_aicore_count > 0 else DECODE_SCORE_FALLBACK_PROGRAM_COUNT
