...
def _minimax_m3_sparse_attn_kv_gather_q(
    ...
    *,
    ...
    op_kwargs: dict[str, Any] = {}
    if envs.VLLM_ASCEND_MINIMAX_M3_PREFILL_METADATA:
        # The C++ binding runs the device-side scheduling producer followed by
        # its consumer on the same stream, including during graph replay. The
        # metadata protocol is shared by the A3 BF16 and A5 FP8 packages.
