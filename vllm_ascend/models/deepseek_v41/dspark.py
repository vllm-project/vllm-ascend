...
class DeepseekV41DSparkModel(torch.nn.Module, DeepseekDSparkModelMixin):
...
class DSparkDeepseekV41ForCausalLM(DeepseekDSparkForCausalLMMixin, torch.nn.Module, SupportsEagle3):
    def __init__(self, *, vllm_config, prefix="") -> None:
        super().__init__()
        assert vllm_config.speculative_config is not None
