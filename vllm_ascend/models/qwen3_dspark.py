...
class AscendQwen3DSparkForCausalLM(Qwen3DSparkForCausalLM):
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = "") -> None:
        ...
        # Draft attention uses its own ModelConfig; rotation and fallback
        # embeddings still belong to the target model's basis.
        ...
        self.rotation_path = get_rotation_path(target_vllm_config)
