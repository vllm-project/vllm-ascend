...
class NPUInputBatch(InputBatch):
    ...
    def __init__(
        ...
        self.num_tokens = np.zeros(max_num_reqs, dtype=np.int32)  # type: ignore[var-annotated]
        ...
        # lora related
        self.request_lora_mapping = np.zeros((self.max_num_reqs,), dtype=np.int64)  # type: ignore[var-annotated]
        ...
        self.logits_processing_needs_token_ids = np.zeros(max_num_reqs, dtype=bool)  # type: ignore[var-annotated]
