...
def _get_kv_cache_config_deepseek_v4_main(
    ...
    num_blocks = kv_cache_planning.may_override_num_blocks(vllm_config, num_blocks)
...
class AscendKVCacheConfigBuilder(KVCacheConfigBuilder):
    ...
    def build_kv_cache_configs(
        ...
        kv_cache_planning._annotate_eagle_groups(
            vllm_config, merged_kv_cache_specs, global_kv_cache_groups, use_deepseek_v4_fallback=True
        )
