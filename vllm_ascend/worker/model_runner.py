...
from vllm_ascend.attention.attention_torchair import AscendTorchairMetadata
...
from vllm_ascend.worker.eagle_proposer import EagleProposer
from vllm_ascend.worker.mtp_proposer import MtpProposer
