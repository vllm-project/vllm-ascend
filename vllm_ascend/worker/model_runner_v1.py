...
class NPUModelRunner(LoRAModelRunnerMixin):
    ...
    def _process_reqs(
        ...
        # the copy from block_table.slot_mapping_cpu to self.slot_mapping_cpu
        # is a temporary resolution, we will drop it till attention builder
        # don't rely on the model_runner any more.
