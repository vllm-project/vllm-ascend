...
try:
    from vllm.utils.gpu_sync_debug import gpu_sync_allowed
except ImportError:  # pragma: no cover - exercised on older vLLM
...
class NPUModelRunner(GPUModelRunner):
    ...
    def _compute_logits_with_guard(self, sample_hidden_states):
    ...
    def _execute_model_after_sync(
        ...
        with record_function_or_nullcontext("post process"):
            ...
            if not self.broadcast_pp_output:
                ...
                logits = self._compute_logits_with_guard(sample_hidden_states)
            else:
                # Rare case.
    ...
    def sample_tokens(
        ...
        result, routed_experts_result = self.runtime_guard.run_sample_phase(
            ...
            routed_experts_fn=routed_experts_fn if self.routed_experts_initialized else None,
        ...
        is_output_rank = is_async_output_rank()
        num_nans_kw = (
