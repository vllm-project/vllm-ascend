...
from vllm_ascend.worker.eagle_v1 import EagleProposer
from vllm.v1.spec_decode.metadata import SpecDecodeMetadata
from vllm.v1.spec_decode.ngram_proposer import NgramProposer
from vllm.v1.spec_decode.utils import is_spec_decode_supported
...
class NPUModelRunner(LoRAModelRunnerMixin):
    ...
    ) -> tuple[dict[str, AscendMetadata], torch.Tensor,
    ...
    def _process_reqs(
        ...
        if self.use_aux_hidden_state_outputs:
            ...
            return hidden_states[self.logits_indices], aux_hidden_states, num_input_tokens, spec_decode_metadata
        elif self.speculative_config.method == "eagle":
            hidden_states = model_output[self.logits_indices]
    ...
    def execute_model(
        ...
        with ProfileExecuteDuration().capture_async(
            ...
            attn_metadata_dict, logits_indices, spec_decode_metadata = (
        ...
        with ProfileExecuteDuration().capture_async("post process"):
            ...
            if self.use_aux_hidden_state_outputs:
                (hidden_states, aux_hidden_states, num_input_tokens, spec_decode_metadata) = (
