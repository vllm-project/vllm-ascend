            ...
            for idx in range(len(shared_layers)):
                ...
                if (
                    ...
                    if use_legacy_shared_by_layout:
                        ...
                        # C8-MXFP: the two E8M0 scale payloads follow this
                        # branch's one-allocation contract -- allocated once at
                        # group level and handed to every shared layer; the
                        # reshape stage carves per-layer regions by offset.
