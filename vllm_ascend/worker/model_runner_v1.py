...
class NPUModelRunner(GPUModelRunner):
    ...
    def _sync_metadata_across_dp(
        ...
        is_mc2_or_allgather = comm_method in {MoECommType.MC2, MoECommType.ALLGATHER}
        ...
        #    TODO(zzzzwwjj): It can be remove after op support dynamic bs in this case.
        ...
        if is_mc2_or_allgather or is_finegrained_tp:
