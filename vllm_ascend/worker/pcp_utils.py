...
class PCPManager:
    ...
    def init_batch_info(
        ...
        is_prefill = (num_scheduled_tokens[:num_reqs] > reorder_batch_threshold) | (num_computed_tokens[:num_reqs] == 0)
    ...
    def generate_pcp_metadata(self, total_num_scheduled_tokens, query_lens,
        ...
        if self.pcp_world_size * self.dcp_world_size > 1:
            decode_context_lens = input_batch.num_tokens[:self.num_decode_reqs]
