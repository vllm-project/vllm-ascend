...
class NPUModelRunner(GPUModelRunner):
    ...
    request_state_cls = AscendRequestState
    aclgraph_manager_cls = ModelAclGraphManager
    ...
    def __init__(self, vllm_config: VllmConfig, device: torch.device):
        ...
        self.req_states: AscendRequestState = self.request_state_cls(
...
def graph_manager_wrapper(model_runner):
    ...
    def factory(
        ...
        return model_runner.aclgraph_manager_cls(
            vllm_config,
            device,
            cudagraph_mode,
            decode_query_len,
