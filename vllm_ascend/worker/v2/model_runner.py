...
class NPUModelRunner(GPUModelRunner):
    ...
    def gather_batch_req_state(self, scheduler_output: SchedulerOutput, dummy_run: bool):
        ...
        if batch_state is not None and self._dp_padding_group_max > batch_state.num_tokens:
            batch_state = batch_state._replace(num_tokens=self._dp_padding_group_max)
        num_tokens = None
