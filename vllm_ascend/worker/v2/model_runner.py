...
class NPUModelRunner(GPUModelRunner):
    ...
    def execute_model(
        ...
        # for dummy-run context setup; v0.27.1's execute_model has no such
    ...
    def prepare_inputs(
        ...
        *args,
        ...
        (scheduler_output, batch_req_state, batch_desc); v0.27.1 passes only
        (scheduler_output, batch_desc).
        """
...
def graph_manager_wrapper(model_runner):
    ...
    def factory(
        ...
        # manager factory; v0.27.1 has no such parameter, so only forward it on
        # the main lane.
        if vllm_version_is("0.27.1"):
