...
if vllm_version_is("0.28.0"):
    ...
    def _prepare_dflash_inputs_v028(
    ...
    prepare_dflash_inputs = _prepare_dflash_inputs_v028
    ...
    def _prepare_dflash_inputs_main(
        input_buffers: InputBuffers,
        query_slot_mapping: torch.Tensor,
        context_positions: torch.Tensor,
        context_slot_mapping: torch.Tensor,
    ...
    prepare_dflash_inputs = _prepare_dflash_inputs_main
