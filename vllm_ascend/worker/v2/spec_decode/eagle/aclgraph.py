...
class EagleAclGraphManager(SpeculatorCudaGraphManager):
    ...
    def __init__(
        ...
        # The upstream constructor creates this manager before the speculator
        # can attach the state needed by Ascend graph replay.
        ...
        # Attention graph parameters must be registered before capture.
    ...
    def capture(
        ...
        with communicator_switch(), model_capture_wrapper(self.speculator, self.is_draft_model_prefill):
            ...
            def create_forward_fn(desc: BatchExecutionDescriptor, warmup: bool):
                ...
                seq_lens_cpu_upper_bound[-1] += num_tokens % num_reqs
