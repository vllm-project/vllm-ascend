...
class PrefillEagleAclGraphManager(PrefillEagleCudaGraphManager):
    ...
    def run_fullgraph(self, desc: BatchExecutionDescriptor) -> torch.Tensor | tuple[torch.Tensor, list[torch.Tensor]]:
        ...
        if self.is_draft_model_prefill:
            logger.info_once("PrefillEagleAclGraphManager: draft prefill run_fullgraph with num_tokens=%d", num_tokens)
        else:
            logger.info_once("DecodeEagleAclGraphManager: draft run_fullgraph with num_tokens=%d", num_tokens)
