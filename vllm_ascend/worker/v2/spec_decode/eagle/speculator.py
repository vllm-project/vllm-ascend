...
if vllm_version_is("0.21.0"):
    from vllm.v1.worker.gpu.spec_decode.eagle import speculator as vllm_speculator_module
...
class AscendEagleSpeculator(EagleSpeculator):
    ...
    def _update_decode_attn_metadata(self, attn_metadata: dict[str, Any] | None, step: int, num_reqs: int | None = None):
