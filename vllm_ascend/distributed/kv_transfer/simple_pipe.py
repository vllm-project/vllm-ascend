...
class SimplePipe(KVPipeBase):
    ...
    def __init__(
        ...
        self.prefill_cluster_id = global_rank_table["prefill_device_list"][self.p_device_rank]["cluster_id"]
        self.decode_cluster_id = global_rank_table["decode_device_list"][self.d_device_rank]["cluster_id"]
    ...
    def _prepare_link_info(self, global_rank_table):
        ...
        rank_table["server_count"] = server_count
    ...
    def _make_cluster(self, global_rank_table):
        ...
        comm_id = self.data_dist.link(comm_name, cluster_rank_info, rank_table)
        while True:
    ...
    def send_tensor(
        ...
        buffer = self.cache_manager.allocate_cache(tensor_desc, [tensor_key])
        ...
        # TODO: Need to manually call cache_manager.remove_cache_key if D fail to pull cache.
        self.cache_manager.deallocate_cache(buffer)
        return buffer
    ...
    def recv_tensor(
        ...
        tmp_buffer = self.cache_manager.allocate_cache(tensor_desc)
