    ...
    def _transfer_kv_cache_all_groups(self, req_meta: dict[str, Any]):
        ...
        for group_pull in group_pulls:
            ...
            if not is_mamba_group:
                ...
                first_local_layer_idx, first_remote_layer_idx = layer_pairs[0]
                local_scale = self.block_size_scale[first_local_layer_idx][0]
                remote_scale = remote_block_size_scale[first_remote_layer_idx][0]
