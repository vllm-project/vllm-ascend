...
class MooncakeHeterogeneousXferAdapter:
    ...
    def __init__(self, hostname: str, port: int, num_layers: int):
        ...
        self._sock: zmq.Socket | None = None  # type: ignore
    ...
    def start_listener(self) -> None:
        ...
        self._sock = ctx.socket(zmq.ROUTER)  # type: ignore
    ...
    def _listen_loop(self) -> None:
        ...
        poller.register(self._sock, zmq.POLLIN)  # type: ignore
        while not self._stopped:
            ...
            if self._sock not in events:
                continue
            try:
                identity, metadata_bytes = self._sock.recv_multipart(zmq.NOBLOCK)  # type: ignore
            except zmq.ContextTerminated:  # type: ignore
                break
