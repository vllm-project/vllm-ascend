...
from vllm.v1.engine.metadata import MLAConfig, MetadataServer
...
class CPUOffloadingConnector(KVConnectorBase_V1):
    ...
    def request_finished(
        ...
        return True, None
    def sending_finished(self, request: "Request"):
        assert self.connector_scheduler is not None
        self.connector_scheduler.sending_finished(request)
class CPUOffloadingConnectorScheduler:
    ...
    def sending_finished(self, request: "Request"):
        self.zmq_rpc_client.call("cache_and_free_slots", request)
