...
class LMCacheAscendConnectorV1(KVConnectorBase_V1):
    def __init__(
        self,
        ...
        ImplCls = LMCacheAscendConnectorV1Dynamic
        self._lmcache_engine = ImplCls(vllm_config, role)
    ...
    def has_connector_metadata(self) -> bool:
        ...
        """
        return self._lmcache_engine.has_connector_metadata()
    ...
    def clear_connector_metadata(self) -> None:
        ...
        """
        self._lmcache_engine.clear_connector_metadata()
    ...
    def bind_connector_metadata(self, connector_metadata: KVConnectorMetadata) -> None:
        ...
        """
        self._lmcache_engine.bind_connector_metadata(connector_metadata)
    ...
    def get_num_new_matched_tokens(
        ...
        """
        return self._lmcache_engine.get_num_new_matched_tokens(request, num_computed_tokens)

    def update_state_after_alloc(self, request: "Request", blocks: "KVCacheBlocks", num_external_tokens: int) -> None:
        """
        Update KVConnector state after block allocation.
        """
        self._lmcache_engine.update_state_after_alloc(request, blocks, num_external_tokens)
    ...
    def build_kv_connector_stats(cls, data: dict[str, Any] | None = None) -> Optional["KVConnectorStats"]:
        ...
        """
        return LMCacheAscendConnectorV1Dynamic.build_kv_connector_stats(data)
    ...
    def build_prom_metrics(
        ...
        LMCacheAscendConnectorV1Dynamic engine.
        """
        return LMCacheAscendConnectorV1Dynamic.build_prom_metrics(
            vllm_config,
            metric_types,
            labelnames,
