...
class LLMDataDistConnector(KVConnectorBase):
    ...
    def send_kv_caches_and_hidden_states(
        ...
        self.value_cache = torchair.llm_datadist.create_npu_tensors(value_desc.shape, kv_hidden_dtype,
                                                                    value_buffer_addr)
        self.input_cache = torchair.llm_datadist.create_npu_tensors(input_desc.shape, input_dtype, input_buffer_addr)
        self.hidden_cache = torchair.llm_datadist.create_npu_tensors(hidden_desc.shape, kv_hidden_dtype,
                                                                     hidden_buffer_addr)
