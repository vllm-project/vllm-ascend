        ...
        for req_id, num_tokens_scheduled in num_scheduled_tokens.items():
            ...
            if new_token_ids or pooler_output is not None or kv_transfer_params or ec_transfer_params or stopped:
                ...
                if not vllm_version_is("0.25.1"):
                    engine_core_kwargs["ec_transfer_params"] = ec_transfer_params
                outputs[request.client_index].append(EngineCoreOutput(**engine_core_kwargs))
            else:
