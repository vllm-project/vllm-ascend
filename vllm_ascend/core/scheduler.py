...
class AscendScheduler(Scheduler):
    ...
    def __init__(
        ...
        self.decode_max_num_running_reqs = max(self.max_num_running_reqs,
                                               decode_max_num_seqs)
        self.dynamic_batch=self.scheduler_config.SLO_limits_for_dynamic_batch!=-1
    ...
    def schedule(self) -> SchedulerOutput:
        if self.scheduler_config.chunked_prefill_enabled and not self.dynamic_batch:
            return super().schedule()
        elif self.dynamic_batch:
            # Chunked prefill scheduling method with dynamic batch is called.
            return self.schedule_with_dynamic_batch()
    ...
    def schedule_with_dynamic_batch(self) -> SchedulerOutput:
