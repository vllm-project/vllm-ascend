...
class LlamaXliteModel(XliteModel):
    ...
    def _build_model(self) -> None:
        ...
        if self.quantization:
            ...
            norm_bias = params_dict.get(model_prefix + "model.norm.bias")
            if norm_bias is not None and not self.all_tensors_zero([norm_bias]):
                xlite_model.norm_bias = norm_bias
            if params_dict.get(model_prefix + "model.layers.0.input_layernorm.bias") is not None:
            ...
            if params_dict.get(model_prefix + "model.layers.0.post_attention_layernorm.bias") is not None:
            ...
            # quant weights
            if params_dict.get(model_prefix + "model.layers.0.self_attn.qkv_proj.deq_scale") is not None:
            ...
            if params_dict.get(model_prefix + "model.layers.0.self_attn.o_proj.deq_scale") is not None:
            ...
            # for dense model
            if params_dict.get(model_prefix + "model.layers.0.mlp.gate_up_proj.deq_scale") is not None:
            ...
            if params_dict.get(model_prefix + "model.layers.0.mlp.down_proj.deq_scale") is not None:
        ...
        if len(q_norm) != xlite_config.n_layers or len(k_norm) != xlite_config.n_layers:
            ...
            if self.quantization:
                if params_dict.get(model_prefix + "model.layers.0.self_attn.q_norm.bias") is not None:
                ...
                if params_dict.get(model_prefix + "model.layers.0.self_attn.k_norm.bias") is not None:
