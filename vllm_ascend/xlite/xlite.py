...
class XliteWrapper:
    ...
    def __call__(
        ...
        if use_xlite_graph:
            ...
            # - Non-DP: batch_tokens == current_tokens
            # - DP: batch_tokens >= current_tokens
            batch_tokens = forward_context.batch_descriptor.num_tokens
            current_tokens = attn_metadata.num_actual_tokens
            h = self.hidden_states[:batch_tokens]
