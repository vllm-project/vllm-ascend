...
from vllm_ascend.utils import ACL_FORMAT_FRACTAL_NZ, get_ascend_soc_version, AscendSocVersion
...
class PanguProMoESparseMoeBlock(nn.Module):
    ...
    def __init__(
        ...
        num_voted_experts = 5 if get_ascend_soc_version() == AscendSocVersion._310P else 8
...
class PanguProMoEForCausalLM(nn.Module, SupportsPP):
    ...
    def load_weights(self, weights: Iterable[Tuple[str, torch.Tensor]]):
        ...
        for name, loaded_weight in weights:
            ...
            if get_ascend_soc_version() == AscendSocVersion._310P and "head" in name:
