...
class NPUPlatform(Platform):
    ...
    def check_and_update_config(cls, vllm_config: VllmConfig) -> None:
        ...
        # 4. kv_transfer_config legal check
        ...
        # 5. compilation config update
        ascend_compilation_config = ascend_config.ascend_compilation_config
        if ascend_compilation_config and ascend_compilation_config.fuse_allreduce_rms:
        ...
        # 7. Update compilation mode in some cases
        if enforce_eager:
        ...
        # 8. Update cudagraph_mode in some cases
        ...
        # 9. set cudaprah sizes before extending `compilation_config.splitting_ops`
        compilation_config.cudagraph_num_of_warmups = 1
        vllm_config._set_cudagraph_sizes()

        # 10. Set and update for different cudagraph_mode
        ...
        # 11. check ASCEND_LAUNCH_BLOCKING
        ...
        # 12. update graph capture sizes for sequence parallelism
        ...
        # 13. refresh block_size for some special cases
        refresh_block_size(vllm_config)

        # 14. Activate custom ops, except on 310P
        if get_ascend_device_type() != AscendDeviceType._310P:
            compilation_config.custom_ops = ["all"]

        # 15. Set PYTORCH_NPU_ALLOC_CONF=expandable_segments:True to optimize NPU memory management.
