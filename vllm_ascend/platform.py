...
class NPUPlatform(Platform):
    ...
    def pre_register_and_update(cls, parser: FlexibleArgumentParser | None = None) -> None:
        ...
        # Motor fork-group parent imported vLLM with devices hidden. Skip NPU-touching
        # registration here; each child restores ASCEND_RT_VISIBLE_DEVICES and calls
        # this method again without MOTOR_VLLM_FORK_PARENT.
