...
class NPUPlatform(Platform):
    ...
    def get_attn_backend_cls(cls, selected_backend, attn_selector_config, num_heads: int | None = None):
        ...
        if use_dcp is None:
            ...
            parallel_config = getattr(get_current_vllm_config(), "parallel_config", None)
            use_dcp = parallel_config is not None and parallel_config.decode_context_parallel_size > 1
