...
class AscendMlaCPMetadataBuilder(AscendMLAMetadataBuilder):
    ...
    def build_cp_metadata(
        ...
        return AscendPCPMetadata(
            ...
            kv_with_q_head_nomask_idx_in_tail=common_long_seq_metadata.kv_with_q_head_nomask_idx_in_tail_tensor,
            kv_with_q_head_mask_idx_in_tail=common_long_seq_metadata.kv_with_q_head_mask_idx_in_tail_tensor,
            kv_with_q_tail_nomask_idx_in_tail=common_long_seq_metadata.kv_with_q_tail_nomask_idx_in_tail_tensor,
            kv_with_q_tail_mask_idx_in_tail=common_long_seq_metadata.kv_with_q_tail_mask_idx_in_tail_tensor,
