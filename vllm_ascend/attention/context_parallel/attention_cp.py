        ...
        if num_prefills > 0:
            ...
            if self.chunked_prefill_enabled and max_context_len_cpu > 0:
                ...
                kv_inverse_idx_for_chunk = torch.argsort(
                    common_pcp_metadata.pcp_allgather_restore_idx[self.pcp_size * num_decode_tokens :].to(torch.float32)
                )
            ...
            assert head_attn_nomask_seqlens
            assert tail_attn_nomask_seqlens
            if self.pcp_size > 1:
