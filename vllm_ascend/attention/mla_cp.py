...
class AscendMlaCPMetadataBuilder(AscendMLAMetadataBuilder):
    ...
    def set_num_actual_tokens(
        ...
        if self.num_actual_tokens is None:
    ...
    def build_chunked_metadata(
        ...
        local_context_lens_allranks = None
        ...
        chunked_context_metadata.starts = local_chunk_starts.pin_memory().to(
        ...
        chunked_context_metadata.padded_local_cu_seq_lens = padded_local_cu_chunk_seq_lens_cpu.pin_memory(
