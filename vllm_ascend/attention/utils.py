...
def get_index_of_skipped_queries_numpy(
                                actual_seq_lengths_query: np.array,
                                actual_seq_lengths_key: np.array,
                                num_actual_seqs: int, 
                                sparse_count: int):
    ...
    num_tokens = np.sum(skipped_q_lens)
    if num_tokens == 0:
    ...
    # 5. calculate each token's key legth
