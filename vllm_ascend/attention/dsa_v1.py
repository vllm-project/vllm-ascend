...
from vllm_ascend.device.hardware import AscendDeviceType, get_ascend_device_type
    ...
    def _build_qli_metadata(
        ...
        if qli_metadata is None:
            ...
            if get_ascend_device_type() == AscendDeviceType.A5:
                qli_metadata = torch.ops._C_ascend.npu_quant_lightning_indexer_v2_metadata_cann(
