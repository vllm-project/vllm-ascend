...
def select_dsa_backend(backend: type[AscendDSABackend], *, use_pcp: bool) -> type[AscendDSABackend]:
    """Bind the load-config-dependent PCP mode while preserving the DSA layout."""
    if not use_pcp:
        return backend
