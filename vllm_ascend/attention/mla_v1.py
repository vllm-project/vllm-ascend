...
from vllm_ascend.utils import (ACL_FORMAT_FRACTAL_ND, AscendDeviceType,
    ...
    def _compute_prefill_context(
        ...
        for i in range(iters):
            ...
            if get_ascend_device_type() == AscendDeviceType.A5:
                ...
                prefix_lse, prefix_output = torch_npu.npu_attention_update(
                    prefix_lse, prefix_output, update_type=1)
            else:
