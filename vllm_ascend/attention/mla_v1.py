...
class AscendMLAImpl(MLAAttentionImpl):
    ...
    def _compute_prefill_context(
        ...
        for i in range(iters):
            ...
            # MLA-NoPE exposes zero-width RoPE tensors, which FIA rejects.
            # Other models can pass native non-power-of-two heads through the
            # dedicated RoPE operands without concatenating Q/K.
