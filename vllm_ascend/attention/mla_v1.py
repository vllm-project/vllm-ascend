...
# Kimi K3 MLA dimensions supported by the A3 MlaPrologV3 kernel.
...
class AscendMLAImpl(MLAAttentionImpl):
    ...
    def _has_mla_prolog_v3_op() -> bool:
        if hasattr(torch.ops, "_C_ascend") and hasattr(torch.ops._C_ascend, "npu_mla_prolog_v3"):
            return True
        return enable_custom_op() and hasattr(torch.ops._C_ascend, "npu_mla_prolog_v3")
    ...
    def _supports_kimi_k3_prolog_v3(self, act_dtype: torch.dtype) -> bool:
        ...
        return (
            get_current_hardware_profile().supports(HardwareCapability.KIMI_K3_MLA_PROLOG_V3)
            and getattr(text_config, "model_type", None) == "kimi_linear"
    ...
    def _prepare_kimi_k3_prolog_v3_weights(self) -> None:
        ...
        # Keep an ND copy because the generic fallback may convert W_UK_T to NZ.
    ...
    def _try_kimi_k3_prolog_v3_decode(
        ...
        # buckets on the proven generic implementation.
