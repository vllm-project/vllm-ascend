...
class AscendMLAImpl(MLAAttentionImpl):
    ...
    def _forward_decode_sliding_window(
        ...
        from vllm_ascend.ops.triton.sliding_window_mla import paged_sliding_window_gather
    ...
    def forward(
        ...
        # MLA Preprocess
        if (self.fa_quant_layer or (self.enable_mlapo and not self.has_mla_extras)) and (
