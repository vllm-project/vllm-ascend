...
class AscendMLAImpl(MLAAttentionImpl):
    ...
    def _forward_prefill(
        ...
        if current_ms_metadata is None:
            return self.o_proj(attn_output, True)[0]
        else:
    ...
    def forward(
        ...
        if not self.running_in_graph:
            ...
            if self.tp_size > 1 and has_decode and num_actual_toks % self.tp_size == 0:
                num_output_toks = num_actual_toks // self.tp_size
                output = output[:num_output_toks, ...]
