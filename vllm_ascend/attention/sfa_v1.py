    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.enable_sfa_prolog_v3 = (
            self.is_kv_consumer and self.enable_sparse_sfa_c8 and get_ascend_device_type() != AscendDeviceType.A5
        )
        self.enable_mlapo = ascend_config.enable_mlapo and not (
            self.enable_sfa_prolog_v3
            or (self.enable_sparse_sfa_c8 and get_ascend_device_type() != AscendDeviceType.A5)
        )
