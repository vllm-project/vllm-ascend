...
class AscendDSparkProposer(AscendDflashProposer):
    ...
    def initialize_attn_backend(
        ...
        draft_window_size = getattr(self, "draft_window_size", None)
    ...
    def _prepare_dspark_group_metadata(
        ...
        common_attn_metadata.block_table_tensor = self._pad_metadata_rows(block_table, rows, 0)
        common_attn_metadata.slot_mapping = self._per_group_query_slot_mapping_buffers[gid][:num_input_tokens]
