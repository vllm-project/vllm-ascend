...
class EagleProposer(EagleProposer):
    ...
    def load_model(self, model: nn.Module) -> None:
        ...
        if self.name == SpecDcodeType.MTP and \
        ...
        if self.name == SpecDcodeType.MTP and self.vllm_config.compilation_config.cudagraph_mode.has_full_cudagraphs(
        ):
