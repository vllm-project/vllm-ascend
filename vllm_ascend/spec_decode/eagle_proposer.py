...
class EagleProposer(Proposer):
    ...
    def generate_token_ids(self,
        ...
        if spec_decode_metadata is None:
            ...
            cu_num_tokens, token_indices =\
                    ...
                    common_attn_metadata, num_rejected_tokens, eagle_attn_metadata.query_start_loc)
    ...
    def _prepare_inputs(
        ...
        seq_lens_cpu = common_attn_metadata.seq_lens_cpu[:common_attn_metadata.num_reqs]
        new_seq_lens_cpu = seq_lens_cpu \
