...
class AscendSpecDecodeBaseProposer(SpecDecodeBaseProposer):
    ...
    def __init__(self, vllm_config: VllmConfig, device: torch.device, pass_hidden_states_to_model: bool, runner=None):
        ...
        self.token_arange_np = np.arange(self.max_num_tokens + 1, dtype=np.int32)  # type: ignore[var-annotated]
    ...
    def prepare_inputs(
        ...
        new_query_start_locs_expanded = np.repeat(  # type: ignore[var-annotated]
        ...
        old_query_start_locs_expanded = np.repeat(  # type: ignore[var-annotated]
