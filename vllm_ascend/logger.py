...
Approach C: Same-name override — import-triggered patching of vLLM handler
formatters to add [vllm-ascend] [module] prefix. No module code changes
required. Triggered via a single import in vllm_ascend/__init__.py.
