    ...
    def get_quant_method(
        ...
        if isinstance(layer, LinearBase):
            ...
            if quant_scheme is not None:
                ...
                ascend_quant_config = AscendQuantConfig(self.quant_description or {})
                quant_method = AscendLinearMethod(ascend_quant_config, prefix, None, layer)
            return quant_method
        if isinstance(layer, FusedMoE):
            ...
            if quant_scheme is not None:
                ...
                quant_method = AscendFusedMoEMethod(
                    ascend_quant_config,
                    prefix,
                    ascend_quant_config.packed_modules_mapping,
                    layer,
                )
            return quant_method
        return None
