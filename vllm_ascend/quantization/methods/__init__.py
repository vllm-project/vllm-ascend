...
from .kv_cache.kv_c8 import AscendFAQuantAttentionMethod

# Import registry functions
from .registry import get_scheme_class, register_scheme
from .w4a4.w4a4_flatquant import AscendW4A4FlatQuantDynamicLinearMethod
from .w4a4.w4a4_laos_dynamic import AscendW4A4LaosDynamicLinearMethod
from .w4a4.w4a4_mxfp4 import AscendW4A4MXFP4DynamicFusedMoEMethod, AscendW4A4MXFP4DynamicLinearMethod
from .w4a4.w4a4_mxfp4_flatquant import AscendW4A4MXFP4FlatQuantDynamicLinearMethod
from .w4a8.w4a8 import AscendW4A8DynamicFusedMoEMethod, AscendW4A8DynamicLinearMethod

# Import all scheme classes for external access
from .w4a8.w4a8_mxfp4 import (
    AscendW4A8MXFPDSDynamicFusedMoEMethod,
    AscendW4A8MXFPDynamicFusedMoEMethod,
    AscendW4A8MXFPDynamicLinearMethod,
)
from .w8a8.w8a8_dynamic import AscendW8A8DynamicFusedMoEMethod, AscendW8A8DynamicLinearMethod
from .w8a8.w8a8_mxfp8 import AscendW8A8MXFP8DSDynamicLinearMethod, AscendW8A8MXFP8DynamicLinearMethod
from .w8a8.w8a8_pdmix import AscendW8A8PDMixFusedMoeMethod, AscendW8A8PDMixLinearMethod
from .w8a8.w8a8_static import AscendW8A8LinearMethod
from .w8a8.w8a8fp8_dynamic import AscendW8A8FP8DynamicFusedMoEMethod, AscendW8A8FP8DynamicLinearMethod
from .wna16.w4a16 import AscendW4A16FusedMoEMethod
from .wna16.w4a16_mxfp4 import AscendW4A16MXFP4FusedMoEMethod
from .wna16.w8a16 import AscendW8A16LinearMethod
