...
from vllm_ascend.utils import ACL_FORMAT_FRACTAL_NZ, get_ascend_soc_version, AscendSocVersion, is_enable_nz
...
class AscendW8A8LinearMethod:
    ...
    def __init__(self) -> None:
        ...
        self.transpose_weight = get_ascend_soc_version() != AscendSocVersion._310P
