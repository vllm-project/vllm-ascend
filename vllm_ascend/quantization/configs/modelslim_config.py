    ...
    def get_quant_method(self, layer: torch.nn.Module, prefix: str, tid2eid=None) -> Optional["QuantizeMethodBase"]:
        ...
        if isinstance(layer, LinearBase):
            ...
            if (
                ...
                linear_scheme = create_scheme_for_layer(quant_type, prefix, "linear")
            ...
            if self.is_fa_quant_layer(prefix):
                ...
                attention_scheme = create_scheme_for_layer(fa_quant_type, prefix, "attention")
                ...
                attention_scheme = create_scheme_for_layer(quant_type, prefix, "attention")
                ...
                attention_scheme = AscendC8KVCacheAttentionMethod(self.quant_description, prefix)
            ...
            moe_scheme = create_scheme_for_layer(quant_type, prefix, "moe")
            ...
            embedding_scheme = create_scheme_for_layer(quant_type, prefix, "linear")
