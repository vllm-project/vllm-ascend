...
class AscendQuantConfig(QuantizationConfig):
    ...
    def __init__(self, quant_config: dict[str, Any]):
        ...
        extra_quant_dict = {}
        for k in list(self.quant_description):
            if "shared_head" in k:
    ...
    def create_weights(
        ...
        **extra_weight_attrs,
        ...
        for pergroup_name, pergroup_param in pergroup_dict.items():
            ...
            set_weight_attrs(param, extra_weight_attrs)
            if "weight_scale_second" in pergroup_name or "weight_offset_second" in pergroup_name or is_mx_quant_type(self.quant_method):
                param.input_dim = 1
                param.input_dim = 1
...
class AscendKVCacheMethod(BaseKVCacheMethod):
    ...
    def __init__(self, quant_config: AscendQuantConfig, prefix: str) -> None:
        self.quant_method = get_quant_method(quant_config.quant_description, prefix, "attention")
