...
class AscendW4A8DynamicLinearMethod:
    ...
    def __init__(self):
        ...
        self.group_size = get_current_vllm_config().quant_config.quant_description.get("group_size", 256)
    ...
    def get_pergroup_param(self, input_size: int, output_size: int, params_dtype: torch.dtype) -> Dict[str, Any]:
        params_dict = {}
    ...
    @staticmethod
    def process_second_scale_offset(weight: torch.Tensor, scale: torch.Tensor, per_group_scale: torch.Tensor):
        k, n = weight.shape
    ...
    def process_weights_after_loading(self, layer: torch.nn.Module):
        ...
        layer.weight_scale_second.data, scale_bias = self.process_second_scale_offset(
            layer.weight.data,
