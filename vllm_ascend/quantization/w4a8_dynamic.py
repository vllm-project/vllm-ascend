...
class AscendW4A8DynamicLinearMethod:
    ...
    def get_weight(
        ...
        if self.new_quant_version:
            ...
            params_dict["weight"] = torch.empty(
                actual_output_size, input_size, dtype=torch.int8
            )
            ...
            params_dict["weight"] = torch.empty(
                output_size, input_size, dtype=torch.int8
            )
    ...
    def get_pergroup_param(
        ...
        if self.new_quant_version:
            ...
            params_dict["scale_bias"] = torch.empty(
                output_size, scale_bias_dim, dtype=torch.float32
            )
        return params_dict
...
class AscendW4A8DynamicFusedMoEMethod:
    ...
    def get_weight(
        ...
        param_dict["w13_weight"] = torch.empty(
            num_experts, w13_output_size, hidden_sizes, dtype=torch.int8
        )
    ...
    def apply(
        ...
        **kwargs,
        ...
        assert (
            router_logits.shape[1] == global_num_experts - global_redundant_expert_num
