    ...
    def forward_oot(
        ...
        if residual is not None:
            if enable_custom_op():
                ...
                x, _, residual = ir.ops.fused_add_rms_norm(x, residual, self.weight, self.variance_epsilon)
    ...
    def forward_oot(
        ...
        if residual is not None:
            if enable_custom_op():
                ...
                x, _, residual = ir.ops.fused_add_rms_norm(x, residual, 1.0 + self.weight, self.variance_epsilon)
            return x, residual
