...
def chunk_gated_delta_rule_fwd(
    ...
    update_chunk_offsets_64 = (
        None if prebuilt_meta is None else prebuilt_meta.update_chunk_offsets_64
    )
    final_chunk_indices_64 = (
        None if prebuilt_meta is None else prebuilt_meta.final_chunk_indices_64
    )
