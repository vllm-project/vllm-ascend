...
def postprocess_mamba_fused_kernel(
    ...
    # Hoist the pointer-type casts out of the copy loops. triton-ascend's
    ...
    actual_src_block_id = tl.load(block_table_base + src_block_idx + accept_token_bias).to(tl.int64)
