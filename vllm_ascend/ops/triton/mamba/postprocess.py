...
def postprocess_mamba_fused_kernel(
    ...
    if CONV_STATE_DIM_FIRST and is_conv_state:
        ...
        for d in range(0, dim_rows):
            ...
            # here and doing plain pointer arithmetic inside the loop is the same
            # fix vllm-ascend applies to batch_memcpy_kernel.
    ...
    # Hoist the pointer-type cast out of the copy loop (see the DS-conv branch
    # above for the triton-ascend rationale).
