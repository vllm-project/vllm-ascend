...
EPLB_EXPERT_MAP_PATH: str = "eplb_expert_map.json"
...
class AscendFusedMoE(FusedMoE):
    ...
    def __init__(self,
        ...
        if self.ep_size > 1:
            # vllm_config = get_current_vllm_config()
            # expert_map_path = vllm_config.additional_config["expert_map_path"]
            expert_map_path = os.path.join(get_current_vllm_config().model_config.model, EPLB_EXPERT_MAP_PATH)
