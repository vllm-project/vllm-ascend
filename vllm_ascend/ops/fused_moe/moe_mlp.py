...
def quant_apply_mlp(
    ...
    elif mxfp_quant_dtype in [QuantType.W4A16MXFP, QuantType.W8A16MXFP]:
        quantized_hidden_states = None
        pertoken_scale = None
...
def unified_apply_mlp(*, mlp_compute_input: MoEMlpComputeInput) -> torch.Tensor:
    ...
    if use_mxfp_quant:
        ...
        if mxfp_quant_dtype in [QuantType.W4A16MXFP, QuantType.W8A16MXFP]:
            act_quant_type = mxfp.act_quant_type
        weight_quant_type = mxfp.weight_quant_type or weight_quant_type
        if mxfp_quant_dtype in [QuantType.W4A8MXFP, QuantType.W4A16MXFP, QuantType.W8A16MXFP]:
