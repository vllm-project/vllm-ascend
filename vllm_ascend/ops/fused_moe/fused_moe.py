...
from vllm_ascend.utils import (ACL_FORMAT_FRACTAL_NZ, enable_sp, get_ascend_soc_version, AscendSocVersion,
...
class AscendUnquantizedFusedMoEMethod(UnquantizedFusedMoEMethod):
    ...
    def process_weights_after_loading(self, layer):
        ...
        if get_ascend_soc_version() != AscendSocVersion._310P and is_enable_nz():
