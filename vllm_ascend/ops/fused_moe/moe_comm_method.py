...
from vllm_ascend.distributed.parallel_state import get_mc2_group, get_mega_moe_group
...
class FusedMC2CommImpl(MoECommMethod):
    ...
    def __init__(self, moe_config):
        ...
        if (get_ascend_config().enable_fused_mc2 == 1 and
            get_ascend_device_type() == AscendDeviceType.A5 and mega_moe_symm_buffer is None):
