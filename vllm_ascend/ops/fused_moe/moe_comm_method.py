...
def setup_moe_comm_method(moe_config):
    """Ensure the comm implementations for this config's shape exist.

    Instances are deduplicated per (comm type, execution shape): all layers
    sharing a shape share one stateful comm instance.
    """
