    ...
    def fused_experts(
        ...
        if envs_ascend.VLLM_ASCEND_ENABLE_FUSED_MC2 == 1:
            ...
            torch.ops._C_ascend.dispatch_ffn_combine(  # type: ignore
                ...
                bias1=[fused_experts_input.weights.w1_scale_bias.data] if fused_experts_input.weights.w1_scale_bias is not None else None,
                bias2=[fused_experts_input.weights.w2_scale_bias.data] if fused_experts_input.weights.w2_scale_bias is not None else None,
