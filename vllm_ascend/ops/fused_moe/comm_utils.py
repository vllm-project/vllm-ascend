...
_CANN_ACL_INT8 = 258
_CANN_ACL_INT4 = 285
_CANN_MEGA_MOE_QUANT_MODE_NO_QUANT = 0
...
def _get_cann_mega_moe_quant_settings(quant_type: QuantType) -> tuple[int, int | None, int | None]:
    ...
    if quant_type == QuantType.NONE:
        # BF16/FP16 unquantized MegaMoe: dispatch without quantization; the
        # op derives weight dtypes from the tensors themselves.
        return (_CANN_MEGA_MOE_QUANT_MODE_NO_QUANT, None, None)
    raise RuntimeError(
