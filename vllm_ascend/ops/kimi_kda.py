...
class AscendKimiK3DeltaAttention(KimiK3DeltaAttention):
    ...
    def _run_overlapped_qkv_bfg(
        ...
        # Stage 1 join: both second-stage branches start after DynamicQuant and
        ...
        with npu_stream_switch(bfg_stream):
            ...
            # Queue this reciprocal wait after bfg_ready so it cannot form a
            # cycle with the main-stream wait below.
