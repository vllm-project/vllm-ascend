...
class AscendYaRNRotaryEmbedding(YaRNScalingRotaryEmbedding):
    def __init__(
        ...
        *,
        ...
        # vLLM #56446 replaced extrapolation_factor/attn_factor/apply_yarn_scaling
        # with mscale/mscale_all_dim/attention_factor. Keep both keyword sets and
        # forward the one the installed vLLM understands.
