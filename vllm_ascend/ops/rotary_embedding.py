    ...
    def __init__(
        ...
        *,
        ...
        extra_kwargs: dict[str, Any] = {
            "beta_fast": beta_fast,
            "beta_slow": beta_slow,
            # TODO: current not support actual truncate, adaptation for extra
            # parameters to be compatible with vllm
            "truncate": truncate,
        }
        if vllm_version_is("0.28.0"):
            # The release tree still scales YaRN through extrapolation/attn
            # factors.
            extra_kwargs.update(
                {
            ...
            # Main derives mscale from mscale/mscale_all_dim/attention_factor.
            extra_kwargs.update(
                {
                    "mscale": mscale,
