...
env_variables: dict[str, Callable[[], Any]] = {
    ...
    # Experimental Qwen3.5-9B decode-only GDN head-tile pipeline. It is
    # disabled by default and restricted to BF16, TP in {1, 2}, batch <= 16,
    # non-speculative decode; unsupported cases use the stock path.
