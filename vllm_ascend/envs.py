...
env_variables: dict[str, Callable[[], Any]] = {
    ...
    # Whether to route DSpark draft attention through the Python reference
    # entry point. This is only for semantic validation before the custom op
    # implementation is ready, and should stay disabled in normal serving.
    "VLLM_ASCEND_DSPARK_USE_PY_ATTENTION_OP": lambda: bool(
        int(os.getenv("VLLM_ASCEND_DSPARK_USE_PY_ATTENTION_OP", "0"))
    ),
}
