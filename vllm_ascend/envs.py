...
env_variables: dict[str, Callable[[], Any]] = {
    ...
    # Whether to log OpenAI chat completions request and response payloads.
    # 0: disable logging, 1: enable logging (default). This can include user
    # prompts and generated content.
    "VLLM_ASCEND_LOG_CHAT_COMPLETIONS": lambda: bool(int(os.getenv("VLLM_ASCEND_LOG_CHAT_COMPLETIONS", "1"))),
}
