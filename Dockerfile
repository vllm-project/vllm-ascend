...
# to public defaults; with the default build-args everything is skipped.
# The script ships with the repo and is already copied in by `COPY .` above.
RUN bash /vllm-workspace/vllm-ascend/.github/workflows/scripts/restore_public_sources.sh
