...
vllm serve ${MOEL_DIR} \
    ...
    --additional_config '{"ascend_scheduler_config":{"enabled": true, "enable_chunked_prefill": true, "SLO_limits_for_dynamic_batch":'${SLO_LITMIT}'},"torchair_graph_config":{"enabled":true}}' > ${OUT_JSON_DIR}/server_tmp.log 2>&1 &
