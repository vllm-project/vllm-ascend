...
| v0.22.1rc1 | 上一 RC 版本 | 请查看[快速开始](https://docs.vllm.ai/projects/ascend/en/releases-v0.22.1rc/quick_start.html)和[安装指南](https://docs.vllm.ai/projects/ascend/en/releases-v0.22.1rc/installation.html)了解更多 |
...
| releases/v0.24.0rc | Maintained | 基于vLLM v0.24.0开发版本CI看护 |
| releases/v0.23.0 | Maintained   | 基于vLLM v0.23.0版本CI看护 |
| releases/v0.22.1rc | Maintained | 基于vLLM v0.22.1版本CI看护 |
| releases/v0.21.0rc | Maintained | 基于vLLM v0.21.0版本CI看护 |
