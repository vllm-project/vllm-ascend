...
### 22. How to acheive low latency in a small batch scenario?
...
```
**NOTE**: Don't set `additional_config.pa_shape_list` when using this mehod, otherwise it will lead to another attention operator.