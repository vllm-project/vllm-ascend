=== "Base environment"
    ...
    ???+ note
        ...
        The commands above use the default CANN and NNAL installation paths. If you install either component in a non-default directory, source the corresponding `set_env.sh` from the actual installation directory. Refer to the [CANN installation resources](https://www.hiascend.com/cann/download) to complete the installation.
