...
| `enable_flashcomm1`                 | bool | `False` | Whether to enable FlashComm1 optimization. The legacy `VLLM_ASCEND_ENABLE_FLASHCOMM1` environment variable is no longer supported. |
