...
| `profiling_chunk_config`            | dict | `{}`    | Configuration options for dynamic chunked pipeline parallel. See [Profiling Chunk Parallel](../feature_guide/profiling_chunk_parallel.md) for details. |
