...
| Name | Type | Default | Description |
| ---- | ---- | ------- | ----------- |
| **`enable_graph_rewrite`** | bool | `True` | This is the primiary flag to control whether to enable the graph rewriter to rewrite the fx graph generated by torch.compile. If disabled, all fusion related flag will be ignored.|
| `fx_graph_eager` | bool | `False` | Whether to always run fx.graph in eager mode | 
