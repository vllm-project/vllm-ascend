...
| `enable_diagnostics` | bool | `False` | Whether to print scheduler and DP engine diagnostics. When NonBSP is enabled, load-balancing and preemption diagnostics are also printed. |
