...
| `enable_moe_lora_dual_stream`       | bool | `False` | Whether to overlap quantized MoE LoRA with base expert GMM on an auxiliary NPU stream. Currently limited to TP with the AllGather backend, without EP or fully sharded LoRA. |
