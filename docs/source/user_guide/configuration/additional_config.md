...
| `enable_pcp_decode_sharding` | bool | `False` | Distribute decode requests across PCP ranks while replicating KV updates. Experimental: MRv2, PCP > 1, DCP = 1, eager DeepSeek V2/V3/V3.2 MLA/SFA only; no speculative decoding, KVPP, or PCP O-proj weight sharding. See [PCP decode request sharding](../feature_guide/context_parallel.md#pcp-decode-request-sharding). |
