...
| `enable_cpu_binding`                | bool | `True`  | Whether to enable CPU binding. Only takes effect on ARM CPUs; A3 uses global-slicing CPU allocation strategy and other device types use topo-affinity's. |
