...
### Highlights
- Improved the performance of DeepSeek V3.2 [#3995](https://github.com/vllm-project/vllm-ascend/pull/3995), please refer to [tutorials](https://docs.vllm.ai/projects/ascend/en/latest/tutorials/DeepSeek-V3.2.html)
