...
- On Atlas 300I DUO (310P), Qwen3.6-35B-A3B W8A8 can start successfully but crash or hang when serving inference requests. [#13050](https://github.com/vllm-project/vllm-ascend/issues/13050)
- On Atlas 300I DUO (310P), Qwen3-14B-W8A8SC deployment with TP2 can fail. [#12989](https://github.com/vllm-project/vllm-ascend/issues/12989)
- On Atlas 300I DUO (310P), Qwen3-series inference can exhaust resources after the service starts, with a suspected resource leak. [#13007](https://github.com/vllm-project/vllm-ascend/issues/13007)
- On Atlas 300I DUO (310P), MTP and graph mode cannot be enabled together. [#12983](https://github.com/vllm-project/vllm-ascend/issues/12983)
- Combining C8 KV cache with Eagle3 on Qwen3-32B W8A8C8 can trigger an `incre_flash_attention` tiling error. [#12956](https://github.com/vllm-project/vllm-ascend/issues/12956)
- Enabling `enable_sparse_sfa_c8` for a four-node A3 GLM-5.2 P/D-disaggregated deployment can produce garbled output for the first request. [#12905](https://github.com/vllm-project/vllm-ascend/issues/12905)
- MiniMax-M3 tool calls can fail XML parsing when tool argument names contain hyphens, causing the raw XML to leak into the response content. [#12815](https://github.com/vllm-project/vllm-ascend/issues/12815)
- An eight-node A2 P/D-disaggregated DeepSeek V4 Pro deployment can produce garbled responses. [#12792](https://github.com/vllm-project/vllm-ascend/issues/12792)
- DeepSeek V4 Flash with Mooncake in P/D-disaggregated serving can hang under load when asynchronous scheduling is enabled; disabling `--async-scheduling` avoids the reported hang. [#12725](https://github.com/vllm-project/vllm-ascend/issues/12725)
- A GLM-5.2 P/D-disaggregated deployment with DCP2 and TP2 can fail on the prefill instance during inference. [#12677](https://github.com/vllm-project/vllm-ascend/issues/12677)
- Ascend 950 Qwen3.5-397B W8A8-MXFP8-FULL_QUANT can produce alternating accurate and inaccurate responses in P/D-disaggregated serving when MTP is disabled. [#12339](https://github.com/vllm-project/vllm-ascend/issues/12339)
...
- Reduced sampling in P/D-disaggregated serving can produce garbled output. [#12827](https://github.com/vllm-project/vllm-ascend/issues/12827)
...
- Triton RoPE with NeoX `head_dim=192` has a reported unsafe head tile on A3. [#12733](https://github.com/vllm-project/vllm-ascend/issues/12733)
