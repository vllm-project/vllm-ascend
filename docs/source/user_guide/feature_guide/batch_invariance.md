...
!!! note
    ...
    For installation instructions, see [Set Up Using Python](https://github.com/vllm-project/vllm-ascend/blob/main/docs/source/getting_started/installation.md#existing-cann-environment)
