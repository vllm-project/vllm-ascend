...
1. Large model inference deployment often uses quantization. Taking INT8 quantization commonly used on NPUs as an example, after LayerNorm, a Quant operator quantizes the hidden states from BF16 to INT8. The communication volume of Allgather is halved, and on longer sequences, the time consumption is almost halved.
...
vllm serve Qwen/Qwen3-VL-2B-Instruct \
    ...
    --compilation-config '{"compile_ranges_split_points": [1000], "pass_config": {"enable_sp": true}}' \
