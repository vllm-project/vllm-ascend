...
LoRA adapters can be used with any vLLM model that implements [SupportsLoRA](https://docs.vllm.ai/en/latest/api/vllm/model_executor/models/interfaces.html#vllm.model_executor.models.interfaces.SupportsLoRA).
...
Check out this [vLLM project LoRA example](https://github.com/vllm-project/vllm/blob/main/examples/offline_inference/multilora_inference.py) for an example of how to use LoRA adapters with the async engine and how to use more advanced configuration options.
