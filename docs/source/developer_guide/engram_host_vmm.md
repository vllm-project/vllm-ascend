...
The branch pins that dependency at `c220bef7ac15f24a99d1b1371b39e11c7aa962a4`.
...
the existing HBM or CPU-offload path. VMM and `enable_engram_ple_offload` are
...
and route rejection. Model input/config tests extend `test_engram_inputs.py`
