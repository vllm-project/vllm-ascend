...
- Online test example: [`tests/e2e/pull_request/two_card/aclgraph/test_aclgraph_capture_replay.py`](https://github.com/vllm-project/vllm-ascend/blob/main/tests/e2e/pull_request/two_card/aclgraph/test_aclgraph_capture_replay.py)
- Correctness test example: [`tests/e2e/pull_request/one_card/aclgraph/test_aclgraph_batch_invariant.py`](https://github.com/vllm-project/vllm-ascend/blob/main/tests/e2e/pull_request/one_card/aclgraph/test_aclgraph_batch_invariant.py)
