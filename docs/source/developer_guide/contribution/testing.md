...
git clone -b |vllm_ascend_version|-dev --depth 1 https://github.com/vllm-project/vllm-ascend.git
git clone --depth 1 -b v0.11.0 https://github.com/vllm-project/vllm.git
