...
- [Runtime Guard design (Chinese)](runtime_guard_design.md) — Online anomaly detect / report / dump_kv control plane.
- [Runtime Guard ops (Chinese)](runtime_guard_ops.md) — Deployment and troubleshooting runbook.
