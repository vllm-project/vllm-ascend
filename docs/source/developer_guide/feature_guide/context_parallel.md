...
As prefill and decode present quite different characteristics and have quite different SLO (service level objectives), we need to implement context parallel separately for them.
...
## How to Use CP?
Please refer to the EPLB section of the user guide for detailed information: [How to Use CP](../../user_guide/feature_guide/context_parallel.md)
