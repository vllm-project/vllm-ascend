...
|-------------|-------------------|-----------------|-------------|---------------------------------|-------------------|----------|
| v0.19.1rc1  | v0.19.1           | >= 3.10, < 3.12 | 9.0.0       | 2.9.0  / 2.9.0                  | 3.2.0             |          |
| v0.18.0     | v0.18.0           | >= 3.10, < 3.12 | 9.0.0       | 2.9.0  / 2.9.0.post1+git4c901a4 | 3.2.0.dev20260322 |  3.9.0   |
| v0.18.0rc1  | v0.18.0           | >= 3.10, < 3.12 | 9.0.0       | 2.9.0  / 2.9.0                  | 3.2.0             |          |
| v0.17.0rc1  | v0.17.0           | >= 3.10, < 3.12 | 9.0.0       | 2.9.0  / 2.9.0                  | 3.2.0             |          |
| v0.16.0rc1  | v0.16.0           | >= 3.10, < 3.12 | 9.0.0       | 2.9.0  / 2.9.0                  | 3.2.0             |          |
| v0.15.0rc1  | v0.15.0           | >= 3.10, < 3.12 | 8.5.0       | 2.9.0  / 2.9.0                  | 3.2.0             |          |
| v0.14.0rc1  | v0.14.1           | >= 3.10, < 3.12 | 8.5.0       | 2.9.0  / 2.9.0                  | 3.2.0             |          |
| v0.13.0rc3  | v0.13.0           | >= 3.10, < 3.12 | 9.0.0       | 2.8.0  / 2.8.0.post2            | 3.2.0             |          |
