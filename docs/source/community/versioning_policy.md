...
|-------------|-------------------|-----------------|-------------|---------------------------------|---------------|
| v0.14.0rc1  | v0.14.0/releases/v0.15.0   | >= 3.10, < 3.12 | 8.5.0       | 2.9.0  / 2.9.0                  | 3.2.0         |
...
|-------------|--------------|------------------|-------------|--------------------|
|     main    | cf1167e50b809f18efd21fb3418dd75d2805b14f, releases/v0.15.0 tag | >= 3.10, < 3.12   | 8.5.0 | 2.9.0 / 2.9.0 |
