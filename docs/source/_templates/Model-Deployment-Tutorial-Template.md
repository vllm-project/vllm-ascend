...
- If the code example includes version numbers,it is necessary to add a comment explaining that the version number should be filled in accoring to the actual version in use.
