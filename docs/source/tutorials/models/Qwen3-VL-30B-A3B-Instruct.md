...
=== "Ascend 950DT series"
    ...
    vllm serve Eco-Tech/Qwen3-VL-30B-A3B-Instruct-w8a8-mxfp8 --additional-config '{"enable_flashcomm1":true}' \
      --host 0.0.0.0 \
      --port 8000 \
...
=== "A3 series"
    ...
    export OMP_PROC_BIND=false
    export TASK_QUEUE_ENABLE=1
    vllm serve Qwen/Qwen3-VL-30B-A3B-Instruct --additional-config '{"enable_flashcomm1":true,"enable_fused_mc2":1}' \
      --host 0.0.0.0 \
      --port 8000 \
      --served-model-name qwen3-vl-30b \
      --data-parallel-size 1 \
