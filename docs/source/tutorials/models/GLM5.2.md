...
2. prepare the script `run_dp_template.sh` on each node.
    ...
    1. Prefill node 0
        ...
        vllm serve /root/.cache/modelscope/hub/models/vllm-ascend/GLM-5.2-w8a8 \
            ...
            --speculative-config '{"num_speculative_tokens": 5, "method":"deepseek_mtp"}' \
            --additional-config '{"enable_sparse_c8":false,"fuse_muls_add": true, "multistream_overlap_shared_expert": true, "ascend_compilation_config": {"enable_npugraph_ex": true},"enable_dsa_cp": true}' \
            --max-num-batched-tokens 4096 \
            --trust-remote-code \
            --max-num-seqs 64 \
            --async-scheduling \
