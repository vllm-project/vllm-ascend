...
- `enable_fused_mc2`: `1` uses `dispatch_ffn_combine`; `2` opts into CANN `mega_moe` for testing. Existing model, hardware, and parallel-configuration constraints still apply.
