...
- `GLM-4.6-w8a8`(Quantized version without mtp): [Download model weight](https://modelers.cn/models/Modelers_Park/GLM-4.6-w8a8). An MTP version was not provided because vLLM did not support it for GLM-4.6 at the time of this model's quantization. Support has since been added, and you can use the following quantization scheme to add MTP weights to the quantized weights.
