...
Select an image based on your machine type and start the Docker image on your node. Refer to [using Docker](../../getting_started/installation.md#pre-built-image) for the complete installation guide.

The `Qwen3.5-397B-A17B` model is first supported in `vllm-ascend:v0.17.0rc1`. Use `v0.17.0rc1` or later for this model. For Ascend 950DT, the model is supported from `vllm-ascend:v0.23.0rc1`.
