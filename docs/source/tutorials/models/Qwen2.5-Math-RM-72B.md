...
- `Qwen2.5-Math-RM-72B` (BF16 version): requires at least 1 Atlas 910B4 (32G × 1) card or higher. [Download model weight](https://modelscope.cn/models/Qwen/Qwen2.5-Math-RM-72B)
