...
Use a draft checkpoint whose attention type matches the intended GQA or MLA
DSpark path. Add the same speculative configuration to the Node 0 and headless
worker commands:
