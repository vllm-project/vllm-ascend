...
The automatic operator optimizations require a serving image that includes their corresponding vLLM-Ascend implementation. The no-RoPE MLAPO optimization applies to native BF16 Kimi K3 checkpoints on Atlas 800 A5 and does not change the A3 deployment commands in this document.
