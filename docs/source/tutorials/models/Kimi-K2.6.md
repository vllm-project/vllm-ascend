...
The `Kimi-K2.6` model is first supported in `vllm-ascend:v0.20.0rc1`.
...
You can use our official docker image to run `Kimi-K2.6` directly.
...
- Quantized model `Kimi-K2.6-w4a8` can be deployed on 1 Atlas 800 A3 (64G × 16).
...
- `Kimi-K2.6-w4a8 2P1D` require 4 Atlas 800 A3 (64G × 16).
