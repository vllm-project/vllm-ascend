...
|-----------------|-----------------------|----------------|
| `Kimi-K2.6-w4a8` (Quantized version for w4a8) | 1 Atlas 800 A3 (64GB × 16) node or 2 Atlas 800 A2 (64GB × 8) nodes | [Modelscope](https://www.modelscope.cn/models/Eco-Tech/Kimi-K2.6-W4A8) \| [HuggingFace]() |
| `kimi-k2.6-eagle3` (Eagle3 MTP draft model for accelerating inference of Kimi-K2.6) |          | [Modelscope]() \| [HuggingFace](https://huggingface.co/lightseekorg/kimi-k2.6-eagle3) |
| `Kimi-K2.5-DFlash` (a speculative decoding framework that leverages a lightweight block <br>diffusion model for parallel drafting) |          | [Modelscope]() \| [HuggingFace](https://huggingface.co/z-lab/Kimi-K2.5-DFlash) |
