...
|-----------------|-----------------------|----------------|
| `Kimi-K2.6-w4a8` (Quantized version for w4a8) | 1 Atlas 800 A3 (64GB × 16) node or 2 Atlas 800 A2 (64GB × 8) nodes | [AtomGit](https://ai.atomgit.com/Eco-Tech/Kimi-K2.6-W4A8) / [ModelScope](https://www.modelscope.cn/models/Eco-Tech/Kimi-K2.6-W4A8) |
