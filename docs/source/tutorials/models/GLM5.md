...
If multi-node deployment is required, please follow the [Verify Multi-node Communication Environment](../../getting_started/installation.md#multi-node-deployment) guide for communication verification.
...
If you want to deploy multi-node environment, you need to verify multi-node communication according to [verify multi-node communication environment](../../getting_started/installation.md#multi-node-deployment).
