...
- `GLM-5.1-w4a4`(Quantized version): [Download model weight](). #TODO
...
### 5.3 Prefill-Decode Disaggregation(A3)
...
2. prepare the script `run_dp_template.sh` on each node.
    ...
    1. Prefill node 0
        ...
        vllm serve /root/.cache/modelscope/hub/models/vllm-ascend/GLM5-w4a4 \
            ...
            "kv_connector_extra_config": {
                        ...
                        "ascend_local_comm_res_path": "/etc/hixlep" #TODO
                }
            }' \
            --additional-config '{"enable_cpu_binding": "True", "multistream_overlap_shared_expert": "True", "recompute_scheduler_enable": "True", "enable_sparse_c8": "True", "enable_dsa_cp": true, "eplb_config": {"dynamic_eplb": "True", "expert_heat_collection_interval": 50, "algorithm_execution_interval": 5, "num_redundant_experts": 8, "eplb_policy_type": 2}}'
        ```
    ...
    3. Decode node 0
        ...
        vllm serve /root/.cache/modelscope/hub/models/vllm-ascend/GLM5-w4a4 \
            ...
            --additional-config '{"enable_cpu_binding": "True", "multistream_overlap_shared_expert": "True", "recompute_scheduler_enable": "True", "enable_sparse_c8": "True", "finegrained_tp_config": {"lmhead_tensor_parallel_size":8}, "eplb_config": {"dynamic_eplb": "True", "expert_heat_collection_interval": 600, "algorithm_execution_interval": 50, "num_redundant_experts": 16, "eplb_policy_type": 2}}'
        ```
...
|High Throughput|2P1D deployment|32 (Ascend950DT)|GLM5-w4a4/GLM5.1-w4a4|dp1 dsa-cp8 on P nodes and dp16 on D nodes to balanced latency and throughput|
|Low Latency|2P1D deployment|32 (Ascend950DT)|GLM5-w4a4/GLM5.1-w4a4|dp1 dsa-cp8 on P nodes and dp16 on D nodes to balanced latency and throughput|
