...
=== "A3 series"
    ...
    --additional-config '{"multistream_overlap_shared_expert": true,"enable_flashcomm1":true}' \
...
=== "A3 series"
    ...
    **node 0**
    ...
    vllm serve /root/.cache/modelscope/hub/models/vllm-ascend/GLM5-bf16 --additional-config '{"enable_flashcomm1":true}' \
    --host 0.0.0.0 \
    --port 8077 \
