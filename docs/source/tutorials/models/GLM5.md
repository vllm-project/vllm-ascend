...
- `VLLM_ASCEND_ENABLE_FUSED_MC2=1`: Enables fused MC2 operators (`mega_moe`) to optimize MoE communication. Constraints: `mega_moe` works for w8a8/w4a8/bf16 with EP≤64. Both are incompatible with MTP and dynamic EPLB.
