...
|---------------------|-----------------------|----------------|
| `PaddleOCR-VL-0.9B` | 1 Atlas 800 A3 (128GB × 8) nodes or 1 Atlas 800 A2 (64GB × 8) nodes or 1 Atlas 300I DUO (48GB × 8) nodes | [Modelscope](https://www.modelscope.cn/models/PaddlePaddle/PaddleOCR-VL) \| [HuggingFace](https://huggingface.co/PaddlePaddle/PaddleOCR-VL) |
