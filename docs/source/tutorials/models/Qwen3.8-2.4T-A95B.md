...
- `Qwen3.8-2.4T-A95B-w8a8`: approximately 2.33 TiB of storage and weight
  ...
  <!-- # TODO: Replace this placeholder with the published W8A8 weight URL. -->
...
<!-- # TODO: Validate the 8P8D topology with Qwen3.8. -->
...
```shell
# TODO: Validate these PD parameters with Qwen3.8.
...
<!-- # TODO: Validate these performance values with Qwen3.8. -->
