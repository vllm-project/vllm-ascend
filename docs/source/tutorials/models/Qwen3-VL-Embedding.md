...
```bash
vllm bench serve --model Qwen/Qwen3-VL-Embedding-2B --backend openai-embeddings --dataset-name random --endpoint /v1/embeddings --random-input 200 --save-result --result-dir ./
```
