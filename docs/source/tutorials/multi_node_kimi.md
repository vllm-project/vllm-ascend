...
## Run with Docker
Assume you have two Atlas 800I A3 (64G*16)  or four Atlas 800I A2 nodes, and want to deploy the `Kimi-K2-Instruct-W8A8` quantitative model across multiple nodes.
