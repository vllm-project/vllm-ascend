...
1. After execution, you can get the result, here is the result of `Qwen3-Omni-30B-A3B-Thinking` in vllm-ascend:0.11.0rc1 for reference only.
...
+-----------------------------+-----------+----------+----------+-------+---------+---------+
| Qwen3-Omni-30B-A3B-Thinking | omni_bench | mean_acc | default  |   100 |     0.5 | default |
+-----------------------------+------------+----------+----------+-------+---------+---------+ 
...
export MODEL=models/Qwen/Qwen3-Omni-30B-A3B-Thinking
