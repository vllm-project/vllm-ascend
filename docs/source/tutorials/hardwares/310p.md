...
!!! tip "Atlas 200I Pro"
    ...
    If host memory looks tight before service startup, consider clearing the host
    page cache as described in
    [Host Page Cache Cleanup (Recommended)](#host-page-cache-cleanup-recommended).
    Judge based on your actual environment; this step is optional when memory is
    already sufficient.
