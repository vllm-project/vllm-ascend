...
summarizes model families that have current 310P coverage in this repository.
Use it as a starting point when selecting models for Atlas 300I DUO; for large
models, adjust TP size, visible devices, `max-model-len`, and quantized weights
according to the deployment examples below.
