# Prefill–Decode Disaggregation on Kubernetes With Kthena

This guide shows how to run **prefill–decode (PD) disaggregation** on Huawei Ascend NPUs using **vLLM-Ascend**, with [**Kthena**](https://kthena.volcano.sh/) handling orchestration on Kubernetes.
...
- The Kthena routing layer is correctly fronting the vLLM-Ascend engines.
