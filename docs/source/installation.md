...
- Software:
    ...
    | torch-npu     | == 2.9.0.post2             | Required for vllm-ascend, No need to install manually, it will be auto installed in below steps |
...
- Ascend 950: `export SOC_VERSION=<value starting with "ascend950">`
```
