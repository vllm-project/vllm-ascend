...
from tools.bisect.version_history import ExternalVersionManager, VersionHistory, VersionProfile, VersionSyncError
...
def run_worker(inp: BisectInput, opt: BisectOptions) -> int:
    ...
    version_manager = ExternalVersionManager(
        VersionHistory(
            ...
            opt.repo_dir,
            opt.version_branch or "main",
            opt.version_target or "a2",
        ),
