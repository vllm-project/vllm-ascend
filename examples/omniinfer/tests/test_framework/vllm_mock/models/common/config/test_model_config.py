...
class TestModelAdditionalConfig(unittest.TestCase):
    ...
    def test_basic_load_json_config(self):
        ...
        self.assertEqual(
            config.operator_opt_config.enable_kv_rmsnorm_rope_cache, False)
        self.assertEqual(config.operator_opt_config.prefill_moe_all_to_all,
                         False)
        self.assertEqual(config.operator_opt_config.moe_multi_stream_tune,
                         True)
        ...
        self.assertEqual(
            config.operator_opt_config.decode_moe_dispatch_combine, True)
    ...
    def test_default_config_when_no_json(self):
        ...
        self.assertEqual(
            config.operator_opt_config.enable_kv_rmsnorm_rope_cache, True)
        self.assertEqual(config.operator_opt_config.prefill_moe_all_to_all,
                         True)
        self.assertEqual(config.operator_opt_config.moe_multi_stream_tune,
                         False)
