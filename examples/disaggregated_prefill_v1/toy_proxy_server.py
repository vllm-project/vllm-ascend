...
async def send_request_to_service(client_info: dict, endpoint: str,
    ...
    #endpoint = "http://xx.xx.xx.xx:8100/v1/completions"
...
async def handle_completions(request: Request):
    try:
        ...
        response = await send_request_to_service(prefill_client_info,
                                                 "http://xx.xx.xx.xx:8100/v1/completions", req_data, #TODO Hard code, we will fix recently
                                                 request_id)
        ...
        async def generate_stream():
            async for chunk in stream_service_response(decode_client_info,
                                                       "http://xx.xx.xx.xx:8200/v1/completions",  #TODO Hard code, we will fix recently
                                                       req_data,
