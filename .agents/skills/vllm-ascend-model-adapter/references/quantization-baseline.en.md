...
This document defines the current capability baseline for quantization-related adaptation, especially fp8 checkpoints, KV quantization, W8A8, and C8.

## What this layer focuses on

The quantization layer asks:

- whether the checkpoint is fp8, int8, compressed-tensors, or another quant format
- whether the problem is a weight-loading quant issue or a runtime kernel/operator issue
